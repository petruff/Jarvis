#!/bin/bash
#
# Electron AAOS Monitor Hooks Installation Script
#
# This script installs the Electron AAOS monitor hooks into ~/.claude/hooks/
...
Electron AAOS_ROOT="$(dirname "$SCRIPT_DIR")"
HOOKS_SOURCE="$Electron AAOS_ROOT/.electron-aaos-core/monitor/hooks"
HOOKS_TARGET="$HOME/.claude/hooks"

echo "╔════════════════════════════════════════════════════════════════╗"
echo "║              Electron AAOS Monitor Hooks Installer                      ║"
echo "╚════════════════════════════════════════════════════════════════╝"
echo ""
...
echo "║     export Electron AAOS_MONITOR_URL=http://localhost:4001              ║"
echo "║                                                                ║"
