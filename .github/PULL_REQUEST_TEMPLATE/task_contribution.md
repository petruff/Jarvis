...
<!-- Thank you for contributing a task to Electron AAOS! Please fill out this template. -->

### Task Information

- **Task Name:** <!-- e.g., db-validate-kiss -->
- **Task File:** <!-- e.g., .electron-aaos-core/development/tasks/db-validate-kiss.md -->
...
- [ ] Task follows Electron AAOS task format
