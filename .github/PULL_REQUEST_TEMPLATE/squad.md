...
- [ ] Follows Electron AAOS squad structure (see [Squads Guide](docs/guides/squads-guide.md))
...
- [ ] Works with core Electron AAOS framework
...
- Compliance with Electron AAOS standards
