...
This directory contains automated workflows for the Electron AAOS project.
...
> **Note:** Legacy 1MCP metrics have been deprecated. Electron AAOS now uses Docker MCP Toolkit exclusively (Story 5.11).
