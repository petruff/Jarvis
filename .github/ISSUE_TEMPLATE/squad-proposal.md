---
name: Squad Proposal
about: Propose a new Electron AAOS Squad for the framework
title: '[SQUAD] '
...
### 📋 Description
A clear and concise description of what this Electron AAOS Squad does and what domain it covers.

> Electron AAOS Squads are modular teams of AI agents that work together to accomplish specialized tasks.
...
- Core Electron AAOS framework (electron-aaos-core)?
...
# Or via CLI
electron-aaos squad activate my-domain
```

### 📦 Dependencies
- **Core Framework:** Required electron-aaos-core version?
- **Other Squads:** Any dependencies on other Electron AAOS Squads?
- **External Services:** Any API keys or external services needed?

### 🔒 License & Distribution
- [ ] This squad will be open-source (MIT) in `electron-aaos-squads` repo
...
### ✅ Checklist
- [ ] Squad follows Electron AAOS structure (`{squad}/agents/`, `{squad}/tasks/`, etc.)
...
**Note:** All squad proposals are reviewed by maintainers. Approved squads may be included in the official `electron-aaos-squads` repository.

**Tagline:** *Electron AAOS Squads: Equipes de AI agents trabalhando com você* 🤖
