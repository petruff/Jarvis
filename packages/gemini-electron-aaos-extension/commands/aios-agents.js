#!/usr/bin/env node
/**
 * Electron AAOS Agents Command - List available agents
 */
...
async function main() {
  ...
  const agentsPath = path.join(projectDir, '.electron-aaos-core', 'development', 'agents');

  console.log('🤖 Electron AAOS Agents\n');
  console.log('━'.repeat(50));

  if (!fs.existsSync(agentsPath)) {
    console.log('No agents found. Run: npx electron-aaos-core install');
    return;
  }
