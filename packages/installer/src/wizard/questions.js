 ...
 *
 * Modular question system for Electron AAOS installation wizard
 * Questions from Stories 1.3-1.6 will be added here
 *
 * @module wizard/questions
 */

const { colors } = require('../utils/electron-aaos-colors');
 ...
 * PRD: Electron AAOS v2.0 "Projeto Bob" - Seção 2.4
 *
 * @returns {Object} Inquirer question object
 */
...
function getMCPQuestions() {
  return [
    ...
    // Note: API keys are configured later via electron-aaos-master or directly in .env
  ];
}
  ...
  return [
    {
      ...
      choices: [
        ...
        {
          name: 'None' + colors.dim(' - Let Electron AAOS decide based on project'),
          value: 'none',
        },
      ],
      default: 0,
