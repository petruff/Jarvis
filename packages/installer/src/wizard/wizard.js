...
/**
 * Interactive Wizard for Electron AAOS Installation
 *
...
async function runWizard(options = {}) {
  ...
  try {
    ...
    console.log('🚀 Welcome to Electron AAOS Installer\n');
...
async function confirmProjectType(detectedType) {
  ...
  const typeDescriptions = {
    GREENFIELD: 'New project - Electron AAOS will create complete structure',
    BROWNFIELD: 'Existing project - Electron AAOS will integrate with current setup',
    EXISTING_Electron AAOS: 'Electron AAOS already installed - Would you like to update or reinstall?',
