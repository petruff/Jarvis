...
async function validateFiles(fileContext = {}) {
  ...
  try {
    ...
    const coreConfigPath = fileContext.coreConfig || '.electron-aaos-core/core-config.yaml';
    ...
    // Validate directory structure - only .electron-aaos-core is required
    const requiredDirs = ['.electron-aaos-core'];
