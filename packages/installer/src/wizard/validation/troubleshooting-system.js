...
const TROUBLESHOOTING_DATABASE = {
  ENV_FILE_MISSING: {
    ...
    solutions: [
      'Re-run wizard: npx @Electron AAOSAI/electron-aaos@latest init',
      'Manually create .env from template: cp .env.example .env',
      'Check file permissions in project directory',
    ],
    docs: 'https://docs.Electron AAOSAI.com/installation/environment',
    priority: 'critical',
  },
  ...
  CORE_CONFIG_MISSING: {
    ...
    causes: [
      'Environment configuration step failed',
      '.electron-aaos-core directory missing',
      'File creation failed',
    ],
    solutions: [
      'Re-run wizard: npx @Electron AAOSAI/electron-aaos@latest init',
      'Check .electron-aaos-core directory exists',
      'Manually create from template',
    ],
    docs: 'https://docs.Electron AAOSAI.com/configuration/core-config',
    priority: 'high',
  },
  ...
  MCP_HEALTH_CHECK_FAILED: {
    ...
    docs: 'https://docs.Electron AAOSAI.com/mcps/troubleshooting',
    priority: 'medium',
  },
  ...
  GITIGNORE_CRITICAL_MISSING: {
    ...
    docs: 'https://docs.Electron AAOSAI.com/security/gitignore',
    priority: 'high',
  },
  ...
  DEPS_INSTALL_FAILED: {
    ...
    docs: 'https://docs.Electron AAOSAI.com/installation/dependencies',
    priority: 'critical',
  },
  ...
  ENV_PERMISSIONS_INSECURE: {
    ...
    docs: 'https://docs.Electron AAOSAI.com/security/file-permissions',
    priority: 'medium',
  },
};
...
async function offerTroubleshooting(errors) {
  ...
  if (viewLogs) {
    ...
    console.log(chalk.dim('  - .electron-aaos/install-log.txt'));
    console.log(chalk.dim('  - .electron-aaos/install-errors.log'));
    console.log('');
    console.log(chalk.dim('View with: cat .electron-aaos/install-log.txt'));
  }
  ...
  if (openDocs) {
    ...
    console.log(chalk.green('  https://docs.Electron AAOSAI.com/troubleshooting'));
    console.log('');
  }
  ...
  console.log(chalk.dim('  - GitHub Issues: https://github.com/Electron AAOSAI/electron-aaos/issues'));
  console.log(chalk.dim('  - Documentation: https://docs.Electron AAOSAI.com'));
  console.log('');
}
...
function displayGenericTroubleshooting(code, errorInstances) {
  ...
  console.log(chalk.green('  2. Check installation logs in .electron-aaos/'));
