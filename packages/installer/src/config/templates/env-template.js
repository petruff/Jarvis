...
/**
 * Get the current Electron AAOS version from package.json
...
const Electron AAOS_VERSION = getAiosVersion();
...
function generateEnvContent(apiKeys = {}) {
  const content = `# ============================================
# Electron AAOS Electron AAOS Environment Configuration
# ============================================
# Generated by Electron AAOS Installer
...
# --------------------------------------------
# Electron AAOS Core Configuration
# --------------------------------------------
NODE_ENV=development
Electron AAOS_VERSION=${Electron AAOS_VERSION}
