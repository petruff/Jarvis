 ...
 *
 * Generates YAML configuration file for Electron AAOS framework
 *
 ...
 * @param {string} options.projectType - Project type from Story 1.3 (GREENFIELD|BROWNFIELD|EXISTING_Electron AAOS)
 ...
 * @param {string} [options.electron-aaosVersion] - Electron AAOS version (default: 2.1.0)
...
function generateCoreConfig(options = {}) {
  ...
  const config = {
    ...
    project: {
      ...
      version: electron-aaosVersion,
    },

    // User Profile Configuration (Story 10.2 - Epic 10: User Profile System)
    // PRD: Electron AAOS v2.0 "Projeto Bob" - Seção 2
    ...
    scriptsLocation: '.electron-aaos-core/scripts',
    dataLocation: '.electron-aaos-core/data',
    elicitationLocation: '.electron-aaos-core/elicitation',
