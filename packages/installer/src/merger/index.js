/**
 * @fileoverview Smart Merge Module for Electron AAOS Installer
 *
 * This module provides intelligent merging capabilities for configuration files
 * during Electron AAOS installation in brownfield projects. Instead of overwriting
 ...
 * - .md files: Section-based merge using Electron AAOS-MANAGED markers
 *
 * @module merger
 * @example
