# @electron-aaos/electron-aaos-install

NPX installer for Electron AAOS - AI-Orchestrated System for Full Stack Development.
...
That's it! The installer will guide you through setting up Electron AAOS in less than 5 minutes.
...
- **Brownfield support**: Detects existing Electron AAOS installations and offers migration
...
```bash
npx @electron-aaos/electron-aaos-install --help
...
```bash
npx @electron-aaos/electron-aaos-install --dry-run
```
...
```bash
npx @electron-aaos/electron-aaos-install --profile bob
npx @electron-aaos/electron-aaos-install --profile advanced
```
...
If you have an existing Electron AAOS installation, the installer will:
...
- Documentation: https://github.com/Electron AAOSAI/electron-aaos-core
