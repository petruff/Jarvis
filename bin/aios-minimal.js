...
/**
 * Electron AAOS-FullStack Minimal Installation
 *
...
console.log('\n⚠️  DEPRECATION WARNING: electron-aaos-minimal is deprecated.');
...
// Get the path to the main router (electron-aaos.js)
const routerPath = path.join(__dirname, 'electron-aaos.js');
...
child.on('error', (error) => {
  console.error('❌ Failed to start Electron AAOS:', error.message);
  process.exit(1);
});
