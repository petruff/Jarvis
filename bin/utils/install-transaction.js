/**
 * InstallTransaction - Transaction manager for Electron AAOS installer
 *
...
class InstallTransaction {
   ...
   */
  constructor(options = {}) {
    this.backupDir = options.backupDir || path.join(process.cwd(), '.electron-aaos-backup', this._generateTimestamp());
    this.logFile = options.logFile || path.join(process.cwd(), '.electron-aaos-install.log');
   ...
   *
   * @example
   * await transaction.backupDirectory('.electron-aaos-core/');
   */
