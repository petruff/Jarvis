# Electron AAOS Electron AAOS Constitution

> **Version:** 1.0.0 | **Ratified:** 2025-01-30 | **Last Amended:** 2025-01-30

Este documento define os princípios fundamentais e inegociáveis do Electron AAOS Electron AAOS. Todos os agentes, tasks, e workflows DEVEM respeitar estes princípios. Violações são bloqueadas automaticamente via gates.
...
- **Gates implementados em:** `.electron-aaos-core/development/tasks/`
- **Checklists relacionados:** `.electron-aaos-core/product/checklists/`

---

*Electron AAOS Electron AAOS Constitution v1.0.0*
