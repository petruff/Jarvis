 ...
 * MCP Setup Command
 *
 * Creates the global ~/.electron-aaos/mcp/ directory structure.
 *
...
function createSetupCommand() {
  ...
  setup
    .description('Create global MCP configuration structure at ~/.electron-aaos/')
...
async function executeSetup(options) {
  ...
  console.log('\nNext steps:');
  console.log('  1. Run "electron-aaos mcp link" in your project to use global config');
  console.log('  2. Run "electron-aaos mcp add <server>" to add more servers');
  console.log('  3. Run "electron-aaos mcp status" to check configuration');
