...
Data Storage:
  Metrics are stored in .electron-aaos/data/quality-metrics.json
...
Examples:
  $ electron-aaos metrics record --layer 1 --passed --duration 3200
  $ electron-aaos metrics record --layer 2 --passed --findings 3 --coderabbit
  $ electron-aaos metrics show
  $ electron-aaos metrics show --layer 2
  $ electron-aaos metrics show --format json
  $ electron-aaos metrics seed --days 30
  $ electron-aaos metrics cleanup
  $ electron-aaos metrics cleanup --dry-run
`);
