 ...
 *
 * Implements `electron-aaos workers list` CLI command.
...
function createListCommand() {
  ...
  list
    ...
    .addHelpText('after', `
Examples:
  $ electron-aaos workers list
  $ electron-aaos workers list --category=task
  $ electron-aaos workers list --format=table
  $ electron-aaos workers list --format=json --category=script
  $ electron-aaos workers list --page=2 --limit=10
  $ electron-aaos workers list --count
  $ electron-aaos workers list --verbose
