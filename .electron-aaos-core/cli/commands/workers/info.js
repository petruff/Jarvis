 ...
 *
 * Implements `electron-aaos workers info <id>` CLI command.
...
function createInfoCommand() {
  ...
  info
    ...
    .addHelpText('after', `
Examples:
  $ electron-aaos workers info json-csv-transformer
  $ electron-aaos workers info architect-checklist --format=json
  $ electron-aaos workers info create-story --format=yaml
  $ electron-aaos workers info data-analyzer --verbose
