 ...
 *
 * Implements `electron-aaos workers search <query>` CLI command.
...
Examples:
  ...
  $ electron-aaos workers search "data transformation" --category=etl
  $ electron-aaos workers search "validation" --tags=schema,json
  $ electron-aaos workers search "api" --format=json --limit=5
  $ electron-aaos workers search "transform" --semantic
  $ electron-aaos workers search "convert" --keyword
`)
