...
Examples:
  $ electron-aaos qa run                    Run full pipeline
  $ electron-aaos qa run --layer=1          Run only Layer 1 (pre-commit)
  $ electron-aaos qa run --layer=2          Run only Layer 2 (PR automation)
  $ electron-aaos qa run --verbose          Run with detailed output
  $ electron-aaos qa status                 Show current gate status
