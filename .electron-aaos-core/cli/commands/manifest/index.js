...
function createManifestCommand() {
  ...
  manifest
    .description('Manage Electron AAOS manifest files for agents, workers, and tasks')
    .addHelpText('after', `
Commands:
...
Examples:
  ...
  $ electron-aaos manifest validate --verbose
  $ electron-aaos manifest regenerate
  $ electron-aaos manifest regenerate --force
`);
