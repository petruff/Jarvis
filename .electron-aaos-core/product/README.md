...
```javascript
const templatePath = '.electron-aaos-core/product/templates/story-tmpl.yaml';
const checklistPath = '.electron-aaos-core/product/checklists/story-dod-checklist.md';
```
...
---
*Electron AAOS Electron AAOS v2.1 - Product Module*
