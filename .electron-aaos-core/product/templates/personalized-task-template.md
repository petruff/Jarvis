...
**Tasks:**
- `.electron-aaos-core/tasks/{dependency1}.md`
- `.electron-aaos-core/tasks/{dependency2}.md`

**Templates:**
- `.electron-aaos-core/product/templates/{template1}.yaml`

**Checklists:**
- `.electron-aaos-core/product/checklists/{checklist1}.md`
...
All task outputs MUST use this structure (see `.electron-aaos-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md`):
...
- See `.electron-aaos-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md` for complete guidelines
