# Electron AAOS Electron AAOS Development Rules for Roo Code
...
- Each mode corresponds to an Electron AAOS agent persona
...
---
*Electron AAOS Electron AAOS Roo Code Configuration v2.1*
