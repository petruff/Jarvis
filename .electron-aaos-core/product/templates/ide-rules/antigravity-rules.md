# Electron AAOS Electron AAOS Development Rules for AntiGravity
...
### Agent Integration
- Recognize Electron AAOS agent activations: @dev, @qa, @architect, @pm, @po, @sm, @analyst
...
---
*Electron AAOS Electron AAOS AntiGravity Configuration v1.0*
