# Electron AAOS Electron AAOS Agent for GitHub Copilot
...
3. Choose the Electron AAOS agent mode you need

### Available Agent Modes
| Mode | Purpose |
|------|---------|
| electron-aaos-dev | Full-stack development |
| electron-aaos-qa | Quality assurance |
| electron-aaos-architect | System design |
| electron-aaos-pm | Project management |
...
---
*Electron AAOS Electron AAOS GitHub Copilot Configuration v2.1*
