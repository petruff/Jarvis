# Electron AAOS Electron AAOS Development Rules for Windsurf

## Electron AAOS Agent Integration

When working with Electron AAOS agents in Windsurf:
...
- Workflows are in `electron-aaos-core/workflows/`
- Tasks are in `electron-aaos-core/tasks/`
...
```
project/
├── electron-aaos-core/          # Electron AAOS framework files
...
---
*Electron AAOS Electron AAOS Configuration v1.0* 