...
This template defines the canonical activation-instructions format for Electron AAOS agents after GreetingBuilder integration (Story 6.1.2.5).
...
activation-instructions:
  ...
  - STEP 3: Build intelligent greeting using .electron-aaos-core/development/scripts/greeting-builder.js
...
```yaml
- STEP 2.5: Load project status using .electron-aaos-core/infrastructure/scripts/project-status-loader.js
- STEP 2.6: Load session context using .electron-aaos-core/scripts/session-context-loader.js
...
- **GreetingBuilder**: `.electron-aaos-core/development/scripts/greeting-builder.js`
- **Context Detector**: `.electron-aaos-core/core/session/context-detector.js`
- **Git Config Detector**: `.electron-aaos-core/infrastructure/scripts/git-config-detector.js`
- **Workflow Navigator**: `.electron-aaos-core/development/scripts/workflow-navigator.js`
- **Project Status Loader**: `.electron-aaos-core/infrastructure/scripts/project-status-loader.js`
- **Workflow Patterns**: `.electron-aaos-core/data/workflow-patterns.yaml`
...
*Template maintained by Electron AAOS Framework Team*
