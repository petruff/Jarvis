...
IDE-FILE-RESOLUTION:
  ...
  - Example: create-doc.md → .electron-aaos-core/tasks/create-doc.md
...
activation-instructions:
  ...
  - Use standardized output templates (see .electron-aaos-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md)
...
| **Orchestrator** | Coordination, meta-level | electron-aaos-master (Orion) |
...
- Refer to archetype vocabulary lists in `.electron-aaos-core/data/archetype-vocabulary.yaml`
