...
2. All tests pass
3. Execute `.electron-aaos-core/product/checklists/story-dod-checklist.md`
...
node .electron-aaos-core/scripts/validate-checklist.js {checklist-id}
  ...
  checklist-validation:
    ...
    steps:
      ...
      - name: Generate Report
        run: |
          node .electron-aaos-core/scripts/generate-checklist-report.js {checklist-id}
...
- **Standard:** `.electron-aaos-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md`
- **Agent File:** `.electron-aaos-core/agents/{agent-id}.md`
