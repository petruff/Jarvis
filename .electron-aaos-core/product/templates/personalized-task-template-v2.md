...
```yaml
**Template:**
- path: .electron-aaos-core/product/templates/task-execution-report.md
  type: output
  version: 1.0
  variables: [agent_name, task_name, duration, tokens, status_message]
  schema: schemas/task-execution-report.schema.json

- path: .electron-aaos-core/product/templates/story-tmpl.yaml
  type: input
  version: 2.1
...
```yaml
**Scripts:**
- .electron-aaos-core/scripts/dev-specific/test-runner.js:
    description: Runs tests with coverage reporting specific to dev agent
    language: javascript
    version: 1.2.0

- .electron-aaos-core/scripts/qa-specific/regression-validator.js:
...
- fallback: |
    ...
    2. Use generic template from .electron-aaos-core/product/templates/
...
- fallback: |
    ...
    1. Check alternative data sources (.electron-aaos-core/data/)
...
- **CRITICAL:** Follow Electron AAOS Task Format Specification V1.0 exactly
...
- See `.electron-aaos-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md` for complete spec
- See `.electron-aaos-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md` for personality guidelines

---

**Template Version:** 2.0
**Last Updated:** 2025-01-14
**Applies to:** All tasks with Electron AAOS Task Format V1.0 + Personalized Agents (Story 6.1.2+)
