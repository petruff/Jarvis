...
Multi-provider AI integration for Electron AAOS. Supports Claude Code and Gemini CLI with automatic fallback and task-based routing.
...
Create `.electron-aaos-ai-config.yaml` in project root:
