...
Project Management tool adapters for Electron AAOS. Enables story synchronization with various PM tools.
...
PM tool is configured via `.electron-aaos-pm-config.yaml` in the project root:
