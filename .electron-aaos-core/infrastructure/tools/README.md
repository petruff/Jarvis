# Electron AAOS Tools - Integrations Directory

This directory contains tool integration definitions for Electron AAOS Electron AAOS agents. Tools are external capabilities that agents can discover and use to accomplish tasks.
...
ls -la .electron-aaos-core/tools/cli/
ls -la .electron-aaos-core/tools/local/
ls -la .electron-aaos-core/tools/mcp/

# Test tool resolver
node .electron-aaos-core/infrastructure/scripts/tool-resolver.js
```
