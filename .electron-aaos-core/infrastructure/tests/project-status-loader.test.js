...
describe('ProjectStatusLoader', () => {
  ...
  beforeEach(async () => {
    ...
    testRoot = await fs.mkdtemp(path.join(os.tmpdir(), 'electron-aaos-test-'));
    loader = new ProjectStatusLoader(testRoot);
    cacheFile = path.join(testRoot, '.electron-aaos', 'project-status.yaml');
  });
  ...
  describe('formatStatusDisplay', () => {
    ...
    it('should display worktrees summary in status', () => {
      const status = {
        ...
        worktrees: {
          'STORY-42': {
            path: '.electron-aaos/worktrees/STORY-42',
          ...
          'STORY-43': {
            path: '.electron-aaos/worktrees/STORY-43',
  ...
  describe('getWorktreesStatus', () => {
    ...
    it('should return worktree info with required fields', async () => {
      ...
      try {
        ...
        const worktreePath = path.join(testRoot, '.electron-aaos', 'worktrees', 'STORY-TEST');
  ...
  describe('generateStatus with worktrees', () => {
    it('should include worktrees in generated status', async () => {
      ...
      try {
        ...
        // Create worktree
        const worktreePath = path.join(testRoot, '.electron-aaos', 'worktrees', 'STORY-GEN');
