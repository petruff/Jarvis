 ...
 *
 * Systematically tests all utilities in .electron-aaos-core/scripts/ and classifies them
 * as WORKING, FIXABLE, or DEPRECATED based on their functional status.
 *
 * Usage: node .electron-aaos-core/scripts/test-utilities.js
 */
...
async function countIntegrationReferences(utilityName) {
  ...
  const searchDirs = [
    '.electron-aaos-core/agents',
    '.electron-aaos-core/tasks',
    'expansion-packs',
  ];
