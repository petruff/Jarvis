/**
 * Transaction Manager for Electron AAOS Electron AAOS
...
class TransactionManager {
  constructor(options = {}) {
    ...
    this.transactionPath = path.join(this.rootPath, 'electron-aaos-core', 'transactions');
    this.backupPath = path.join(this.rootPath, 'electron-aaos-core', 'backups');
  ...
  async rollbackManifestUpdate(operation, results) {
    try {
      const manifestPath = path.join(this.rootPath, 'electron-aaos-core', 'team-manifest.yaml');
