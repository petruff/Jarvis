...
function loadConfig(projectRoot) {
  const configPath = path.join(projectRoot, '.electron-aaos-core', 'core-config.yaml');
  ...
  const defaultConfig = {
    ...
    redirects: {
      ...
      'electron-aaos-orchestrator': 'electron-aaos-master',
...
function showHelp() {
  console.log(`
${colors.bright}IDE Sync${colors.reset} - Sync Electron AAOS agents to IDE command files
