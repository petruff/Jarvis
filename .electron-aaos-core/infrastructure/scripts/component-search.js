...
/**
 * Component search utility for Electron AAOS Electron AAOS framework
...
class ComponentSearch {
  ...
  async searchComponent(componentType, componentName) {
    ...
    const searchPaths = [
      path.join(this.rootPath, 'electron-aaos-core', typeConfig.directory),
  ...
  async findRegistrationFile(componentType, componentName) {
    const possibleRegistrationFiles = [
      path.join(this.rootPath, 'electron-aaos-core', 'registry.json'),
