...
/**
 * Electron AAOS Agent Migration Script (V2 → V3)
...
// Paths
const AGENTS_DIR = '.electron-aaos-core/development/agents';
const BACKUP_DIR = '.electron-aaos/migration-backup';
const SCHEMAS_DIR = '.electron-aaos-core/schemas';
...
function formatListOutput(agents) {
  ...
  lines.push('');
  lines.push('═══════════════════════════════════════════════════════════');
  lines.push('  Electron AAOS Agents - Migration Status');
  lines.push('═══════════════════════════════════════════════════════════');
  lines.push('');
