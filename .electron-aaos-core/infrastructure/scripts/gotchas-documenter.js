...
/**
 * Electron AAOS Gotchas Documenter
 *
 ...
 * - AC2: Generates `.electron-aaos/gotchas.md` consolidated
...
const CONFIG = {
  ...
  outputJsonPath: '.electron-aaos/gotchas.json',
  ...
  // Schema version
  schemaVersion: 'electron-aaos-gotchas-v1',
};
...
*Generated by Electron AAOS Gotchas Documenter v${CONFIG.version}*
`;
  ...
  static showHelp() {
    console.log(`
Gotchas Documenter - Electron AAOS Memory Layer (Story 7.4)
