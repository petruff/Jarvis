...
/**
 * Usage pattern analyzer for Electron AAOS Electron AAOS framework components
...
class UsageAnalytics {
  ...
  isExcludedDirectory(name) {
    const excludes = ['node_modules', '.git', '.electron-aaos', 'dist', 'build', 'coverage'];
