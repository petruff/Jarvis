...
/**
 * Framework structure analyzer for Electron AAOS Electron AAOS
 * Discovers and catalogs all framework components
 */
class FrameworkAnalyzer {
  constructor(options = {}) {
    this.rootPath = options.rootPath || process.cwd();
    this.electron-aaosCoreDir = path.join(this.rootPath, 'electron-aaos-core');
  ...
  async discoverAgents() {
    const agents = [];
    const agentsDir = path.join(this.electron-aaosCoreDir, 'agents');
  ...
  async discoverTasks() {
    const tasks = [];
    const tasksDir = path.join(this.electron-aaosCoreDir, 'tasks');
  ...
  async discoverWorkflows() {
    const workflows = [];
    const workflowsDir = path.join(this.electron-aaosCoreDir, 'workflows');
  ...
  async discoverUtils() {
    const utils = [];
    const utilsDir = path.join(this.electron-aaosCoreDir, 'utils');
  ...
  async discoverTemplates() {
    const templates = [];
    const templatesDir = path.join(this.electron-aaosCoreDir, 'templates');
