...
/**
 * Electron AAOS Asset Inventory Generator
 * Story 2.1: Creates comprehensive inventory of all Electron AAOS assets
 *
 * Usage:
...
const ASSET_PATHS = {
  ...
  templates: '.electron-aaos-core/product/templates',
  checklists: '.electron-aaos-core/product/checklists',
  scripts: '.electron-aaos-core/infrastructure/scripts',
  schemas: '.electron-aaos-core/schemas',
...
function formatConsoleOutput(report, verbose = false) {
  ...
  lines.push('');
  lines.push('═══════════════════════════════════════════════════════════');
  lines.push('  Electron AAOS Asset Inventory');
...
Options:
  ...
  // Find project root (look for .electron-aaos-core directory)
