 ...
 * 
 * Electron AAOS Config Loader with Lazy Loading
 *
...
const agentRequirements = {
  ...
  'electron-aaos-master': ['frameworkDocsLocation', 'projectDocsLocation', 'devLoadAlwaysFiles', 'lazyLoading', 'registry', 'expansionPacks', 'toolConfigurations'],
...
async function loadFullConfig() {
  const configPath = path.join('.electron-aaos-core', 'core-config.yaml');
