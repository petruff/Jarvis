 ...
 *
 * Writes the current Electron AAOS agent status to .electron-aaos/dashboard/status.json
...
const STATUS_DIR = '.electron-aaos/dashboard';
 ...
 * Uses Electron AAOS_PROJECT_ROOT env var or cwd
 */
function getProjectRoot() {
  return process.env.Electron AAOS_PROJECT_ROOT || process.cwd();
}
