...
/**
 * Dependency impact analyzer for Electron AAOS Electron AAOS framework
...
class DependencyImpactAnalyzer {
  ...
  extractDependenciesFromContent(content, filePath) {
    ...
    // Extract Electron AAOS-specific references
  ...
  categorizeDependency(dep, dependencies, filePath) {
    ...
    } else if (dep.includes('electron-aaos-core/') || dep.includes('/electron-aaos-core/')) {
