...
async function loadConfig(configPath) {
  const defaultPath = path.join(process.cwd(), '.electron-aaos-core', 'core-config.yaml');
...
async function main() {
  ...
  if (args.length === 0 || args.includes('--help') || args.includes('-h')) {
    console.log(`
${chalk.bold('Stuck Detector')} - Electron AAOS Auto-Claude Recovery System (Story 5.2)
