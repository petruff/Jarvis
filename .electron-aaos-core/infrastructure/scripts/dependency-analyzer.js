/**
 * Dependency Analyzer for Electron AAOS Electron AAOS
...
class DependencyAnalyzer {
  constructor(options = {}) {
    ...
    this.manifestPath = path.join(this.rootPath, 'electron-aaos-core', 'team-manifest.yaml');
    
    // Component paths
    this.paths = {
      agents: path.join(this.rootPath, 'electron-aaos-core', 'agents'),
      tasks: path.join(this.rootPath, 'electron-aaos-core', 'tasks'),
      workflows: path.join(this.rootPath, 'electron-aaos-core', 'workflows'),
    };
    ...
    switch (type) {
      ...
      case 'task':
        ...
        return {
          ...
          agentName: 'electron-aaos-developer',
        };
