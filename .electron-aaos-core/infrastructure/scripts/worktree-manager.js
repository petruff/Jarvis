 ...
 * @property {string} [worktreeDir='.electron-aaos/worktrees'] - Directory for worktrees
 ...
 * @property {string} [mergeLogDir='.electron-aaos/logs/merges'] - Directory for merge audit logs
 */
...
class WorktreeManager {
  ...
  constructor(projectRoot, options = {}) {
    ...
    this.worktreeDir = options.worktreeDir || '.electron-aaos/worktrees';
    this.branchPrefix = options.branchPrefix || 'auto-claude/';
    this.staleDays = options.staleDays || 30;
    this.mergeLogDir = options.mergeLogDir || '.electron-aaos/logs/merges';
    this.gitPath = 'git';
  }
