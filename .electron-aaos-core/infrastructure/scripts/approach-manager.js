...
/**
 * Electron AAOS Approach Manager
 *
...
const CONFIG = {
  ...
  templatePath: '.electron-aaos-core/product/templates/current-approach-tmpl.md',
...
async function main() {
  ...
  if (args.length < 1 || args.includes('--help') || args.includes('-h')) {
    console.log(`
Approach Manager - Electron AAOS Recovery System (Story 5.3)
