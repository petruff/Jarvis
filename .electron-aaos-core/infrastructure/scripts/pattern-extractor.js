...
/**
 * Electron AAOS Pattern Extractor
...
const EXCLUDED_DIRS = [
  ...
  'temp',
  '__pycache__',
  '.electron-aaos/migration-backup',
];
...
\`\`\``,
  ...
  async savePatterns(outputPath) {
    const defaultPath = path.join(this.rootPath, '.electron-aaos', 'patterns.md');
...
`);
  ...
  // Find project root (look for package.json or .electron-aaos-core)
