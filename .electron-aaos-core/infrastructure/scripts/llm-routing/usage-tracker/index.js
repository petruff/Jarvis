 ...
 * @location .electron-aaos-core/infrastructure/scripts/llm-routing/usage-tracker/
 */
...
const DATA_DIR = path.join(os.homedir(), '.electron-aaos', 'usage-tracking');
...
║  Data File:    ~/.electron-aaos/usage-tracking/deepseek-usage.json  ║
╠════════════════════════════════════════════════════════════╣
║  Endpoints:                                                ║
║    /health     - Health check                              ║
