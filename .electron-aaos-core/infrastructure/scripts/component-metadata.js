/**
 * Component Metadata Manager for Electron AAOS Electron AAOS
...
class ComponentMetadata {
  constructor(options = {}) {
    ...
    this.metadataPath = path.join(this.rootPath, 'electron-aaos-core', 'metadata');

    // Initialize memory adapter if available
    this.memoryClient = MemoryAdapter ? new MemoryAdapter({
      persistencePath: path.join(this.rootPath, 'electron-aaos-memory-layer-mvp', 'data'),
