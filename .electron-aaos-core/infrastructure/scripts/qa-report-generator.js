...
/**
 * Electron AAOS QA Report Generator
 *
...
const CONFIG = {
  ...
  // Template path
  templatePath: '.electron-aaos-core/product/templates/qa-report-tmpl.md',
...
*Generated by Electron AAOS QA Report Generator v1.0*
`;
  }
  ...
  toJSON() {
    ...
    return {
      schema: 'electron-aaos-qa-report-v1',
...
async function main() {
  ...
  if (args.length < 1 || args.includes('--help') || args.includes('-h')) {
    console.log(`
QA Report Generator - Electron AAOS QA Evolution (Story 6.2)
