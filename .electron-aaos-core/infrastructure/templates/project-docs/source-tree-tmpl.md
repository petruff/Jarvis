...
> **Auto-generated by Electron AAOS** on {{GENERATED_DATE}}
...
```
{{PROJECT_NAME}}/
├── .electron-aaos-core/                    # Electron AAOS configuration
...
|------|----------|---------|
| `.electron-aaos-core/core-config.yaml` | Root | Electron AAOS configuration |
...
*Generated by Electron AAOS Documentation Integrity System*
