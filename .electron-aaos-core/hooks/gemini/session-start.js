#!/usr/bin/env node
/**
 * Electron AAOS Session Start Hook for Gemini CLI
 * Story GEMINI-INT.6 - Electron AAOS Hooks System
 *
 * Executes at session start to load Electron AAOS context and memory.
...
async function sessionStart() {
  ...
  try {
    const codebaseMapPath = path.join(projectDir, '.electron-aaos', 'codebase-map.json');
