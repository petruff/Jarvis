# Electron AAOS V3 Schemas

> Schema definitions for Electron AAOS agents and tasks with Auto-Claude capabilities.
...
- **V2 (Legacy)**: Current Electron AAOS format without `autoClaude` section
...
```bash
node validate-v3-schema.js .electron-aaos-core/development/agents/dev.md
```
...
```bash
node validate-v3-schema.js --diff .electron-aaos-core/development/agents/dev.md
```
...
```bash
node validate-v3-schema.js .electron-aaos-core/development/agents/dev.md --strict
```
...
- PRD: `docs/prd/electron-aaos-autonomous-development-engine.md`
- Auto-Claude Analysis: `docs/architecture/AUTO-CLAUDE-ANALYSIS-COMPLETE.md`
- Migration Stories: `docs/stories/electron-aaos-core-ade/epic-2-migration-v2-v3.md`
...
_Electron AAOS V3 Schemas - Electron AAOS Framework_
