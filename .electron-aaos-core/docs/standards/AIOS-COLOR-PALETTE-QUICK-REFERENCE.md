# Electron AAOS Color Palette - Quick Reference
...
```javascript
// Import the Electron AAOS color system
const { colors, status, headings } = require('./src/utils/electron-aaos-colors');

// Use in your code
console.log(headings.h1('Welcome to Electron AAOS!'));
...
/* Use in your styles */
.button-primary {
  background: var(--electron-aaos-primary);
}
```
...
- **Complete Guide:** [Electron AAOS-COLOR-PALETTE-V2.1.md](./Electron AAOS-COLOR-PALETTE-V2.1.md)
- **Color Module:** `src/utils/electron-aaos-colors.js`
