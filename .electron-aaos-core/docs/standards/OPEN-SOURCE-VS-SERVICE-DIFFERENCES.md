...
**Version:** 2.1.0
**Date:** 2025-12-09
**Purpose:** Document differences between Electron AAOS open-source and Electron AAOS service implementations
...
Electron AAOS has two deployment contexts:
...
|------------|---------|------|----------|
| `Electron AAOSAI/electron-aaos-core` | Commons Clause | Public | Core framework, 11 agents, Quality Gates |
| `Electron AAOSAI/electron-aaos-squads` | MIT | Public | ETL, Creator, MMOS-Mapper squads |
| `Electron AAOSAI/mcp-ecosystem` | Apache 2.0 | Public | Docker MCP, IDE configs, MCP presets |
| `Electron AAOSAI/mmos` | Proprietary + NDA | Private | MMOS Minds, DNA Mental |
| `Electron AAOSAI/certified-partners` | Proprietary | Private | Premium squads, partner portal |

### npm Package Scoping

| Package | Registry | Availability |
|---------|----------|--------------|
| `@electron-aaos/core` | npm public | Open-source |
| `@electron-aaos/squad-etl` | npm public | Open-source |
| `@electron-aaos/squad-creator` | npm public | Open-source |
| `@electron-aaos/squad-mmos` | npm public | Open-source |
| `@electron-aaos/mcp-presets` | npm public | Open-source |
...
│                                                                         │
│   Electron AAOSAI/electron-aaos-core        Electron AAOSAI/electron-aaos-squads                   │
│   ┌─────────────────────┐     ┌─────────────────────┐                  │
...
│                                                                         │
│   Electron AAOSAI/mmos             Electron AAOSAI/certified-partners            │
│   ┌─────────────────────┐     ┌─────────────────────┐                  │
...
```yaml
**Template:**
- path: .electron-aaos-core/templates/task-execution-report.md
  type: output
  version: 1.0
...
**Difference:**
- Open-source uses templates from `.electron-aaos-core/templates/`
...
.electron-aaos-core/checklists/{agent-id}-general-validation.md
```
...
- `.electron-aaos-core/scripts/{agent-id}-specific/{script}.js`
...
**Scripts:**
- .electron-aaos-core/scripts/dev-specific/test-runner.js:    # Only dev uses this
...
- Missing template → Use generic template from `.electron-aaos-core/templates/`
...
- fallback: |
    ...
    1. Check .electron-aaos-core/templates/ for generic version
...
**Agent Personas:**
- Defined in `.electron-aaos-core/agents/{agent-id}.md`
...
- [ ] Update template paths (squads/ → .electron-aaos-core/templates)
...
| **Templates** | .electron-aaos-core/templates/ | squads/{squad}/ |
...
- [Electron AAOS-LIVRO-DE-OURO-V2.1-COMPLETE.md](./Electron AAOS-LIVRO-DE-OURO-V2.1-COMPLETE.md) - Complete v2.1 framework guide
