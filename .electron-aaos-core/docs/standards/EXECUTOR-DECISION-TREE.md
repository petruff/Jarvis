# Electron AAOS Executor Decision Tree
...
This document defines HOW to choose the appropriate executor type (Agente, Worker, Humano, Clone) for any Electron AAOS Task based on task characteristics, requirements, and constraints.
