# Electron AAOS Task Format Specification V1.0
...
This document defines the UNIVERSAL format for Electron AAOS Tasks, ensuring consistency, scalability, and reusability across workflows, executors, and teams.

---

## Task Format Overview

Every Electron AAOS Task MUST follow this structure:
...
- callAgent:
    version: 1.0.0
    used_for: Electron AAOS agent caller with retry logic
...
Use this checklist to validate any Electron AAOS Task:
