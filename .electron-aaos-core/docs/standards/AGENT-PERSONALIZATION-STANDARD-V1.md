...
│   (.electron-aaos-core/agents/*.md)          │
└─────────────────────────────────────┘
              ↓
┌─────────────────────────────────────┐
│   LAYER 2: Output Formatter         │  ← Template engine (JS)
│   (.electron-aaos-core/infrastructure/scripts/)│
└─────────────────────────────────────┘
              ↓
┌─────────────────────────────────────┐
...
```yaml
# .electron-aaos-core/agents/{agent-id}.md
...
```yaml
# .electron-aaos-core/data/archetype-vocabulary.yaml
...
```javascript
// .electron-aaos-core/infrastructure/scripts/output-formatter.js
...
```javascript
// .electron-aaos-core/infrastructure/scripts/validate-output-pattern.js
...
```markdown
<!-- .electron-aaos-core/templates/task-execution-report.md -->
...
```markdown
<!-- .electron-aaos-core/templates/agent-checklist-template.md -->
...
```yaml
# .electron-aaos-core/workflows/{workflow-name}.yaml
...
11. Merge electron-aaos-developer + electron-aaos-orchestrator → electron-aaos-master.md → Orion (Orchestrator)
