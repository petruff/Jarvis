...
/.electron-aaos-core/core/ @architect @senior-devs
...
reviews:
  path_instructions:
    ...
    - path: ".electron-aaos-core/docs/standards/**"
      instructions: |
        Verify:
    ...
    - path: "squads/**"
      instructions: |
        ...
        - peerDependency on @electron-aaos/core declared
