...
**Created:** 2025-01-20  
**Status:** Active  
**Scope:** All Electron AAOS CLI tools, installer, and visual outputs
...
The Electron AAOS color palette is derived from the brand logo's vibrant gradient:
...
:root {
  /* Brand Colors */
  --electron-aaos-primary: #8B5CF6;
  --electron-aaos-secondary: #EC4899;
  --electron-aaos-tertiary: #3B82F6;
  
  /* Functional Colors */
  --electron-aaos-success: #10B981;
  --electron-aaos-warning: #F59E0B;
  --electron-aaos-error: #EF4444;
  --electron-aaos-info: #06B6D4;
  
  /* Neutral Colors */
  --electron-aaos-muted: #94A3B8;
  --electron-aaos-dim: #64748B;
  
  /* Gradient */
  --electron-aaos-gradient: linear-gradient(135deg, #EC4899 0%, #8B5CF6 50%, #3B82F6 100%);
}
```
...
- Use `colors.brandPrimary` (purple bold) for Electron AAOS branding
- Example: Welcome screens, major section headers

```javascript
console.log(colors.brandPrimary('🎉 Electron AAOS v2.1 Installer'));
```
...
// Success
console.log(colors.success('\n✓ All done! Your Electron AAOS project is ready.\n'));
```
  ...
  "electron-aaos": {
    "color": {
      "primary": {
        "$type": "color",
        "$value": "#8B5CF6",
        "$description": "Electron AAOS primary brand color (ClickUp-inspired purple)"
      },
      "secondary": {
        "$type": "color",
        "$value": "#EC4899",
        "$description": "Electron AAOS secondary brand color (magenta accent)"
      },
      "success": {
        "$type": "color",
        "$value": "#10B981",
    ...
    "gradient": {
      "brand": {
        ...
        "$description": "Electron AAOS brand gradient (logo-inspired)"
      }
    }
  }
}
...
|---------|------|---------|--------|
| 2.1.0 | 2025-01-20 | Initial Electron AAOS Color Palette - Logo-inspired gradient + ClickUp purple | Uma (UX-Design Expert) |

---

## 🔗 Related Documents

- [Electron AAOS-LIVRO-DE-OURO-V2.1](./Electron AAOS-LIVRO-DE-OURO-V2.1-SUMMARY.md) - Complete Electron AAOS standards
