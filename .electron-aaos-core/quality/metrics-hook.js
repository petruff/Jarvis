 ...
 * const { recordPreCommitMetrics } = require('./.electron-aaos-core/quality/metrics-hook');
 ...
 *
 * @example
 * const { recordPRReviewMetrics } = require('./.electron-aaos-core/quality/metrics-hook');
 ...
 *
 * @example
 * const { recordHumanReviewMetrics } = require('./.electron-aaos-core/quality/metrics-hook');
 ...
 *
 * @example
 * const { withPreCommitMetrics } = require('./.electron-aaos-core/quality/metrics-hook');
 *
