...
/**
 * Test template system for Electron AAOS Electron AAOS automated test generation
 * Provides reusable templates for generating different types of tests
 */
class TestTemplateSystem {
  constructor(options = {}) {
    this.rootPath = options.rootPath || process.cwd();
    this.templatesDir = path.join(this.rootPath, 'electron-aaos-core', 'templates', 'tests');
  ...
  async generateTestContent(component, testFile, config) {
    ...
    const templateData = {
      ...
      metadata: {
        ...
        generator: 'Electron AAOS Test Template System',
        version: '1.0.0',
      },
    };
    ...
    return {
      agent: {
        ...
        setup: {
          ...
          beforeEach: [
            "agentPath = path.join(__dirname, '../../../electron-aaos-core/agents/{{component.name}}.md');",
      ...
      task: {
        ...
        setup: {
          ...
          beforeEach: [
            "taskPath = path.join(__dirname, '../../../electron-aaos-core/tasks/{{component.name}}.md');",
      ...
      workflow: {
        ...
        setup: {
          ...
          beforeEach: [
            "workflowPath = path.join(__dirname, '../../../electron-aaos-core/workflows/{{component.name}}.yaml');",
      ...
      util: {
        ...
        setup: {
          ...
          beforeEach: [
            "UtilClass = require('../../../electron-aaos-core/scripts/{{component.name}}');",
...
afterAll(async () => {
  ...
  renderMetadata(metadata, data) {
    return `
// Generated by Electron AAOS Test Template System
