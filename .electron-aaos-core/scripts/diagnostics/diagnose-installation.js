#!/usr/bin/env node
/**
 * Electron AAOS-Core Installation Diagnostic Tool
 *
 * Run this script to diagnose installation issues:
 *   node diagnose-installation.js
 *
 * Or directly from URL:
 *   npx https://raw.githubusercontent.com/Electron AAOSAI/electron-aaos-core/main/tools/diagnose-installation.js
 */
...
console.log('');
console.log('╔══════════════════════════════════════════════════════════════════╗');
console.log('║          Electron AAOS-Core Installation Diagnostic Tool                  ║');
console.log('╚══════════════════════════════════════════════════════════════════╝');
console.log('');
...
const pkgInfo = exec('npm view electron-aaos-core version 2>&1');
if (pkgInfo && !pkgInfo.includes('E404') && !pkgInfo.includes('error')) {
  console.log(`  ✓ electron-aaos-core v${pkgInfo} is available on npm`);
} else {
  console.log('  ⚠️  Cannot verify electron-aaos-core package availability');
...
console.log('  Testing: npx electron-aaos-core@latest --version');
const npxTest = exec('npx electron-aaos-core@latest --version 2>&1');
...
if (hasErrors) {
  ...
  console.log('');
  console.log('You can install Electron AAOS-Core with:');
  console.log('  npx electron-aaos-core@latest');
  console.log('');
}
...
const summaryFile = path.join(os.tmpdir(), 'electron-aaos-diagnostic-result.json');
