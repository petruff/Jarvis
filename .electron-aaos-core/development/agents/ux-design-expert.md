...
IDE-FILE-RESOLUTION:
  ...
  - Dependencies map to electron-aaos-core/{type}/{name}
  - type=folder (tasks|templates|checklists|data|workflows|etc...), name=file-name
  - Example: audit-codebase.md → electron-aaos-core/tasks/audit-codebase.md
...
activation-instructions:
  ...
  - STEP 3: |
      Activate using .electron-aaos-core/development/scripts/unified-activation-pipeline.js
...
agent:
  ...
  customization: |
    ...
    Phase 1 Commands:
    *research        → Read("electron-aaos-core/tasks/ux-user-research.md")
    *wireframe       → Read("electron-aaos-core/tasks/ux-create-wireframe.md")
    *generate-ui-prompt → Read("electron-aaos-core/tasks/generate-ai-frontend-prompt.md")
    *create-front-end-spec → Read("electron-aaos-core/tasks/create-doc.md") + template

    Phase 2 Commands:
    *audit           → Read("electron-aaos-core/tasks/audit-codebase.md")
    *consolidate     → Read("electron-aaos-core/tasks/consolidate-patterns.md")
    *shock-report    → Read("electron-aaos-core/tasks/generate-shock-report.md")

    Phase 3 Commands:
    *tokenize        → Read("electron-aaos-core/tasks/extract-tokens.md")
    *setup           → Read("electron-aaos-core/tasks/setup-design-system.md")
    *migrate         → Read("electron-aaos-core/tasks/generate-migration-strategy.md")
    *upgrade-tailwind → Read("electron-aaos-core/tasks/tailwind-upgrade.md")
    *audit-tailwind-config → Read("electron-aaos-core/tasks/audit-tailwind-config.md")
    *export-dtcg     → Read("electron-aaos-core/tasks/export-design-tokens-dtcg.md")
    *bootstrap-shadcn → Read("electron-aaos-core/tasks/bootstrap-shadcn-library.md")

    Phase 4 Commands:
    *build           → Read("electron-aaos-core/tasks/build-component.md")
    *compose         → Read("electron-aaos-core/tasks/compose-molecule.md")
    *extend          → Read("electron-aaos-core/tasks/extend-pattern.md")

    Phase 5 Commands:
    *document        → Read("electron-aaos-core/tasks/generate-documentation.md")
    *a11y-check      → Read("electron-aaos-core/checklists/accessibility-wcag-checklist.md")
    *calculate-roi   → Read("electron-aaos-core/tasks/calculate-roi.md")

    Universal Commands:
    *scan            → Read("electron-aaos-core/tasks/ux-ds-scan-artifact.md")
    *integrate       → Read("electron-aaos-core/tasks/integrate-Squad.md")
