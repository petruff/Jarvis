...
dependencies:
  ...
  repository_agnostic_design:
    ...
    installation_modes:
      framework-development: '.electron-aaos-core/ is SOURCE CODE (committed to git)'
      project-development: '.electron-aaos-core/ is DEPENDENCY (gitignored, in node_modules)'
    detection_priority:
      - '.electron-aaos-installation-config.yaml (explicit user choice)'
  ...
  git_authority:
    ...
    enforcement_mechanism: |
      ...
      - Works in ANY repository using Electron AAOS-FullStack
