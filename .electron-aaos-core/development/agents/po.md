...
command_availability:
  sync-story:
    ...
    description: |
      ...
      If no PM tool configured, runs `electron-aaos init` prompt
  pull-story:
    always_available: true
    description: |
...
- For course corrections → Escalate to `@electron-aaos-master *correct-course`
...
3. Story templates available in `.electron-aaos-core/product/templates/`
