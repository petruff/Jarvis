...
activation-instructions:
  ...
  - STAY IN CHARACTER!
  - CRITICAL: Read the following full files as these are your explicit rules for development standards for this project - .electron-aaos-core/core-config.yaml devLoadAlwaysFiles list
...
dependencies:
  ...
  coderabbit_integration:
    ...
    workflow: |
      ...
      WHILE iteration < max_iterations:
        1. Run: wsl bash -c 'cd /mnt/c/.../@electron-aaos/electron-aaos-core && ~/.local/bin/coderabbit --prompt-only -t uncommitted'
  ...
  decision_logging:
    ...
    utility: '.electron-aaos-core/utils/decision-log-generator.js'
    ...
    usage_example: |
      ...
      const { generateDecisionLog } = require('.electron-aaos-core/utils/decision-log-generator');
