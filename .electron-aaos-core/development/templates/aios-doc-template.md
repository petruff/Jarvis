# Electron AAOS Documentation Template
...
This document provides the standard template structure for Electron AAOS documentation. All documentation in the Electron AAOS framework should follow this template to ensure consistency and ease of navigation.
...
_Last Updated: {{DATE}} | Electron AAOS Framework Team_
```
...
Brief description of what this document covers and its purpose within the Electron AAOS framework.
...
**Version:** 1.0.0
**Last Updated:** 2026-01-28
**Audience:** Developers extending Electron AAOS

---

## Overview

This guide explains how to create custom agents for the Electron AAOS framework.
...
- [Electron AAOS Framework Documentation](/docs/README.md)
