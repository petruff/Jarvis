...
> Each variable is replaced at runtime by the orchestrator (electron-aaos-master) before spawning the subagent via the Task tool.
...
|---------|-----------|-----------|-----------|
| `core` | `.electron-aaos-core/development/agents/{agent}.md` | `.electron-aaos-core/development/tasks/{uses}.md` | `.electron-aaos-core/data/{file}` |
...
2. If not found, check `.electron-aaos-core/development/agents/{agent}.md`
...
- The orchestrator (electron-aaos-master) builds the prompt by reading files and replacing variables
