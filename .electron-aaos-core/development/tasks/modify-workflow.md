...
- **Tool:** ast-parser
  ...
  - **Source:** .electron-aaos-core/utils/ast-parser.js
...
- **Script:** modify-file.js
  ...
  - **Language:** JavaScript
  - **Location:** .electron-aaos-core/scripts/modify-file.js
...
- Target workflow must exist (path resolved from target_context):
  - `core` → `.electron-aaos-core/development/workflows/`
...
- Resolve workflow path based on target_context:
  - `core` → `.electron-aaos-core/development/workflows/{workflow-name}.yaml`
...
- Create timestamped backup in same context:
  - `core` → `.electron-aaos-core/development/workflows/.backups/{workflow-name}.yaml.{timestamp}`
...
+ modified_by: electron-aaos-developer
