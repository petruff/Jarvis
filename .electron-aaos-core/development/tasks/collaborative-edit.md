...
# Collaborative Edit - Electron AAOS Developer Task
...
*collaborative-edit start --component electron-aaos-core/agents/data-agent.md --participants alice,bob --mode live
...
class CollaborativeEditTask extends EventEmitter {
  constructor() {
    ...
    this.sessionDir = path.join(this.rootPath, '.electron-aaos', 'sessions');
  ...
  async execute(params) {
    try {
      console.log(chalk.blue('👥 Electron AAOS Collaborative Editing'));
