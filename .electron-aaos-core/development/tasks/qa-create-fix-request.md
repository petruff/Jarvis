...
- **Script:** parse-qa-report.js
  ...
  - **Language:** JavaScript
  - **Location:** .electron-aaos-core/development/scripts/parse-qa-report.js (optional)
...
_Generated by Quinn (Test Architect) - Electron AAOS QA System_
...
**Location:** `.electron-aaos-core/development/tasks/qa-review-story.md`
