...
pre-conditions:
  ...
  - [ ] Pattern storage exists
    tipo: pre-condition
    blocker: false
    validação: Check .electron-aaos-core/data/learned-patterns.yaml exists
...
```javascript
const learning = require('.electron-aaos-core/workflow-intelligence/learning');
...
Storage file: .electron-aaos-core/data/learned-patterns.yaml
...
try {
  ...
  console.log('Try running: rm .electron-aaos-core/data/learned-patterns.yaml');
}
```
