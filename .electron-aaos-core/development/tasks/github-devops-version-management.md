...
**Purpose**: Analyze changes, recommend version bumps, and manage semantic versioning for ANY repository using Electron AAOS.
...
if (!context) {
  throw new Error('Unable to detect repository context. Run "electron-aaos init" first.');
}
