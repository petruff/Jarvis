...
atomic_layer: task
Entrada: |
  - preset_path: Path to the tech preset file (default: .electron-aaos-core/data/tech-presets/)
...
1. Resolve preset path
   ...
   ├── If name provided → resolve via .electron-aaos-core/data/tech-presets/{name}.md
...
- Preset: .electron-aaos-core/data/tech-presets/{name}.md
```

## Related

- **Agent:** @architect (Aria)
- **Location:** .electron-aaos-core/data/tech-presets/
