...
# Deprecate Component - Electron AAOS Developer Task
...
*deprecate-component util old-logger --replacement @electron-aaos/logger --migration-guide docs/migration/logger.md --severity high
...
class DeprecateComponentTask {
  ...
  async execute(params) {
    try {
      console.log(chalk.blue('🚫 Electron AAOS Component Deprecation'));
