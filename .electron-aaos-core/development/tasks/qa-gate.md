...
**ALWAYS** check the `electron-aaos-core/core-config.yaml` for the `qa.qaLocation/gates`
...
1. **ALWAYS** create gate file at: `qa.qaLocation/gates` from `electron-aaos-core/core-config.yaml`
