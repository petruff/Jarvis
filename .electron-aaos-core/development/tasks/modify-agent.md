...
- Target agent must exist in `electron-aaos-core/agents/`
...
- Load target agent from `electron-aaos-core/agents/{agent-name}.md`
- Parse YAML header and markdown content separately
- Create timestamped backup: `electron-aaos-core/agents/.backups/{agent-name}.md.{timestamp}`
