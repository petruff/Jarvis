...
- Dashboard status at `.electron-aaos/dashboard/status.json`
- State saved at `.electron-aaos/master-orchestrator/{story-id}.json`
- Logs at `.electron-aaos/logs/{story-id}.log`
