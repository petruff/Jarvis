...
```javascript
const { getPMAdapter, isPMToolConfigured } = require('../.electron-aaos-core/scripts/pm-adapter-factory');
...
```javascript
const { pullStoryFromPM } = require('../.electron-aaos-core/scripts/story-manager');
