...
} = require('./.electron-aaos-core/scripts/decision-recorder');
```
...
7. Execute `.electron-aaos-core/product/checklists/story-dod-checklist.md`
...
│    │    wsl bash -c 'cd /mnt/c/.../@electron-aaos/electron-aaos-core &&    │   │
...
- `.electron-aaos-core/product/checklists/story-dod-checklist.md` - Definition of Done checklist
