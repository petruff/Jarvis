...
Lists all Electron AAOS-managed worktrees with their current status, uncommitted changes, and age. Provides visibility into parallel development activities.

**Features:**

- Shows all active worktrees managed by Electron AAOS
...
**Action:** Get all Electron AAOS-managed worktrees
...
[
  {
    "storyId": "STORY-42",
    "path": "/abs/path/.electron-aaos/worktrees/STORY-42",
...
No Electron AAOS-managed worktrees found.
...
**Resolution:** Check Electron AAOS installation.
