...
# User selects from available templates in .electron-aaos-core/product/templates/
tools:
...
If a YAML Template has not been provided, list all templates from .electron-aaos-core/product/templates or ask the user to provide another.
