...
Each component type uses a template from `.electron-aaos-core/development/templates/squad/`:
...
- **Templates:**
  ...
  - `.electron-aaos-core/development/templates/squad/workflow-template.md`
