...
- **Tool:** query-validator
  ...
  - **Source:** .electron-aaos-core/utils/db-query-validator.js
...
- **Script:** db-query.js
  ...
  - **Language:** JavaScript
  - **Location:** .electron-aaos-core/scripts/db-query.js
...
3. `.electron-aaos-core/product/templates/tmpl-smoke-test.sql` (template)
...
elif [ -f ".electron-aaos-core/product/templates/tmpl-smoke-test.sql" ]; then
  SMOKE_TEST=".electron-aaos-core/product/templates/tmpl-smoke-test.sql"
else
