...
- **published_packages**: `array<object>`
  ...
  - **Example**: `[{ registry: "npm", package_name: "electron-aaos-core", version: "2.1.3", url: "https://npmjs.com/package/electron-aaos-core" }]`
...
electron-aaos release create --repo="." --type="auto"
````
