...
pre-conditions:
  ...
  - [ ] WorktreeManager is available
    tipo: pre-condition
    blocker: true
    validação: Script exists at .electron-aaos-core/infrastructure/scripts/worktree-manager.js
    error_message: "WorktreeManager not found. Ensure Electron AAOS is properly installed."
...
post-conditions:
  - [ ] Worktree directory exists
    tipo: post-condition
    blocker: true
    validação: Directory exists at .electron-aaos/worktrees/{storyId}
...
- **Tool:** WorktreeManager
  ...
  - **Source:** .electron-aaos-core/infrastructure/scripts/worktree-manager.js
...
```javascript
const WorktreeManager = require('./.electron-aaos-core/infrastructure/scripts/worktree-manager.js');
...
⚠️  Worktree for '{storyId}' already exists.
    Path: .electron-aaos/worktrees/{storyId}
...
- Directory: `.electron-aaos/worktrees/{storyId}/`
- Branch: `auto-claude/{storyId}`
...
Next Steps:
  • cd .electron-aaos/worktrees/{storyId}  - Navigate to worktree
...
- `.electron-aaos/worktrees/{storyId}/` - Isolated worktree directory
...
```bash
git worktree remove .electron-aaos/worktrees/{storyId}
...
- `.electron-aaos-core/infrastructure/scripts/worktree-manager.js` - Core manager
...
- **Script:** `.electron-aaos-core/infrastructure/scripts/worktree-manager.js`
