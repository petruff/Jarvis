...
- Load `.electron-aaos-core/core-config.yaml`
...
- Identify and load the following inputs:
  ...
  - **Story template**: `electron-aaos-core/templates/story-tmpl.yaml` for completeness validation

### 1. Template Completeness Validation

- Load `electron-aaos-core/templates/story-tmpl.yaml` and extract all section headings from the template
...
**PRD Reference:** Electron AAOS v2.0 "Projeto Bob" - Section 5 (Dynamic Executor Assignment)
