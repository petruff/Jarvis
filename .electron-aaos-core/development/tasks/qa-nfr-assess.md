...
required:
  ...
  - story_path: `electron-aaos-core/core-config.yaml` for the `devStoryLocation`

optional:
  - architecture_refs: `electron-aaos-core/core-config.yaml` for the `architecture.architectureFile`
  - technical_preferences: `electron-aaos-core/core-config.yaml` for the `technicalPreferences`
