...
# Improve Code Quality - Electron AAOS Developer Task
...
*improve-code-quality electron-aaos-core/scripts/legacy-utility.js --preview

# Auto-fix all safe improvements in directory
*improve-code-quality electron-aaos-core/agents --auto-fix --recursive

# Apply specific patterns
*improve-code-quality electron-aaos-core/utils --patterns formatting,modern-syntax,async-await

# Generate improvement report
*improve-code-quality . --recursive --report quality-report.json

# Use custom configuration
*improve-code-quality electron-aaos-core --config .electron-aaos/quality-config.json
```
...
class ImproveCodeQualityTask {
  ...
  async execute(params) {
    try {
      console.log(chalk.blue('🎨 Electron AAOS Code Quality Improvement'));
  ...
  async createBackup(filePath) {
    const backupDir = path.join(this.rootPath, '.electron-aaos', 'backups', 'code-quality');
