...
**Agent:** @electron-aaos-master
**Story:** IDS-7 (electron-aaos-master IDS Governor Integration)
...
```bash
node bin/electron-aaos-ids.js ids:check "your intent" --type task
node bin/electron-aaos-ids.js ids:impact create-doc
node bin/electron-aaos-ids.js ids:stats --json
node bin/electron-aaos-ids.js ids:register path/to/file.md
```
...
- `.electron-aaos-core/core/ids/framework-governor.js` — FrameworkGovernor class
- `.electron-aaos-core/core/ids/registry-loader.js` — RegistryLoader
- `.electron-aaos-core/core/ids/incremental-decision-engine.js` — DecisionEngine
- `.electron-aaos-core/core/ids/registry-updater.js` — RegistryUpdater
- `.electron-aaos-core/core/ids/registry-healer.js` — RegistryHealer (optional, IDS-4a)
