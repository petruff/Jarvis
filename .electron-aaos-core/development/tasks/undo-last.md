...
- **Tool:** backup-manager
  ...
  - **Source:** .electron-aaos-core/utils/backup-manager.js
...
- **Script:** rollback-changes.js
  ...
  - **Language:** JavaScript
  - **Location:** .electron-aaos-core/scripts/rollback-changes.js
...
Rollback the last component creation or modification operation. This task allows undoing recent changes made by the electron-aaos-developer agent, including single component creation, batch creation, or component updates.
...
Operations:
  - Created: /electron-aaos-core/agents/data-analyst.md
  - Updated: /electron-aaos-core/team-manifest.yaml
  - Created: /electron-aaos-core/tasks/analyze-data.md
```
