...
Publishes a local squad to the electron-aaos-squads GitHub repository via Pull Request.
...
PR Preview:
  ...
  Target: Electron AAOSAI/electron-aaos-squads
...
Publishing: my-squad@1.0.0
  ...
  Target: github.com/Electron AAOSAI/electron-aaos-squads
...
Pull Request Created!
  URL: https://github.com/Electron AAOSAI/electron-aaos-squads/pull/42
  Branch: squad/my-squad
...
4. Create/check fork
   └── Fork Electron AAOSAI/electron-aaos-squads if needed
