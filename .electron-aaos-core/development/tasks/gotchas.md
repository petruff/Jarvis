...
steps:
  - name: Load Gotchas
    action: |
      Load gotchas from .electron-aaos/gotchas.json via GotchasMemory
...
- **Script:** `.electron-aaos-core/core/memory/gotchas-memory.js`
- **Source:** `.electron-aaos/gotchas.json`
