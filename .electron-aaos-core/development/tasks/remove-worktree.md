...
post-conditions:
  - [ ] Worktree directory removed
    tipo: post-condition
    blocker: true
    validação: Directory .electron-aaos/worktrees/{storyId} does not exist
...
Removes an Electron AAOS-managed worktree and its associated branch. Includes safety checks for uncommitted changes and provides options for force removal.
...
Options:
  1. Commit changes first    : cd .electron-aaos/worktrees/{storyId} && git commit
...
You are about to remove:
  • Worktree: .electron-aaos/worktrees/{storyId}
  • Branch:   auto-claude/{storyId}
...
1. `git worktree remove .electron-aaos/worktrees/{storyId}`
...
❌ Cannot remove worktree while inside it.
   ...
   Current directory: .electron-aaos/worktrees/{storyId}
...
- `.electron-aaos-core/infrastructure/scripts/worktree-manager.js`
