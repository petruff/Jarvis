...
autoClaude:
  ...
  verification:
    type: script
    script: .electron-aaos-core/infrastructure/scripts/subtask-verifier.js
    timeout: 120
```
  ...
  actions:
    - action: find_implementation
      paths:
        ...
        - .electron-aaos/plans/{storyId}/implementation.yaml
...
step_2:
  actions:
    - action: execute_script
      script: |
        node .electron-aaos-core/infrastructure/scripts/subtask-verifier.js {subtaskId} \
