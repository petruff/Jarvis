...
```javascript
const { generateStoryIndex } = require('.electron-aaos-core/scripts/story-index-generator');
...
Stories by Epic:
- Epic 6.1 Electron AAOS Migration: 45 stories
...
{
  "scripts": {
    "stories:index": "node .electron-aaos-core/scripts/story-index-generator.js docs/stories"
  }
}
```
