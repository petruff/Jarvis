...
- Target task must exist in `electron-aaos-core/tasks/`
...
- Load target task from `electron-aaos-core/tasks/{task-name}.md`
- Create timestamped backup: `electron-aaos-core/tasks/.backups/{task-name}.md.{timestamp}`
