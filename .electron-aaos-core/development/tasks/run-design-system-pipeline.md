...
- **Tool:** build-component
  ...
  - **Source:** .electron-aaos-core/development/tasks/build-component.md

- **Tool:** generate-documentation
  - **Purpose:** Generate Pattern Library docs
  - **Source:** .electron-aaos-core/development/tasks/generate-documentation.md
...
- **Tool:** calculate-roi
  ...
  - **Source:** .electron-aaos-core/development/tasks/calculate-roi.md
  ...
  quality-pipeline:
    ...
    steps:
      ...
      - name: Run Design System Pipeline
        run: npx electron-aaos-core task run-design-system-pipeline --mode=yolo
```
...
{
  "scripts": {
    "ds:pipeline": "npx electron-aaos-core task run-design-system-pipeline",
    "ds:pipeline:ci": "npx electron-aaos-core task run-design-system-pipeline --mode=yolo"
  }
}
```
