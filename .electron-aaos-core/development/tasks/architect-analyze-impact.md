...
alyze Impact - Electron AAOS Developer Task

## Purpose
Analyze the potential impact of proposed component modifications on the broader Electron AAOS Electron AAOS framework.
...
*analyze-impact deprecate electron-aaos-core/scripts/old-helper.js --output-format visual --save-report reports/deprecation-impact.html
...
*analyze-impact remove electron-aaos-core/workflows/legacy-workflow.yaml --depth deep --save-report reports/removal-impact.json
```
...
class AnalyzeImpactTask {
  ...
  async execute(params) {
    try {
      console.log(chalk.blue('🔍 Electron AAOS Impact Analysis'));
...
{
  "success": true,
  "targetComponent": "electron-aaos-core/agents/weather-agent.md",
  "riskLevel": "medium",
