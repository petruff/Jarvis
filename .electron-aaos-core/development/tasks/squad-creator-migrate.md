...
Migrates legacy squad formats to Electron AAOS 2.1 standard.
...
| Missing `electron-aaos.type` | Field not present | Add `electron-aaos.type: squad` |
| Missing `electron-aaos.minVersion` | Field not present | Add `electron-aaos.minVersion: 2.1.0` |
...
───────────────────────────────────────────────────────────
  ...
  ❌ [ERROR] Missing required field: electron-aaos.type
  ❌ [ERROR] Missing required field: electron-aaos.minVersion
...
───────────────────────────────────────────────────────────
  ...
  3. Add field: electron-aaos.type = "squad"
  4. Add field: electron-aaos.minVersion = "2.1.0"
...
───────────────────────────────────────────────────────────
  ...
  Executed Actions:
    ...
    ✅ Add field: electron-aaos.type = "squad" [success]
    ✅ Add field: electron-aaos.minVersion = "2.1.0" [success]
...
───────────────────────────────────────────────────────────
  ...
  Executed Actions:
    ...
    🔍 Add field: electron-aaos.type = "squad" [dry-run]
    🔍 Add field: electron-aaos.minVersion = "2.1.0" [dry-run]
...
```javascript
const { SquadMigrator } = require('./.electron-aaos-core/development/scripts/squad');
...
- **Schema:** .electron-aaos-core/schemas/squad-schema.json
