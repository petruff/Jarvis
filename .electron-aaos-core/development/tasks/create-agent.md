...
**Quality Standard:** Electron AAOS Level (300+ lines, voice_dna, output_examples, command_loader, task files)
...
generate_agent:
  ...
  required_sections:
    # Level 1: Identity
    activation_notice: 'Standard Electron AAOS header'
...
## Integration with Electron AAOS

This task creates agents that:

- Follow Electron AAOS agent definition standards (6 levels)
