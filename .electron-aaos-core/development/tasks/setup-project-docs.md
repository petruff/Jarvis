...
- field: core_config
  type: file
  destination: .electron-aaos-core/core-config.yaml
  persisted: true
...
pre-conditions:
  ...
  - [ ] Documentation Integrity module is available
    ...
    blocker: true
    validation: |
      Verify .electron-aaos-core/infrastructure/scripts/documentation-integrity/index.js exists
...
post-conditions:
  ...
  - [ ] core-config.yaml created with valid deployment section
    ...
    blocker: true
    validation: |
      Verify .electron-aaos-core/core-config.yaml exists and has deployment configuration
...
acceptance-criteria:
  ...
  - [ ] .gitignore properly configured for project
    ...
    blocker: true
    validation: |
      Assert .gitignore includes Electron AAOS ignores and tech stack ignores
...
- **Tool:** documentation-integrity
  ...
  - **Source:** .electron-aaos-core/infrastructure/scripts/documentation-integrity/index.js

- **Tool:** deployment-config-loader
  - **Purpose:** Load and validate deployment configuration
  - **Source:** .electron-aaos-core/infrastructure/scripts/documentation-integrity/deployment-config-loader.js
...
- **Script:** mode-detector.js
  ...
  - **Language:** JavaScript
  - **Location:** .electron-aaos-core/infrastructure/scripts/documentation-integrity/mode-detector.js

- **Script:** doc-generator.js
  - **Purpose:** Generate project documentation from templates
  - **Language:** JavaScript
  - **Location:** .electron-aaos-core/infrastructure/scripts/documentation-integrity/doc-generator.js

- **Script:** config-generator.js
  - **Purpose:** Generate core-config.yaml
  - **Language:** JavaScript
  - **Location:** .electron-aaos-core/infrastructure/scripts/documentation-integrity/config-generator.js

- **Script:** gitignore-generator.js
  - **Purpose:** Generate or merge .gitignore
  - **Language:** JavaScript
  - **Location:** .electron-aaos-core/infrastructure/scripts/documentation-integrity/gitignore-generator.js
...
```javascript
const { detectInstallationMode, collectMarkers } = require('./.electron-aaos-core/infrastructure/scripts/documentation-integrity');
...
|------|-------------|---------|
| `framework-dev` | Contributing to electron-aaos-core itself | Skip project setup, use existing config |
...
```javascript
const { buildDocContext, generateDocs } = require('./.electron-aaos-core/infrastructure/scripts/documentation-integrity');
...
```javascript
const { buildConfigContext, generateConfig, DeploymentWorkflow, DeploymentPlatform } = require('./.electron-aaos-core/infrastructure/scripts/documentation-integrity');
...
```javascript
const { generateGitignoreFile, hasAiosIntegration } = require('./.electron-aaos-core/infrastructure/scripts/documentation-integrity');
...
```javascript
const { loadDeploymentConfig, validateDeploymentConfig } = require('./.electron-aaos-core/infrastructure/scripts/documentation-integrity');
...
Generated Files:
  ...
  ✓ .electron-aaos-core/core-config.yaml
  ✓ .gitignore (created)
