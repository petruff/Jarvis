...
checklists:
  - electron-aaos-master-checklist.md
---
...
- **topic**: `string`
  ...
  - **Example**: "How can we improve user onboarding for Electron AAOS?"
...
```bash
electron-aaos activate Maestro
electron-aaos brainstorm "How can we improve Electron AAOS user onboarding for non-technical users?"
```
...
```bash
electron-aaos brainstorm "How to reduce API latency in database queries?" \
...
```bash
electron-aaos brainstorm "What should be our open-source expansion strategy for Q1 2026?" \
