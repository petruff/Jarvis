...
Downloads public squads from the electron-aaos-squads GitHub repository to use in your project.
...
Available Squads (from electron-aaos-squads):
...
Downloading: etl-squad@1.0.0
  Source: github.com/Electron AAOSAI/electron-aaos-squads/packages/etl-squad
...
```
1. Fetch registry.json from electron-aaos-squads
...
The registry.json in electron-aaos-squads contains:
