...
questions:
  - Story path (relative to docs/stories/):
    ...
    example: "epics/epic-pro-electron-aaos-pro-architecture/story-pro-5-repo-bootstrap.md"
...
*close-story epics/epic-pro-electron-aaos-pro-architecture/story-pro-5-repo-bootstrap.md
