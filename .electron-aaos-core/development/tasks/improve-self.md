...
- capability-analyzer.js:
    ...
    language: JavaScript
    location: .electron-aaos-core/scripts/capability-analyzer.js

- improvement-validator.js:
    description: Validate improvement plans against safety rules
    language: JavaScript
    location: .electron-aaos-core/scripts/improvement-validator.js

- sandbox-tester.js:
    description: Test improvements in isolated sandbox environment
    language: JavaScript
    location: .electron-aaos-core/scripts/sandbox-tester.js

- backup-manager.js:
    description: Manage backups and rollback operations
    language: JavaScript
    location: .electron-aaos-core/scripts/backup-manager.js
```
...
if (process.env.Electron AAOS_SAFE_MODE === 'true') {
  ...
  async execute(params) {
    ...
    try {
      ...
      const analysis = await analyzer.analyzeCapabilities({
        target_areas,
        currentImplementation: './electron-aaos-core'
      });
