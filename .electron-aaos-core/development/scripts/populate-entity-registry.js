...
const SCAN_CONFIG = [
  { category: 'tasks', basePath: '.electron-aaos-core/development/tasks', glob: '**/*.md', type: 'task' },
  { category: 'templates', basePath: '.electron-aaos-core/product/templates', glob: '**/*.{yaml,yml,md}', type: 'template' },
  { category: 'scripts', basePath: '.electron-aaos-core/development/scripts', glob: '**/*.{js,mjs}', type: 'script' },
  { category: 'modules', basePath: '.electron-aaos-core/core', glob: '**/*.{js,mjs}', type: 'module' },
  { category: 'agents', basePath: '.electron-aaos-core/development/agents', glob: '**/*.{md,yaml,yml}', type: 'agent' },
  { category: 'checklists', basePath: '.electron-aaos-core/development/checklists', glob: '**/*.md', type: 'checklist' },
  { category: 'data', basePath: '.electron-aaos-core/data', glob: '**/*.{yaml,yml,md}', type: 'data' }
];
