...
Utilities for the squad-creator agent to manage squads in Electron AAOS projects.
...
# Run with coverage
npm test -- tests/unit/squad/squad-loader.test.js --coverage --collectCoverageFrom=".electron-aaos-core/development/scripts/squad/*.js"
```
