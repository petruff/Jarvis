/**
 * Backlog Manager for Electron AAOS Framework
 *
...
`;
    ...
    markdown += '\n---\n\n';
    markdown += '*Auto-generated by Electron AAOS Backlog Manager (Story 6.1.2.6)*\n';
    markdown += '*Update: Run `npm run stories:backlog` or `node .electron-aaos-core/scripts/backlog-manager.js generate docs/stories/backlog.md`*\n';
