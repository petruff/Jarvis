 ...
 * Usage:
 *   node .electron-aaos-core/scripts/greeting-config-cli.js get greeting
 *   node .electron-aaos-core/scripts/greeting-config-cli.js set greeting.preference minimal
 */
