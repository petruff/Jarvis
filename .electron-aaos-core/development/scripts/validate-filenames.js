 ...
 *
 * Usage:
 *   node .electron-aaos-core/utils/validate-filenames.js
 *   node .electron-aaos-core/utils/validate-filenames.js --fix
 */
...
class FilenameValidator {
  ...
  report() {
    console.log('\n📋 Electron AAOS Filename Validation Report\n');
    ...
    if (this.errors.length > 0) {
      ...
      console.log('3. Or run: node .electron-aaos-core/utils/validate-filenames.js --fix\n');
