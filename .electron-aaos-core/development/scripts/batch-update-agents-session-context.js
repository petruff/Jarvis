...
const AGENTS_DIR = path.join(process.cwd(), '.electron-aaos-core', 'agents');
...
async function updateAgent(agentFile) {
  ...
  try {
    ...
    const activationReplacement = '$1  - STEP 2.6: Load session context using .electron-aaos-core/scripts/session-context-loader.js to detect previous agent and workflow state\n$2';
