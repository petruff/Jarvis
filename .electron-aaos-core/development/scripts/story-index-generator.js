/**
 * Story Index Generator for Electron AAOS Framework
 *
...
`;
  ...
  markdown += '\n---\n\n';
  markdown += '*Auto-generated by Electron AAOS Story Index Generator (Story 6.1.2.6)*\n';
  markdown += '*Update: Run `npm run stories:index` or `node .electron-aaos-core/scripts/story-index-generator.js docs/stories`*\n';
