 ...
 * New code should use: .electron-aaos-core/core/orchestration/session-state.js
 *
 ...
 *
 * State files are stored at: .electron-aaos/{instance-id}-state.yaml
 *
 * Design constraints:
...
class WorkflowStateManager {
  ...
  constructor(options = {}) {
    ...
    this.stateDir = path.join(this.basePath, '.electron-aaos');
  }
  ...
  resolveAgentPaths(state) {
    const corePath = path.join(this.basePath, '.electron-aaos-core', 'development', 'agents');
