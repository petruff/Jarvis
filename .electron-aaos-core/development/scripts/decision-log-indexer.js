...
async function loadConfig() {
  ...
  try {
    const configContent = await fs.readFile('.electron-aaos-core/core-config.yaml', 'utf8');
...
- [Core Configuration](.electron-aaos-core/core-config.yaml)
...
*To manually rebuild the index, run: node .electron-aaos-core/scripts/decision-log-indexer.js rebuild*
`;
