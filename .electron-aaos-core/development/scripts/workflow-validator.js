 ...
 * Workflow Validator
 *
 * Validates workflow YAML files against Electron AAOS workflow conventions:
 * 1. YAML syntax
...
class WorkflowValidator {
  ...
  constructor(options = {}) {
    ...
    this.agentsPath = options.agentsPath || path.join(process.cwd(), '.electron-aaos-core', 'development', 'agents');
