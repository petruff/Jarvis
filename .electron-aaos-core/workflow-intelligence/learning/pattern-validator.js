...
/**
 * Known Electron AAOS task registry commands
 * @type {Set<string>}
 */
...
class PatternValidator {
  ...
  validate(pattern) {
    ...
    // Rule 6: All commands should exist in Electron AAOS task registry
  ...
  /**
   * Check if a command is known in the Electron AAOS task registry
