 ...
 * Inspired by Auto-Claude's Coder Agent but with Electron AAOS extensibility.
 *
 * Features:
 * - AC1: Located in `.electron-aaos-core/core/execution/`
...
async function main() {
  ...
  if (args.length === 0 || args.includes('--help') || args.includes('-h')) {
    console.log(`
${chalk.bold('Autonomous Build Loop')} - Electron AAOS Coder Agent Loop (Story 8.1)
