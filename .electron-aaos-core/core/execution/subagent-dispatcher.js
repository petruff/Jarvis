...
class SubagentDispatcher extends EventEmitter {
  ...
  async getProjectContext() {
    // This would read from .electron-aaos/codebase-map.json or similar
    return {
      rootPath: this.rootPath,
      framework: 'electron-aaos-core',
  ...
  buildPrompt(agentId, task, context) {
    let prompt = `You are ${agentId}, a specialized agent in the Electron AAOS framework.\n\n`;
