...
class SubagentPromptBuilder {
  ...
  constructor(projectRoot) {
    ...
    this.electron-aaosCoreRoot = path.join(projectRoot, '.electron-aaos-core');

    // Paths to Electron AAOS components
    this.paths = {
      agents: path.join(this.electron-aaosCoreRoot, 'development', 'agents'),
      tasks: path.join(this.electron-aaosCoreRoot, 'development', 'tasks'),
      checklists: path.join(this.electron-aaosCoreRoot, 'product', 'checklists'),
      templates: path.join(this.electron-aaosCoreRoot, 'product', 'templates'),
    };
  }
