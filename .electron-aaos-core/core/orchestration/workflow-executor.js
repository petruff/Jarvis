...
class WorkflowExecutor {
  ...
  constructor(projectRoot, options = {}) {
    ...
    this.workflowPath = path.join(
      projectRoot,
      '.electron-aaos-core/development/workflows/development-cycle.yaml',
    );
    this.statePath = path.join(projectRoot, '.electron-aaos/workflow-state/');
    this.configPath = path.join(projectRoot, '.electron-aaos-core/core-config.yaml');
