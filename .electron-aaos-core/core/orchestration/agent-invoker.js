...
class AgentInvoker extends EventEmitter {
  ...
  constructor(options = {}) {
    ...
    // Paths
    this.agentsDir = path.join(this.projectRoot, '.electron-aaos-core', 'development', 'agents');
    this.tasksDir = path.join(this.projectRoot, '.electron-aaos-core', 'development', 'tasks');
