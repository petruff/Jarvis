 ...
 *
 * Handles first execution behavior for existing projects without Electron AAOS documentation.
...
class BrownfieldHandler extends EventEmitter {
  ...
  constructor(projectRoot, options = {}) {
    ...
    this.workflowPath = path.join(
      projectRoot,
      '.electron-aaos-core/development/workflows/brownfield-discovery.yaml',
    );
      ...
      case PostDiscoveryChoice.RESOLVE_DEBTS:
        ...
        return {
          ...
          data: {
            ...
            taskPath: '.electron-aaos-core/development/tasks/brownfield-create-epic.md',
            context,
          },
        };
