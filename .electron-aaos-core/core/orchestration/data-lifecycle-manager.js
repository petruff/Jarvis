 ...
 * - Session states older than 30 days (archived to .electron-aaos/archive/sessions/)
...
const ARCHIVE_DIR = '.electron-aaos/archive/sessions';
const SNAPSHOTS_DIR = '.electron-aaos/snapshots';
...
class DataLifecycleManager {
   ...
   *
   * Sessions with last_updated > 30 days are moved to .electron-aaos/archive/sessions/
   *
