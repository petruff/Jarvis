 ...
 *
 * Features:
 * - AC1: gotchas-memory.js in .electron-aaos-core/core/memory/
 * - AC2: Persists in .electron-aaos/gotchas.json and .electron-aaos/gotchas.md
...
const CONFIG = {
  // Output paths
  gotchasJsonPath: '.electron-aaos/gotchas.json',
  gotchasMdPath: '.electron-aaos/gotchas.md',
  errorTrackingPath: '.electron-aaos/error-tracking.json',
  ...
  // Version
  version: '1.0.0',
  schemaVersion: 'electron-aaos-gotchas-memory-v1',
};
...
> Auto-generated by Electron AAOS Gotchas Memory
> Last updated: ${now}
...
*Generated by Electron AAOS Gotchas Memory v${CONFIG.version}*
`;
  ...
  static showHelp() {
    console.log(`
Gotchas Memory - Electron AAOS Memory Layer (Story 9.4)
