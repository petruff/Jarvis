 ...
 *
 * Facade class that integrates electron-aaos-master with the IDS Entity Registry for
 ...
 *   const { RegistryUpdater } = require('.electron-aaos-core/core/ids/registry-updater');
 *   const { FrameworkGovernor } = require('.electron-aaos-core/core/ids/framework-governor');
 *
  ...
  async postRegister(filePath, metadata = {}) {
    ...
    return this._withTimeout(async () => {
      const task = {
        ...
        agent: metadata.agent || 'electron-aaos-master',
