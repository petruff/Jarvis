...
const HEALING_LOG_PATH = path.resolve(REPO_ROOT, '.electron-aaos-core/data/registry-healing-log.jsonl');
const HEALING_BACKUP_DIR = path.resolve(REPO_ROOT, '.electron-aaos-core/data/registry-backups/healing');
...
class RegistryHealer {
   ...
   * Integrates with Electron AAOS NotificationManager (console + file channels).
   *
    ...
    switch (issue.ruleId) {
      ...
      default:
        return [
          ...
          'Run \'electron-aaos ids:health --fix\' after resolving',
        ];
    }
  }
