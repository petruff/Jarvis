 ...
 */
const DEFAULT_CONFIG_PATH = '.electron-aaos-core/core/quality-gates/quality-gate-config.yaml';
...
class QualityGateManager {
   ...
   */
  async getStatus() {
    const statusPath = this.config.status?.location || '.electron-aaos/qa-status.json';
  ...
  async saveReport(storyId = 'unknown') {
    const reportDir = this.config.reports?.location || '.electron-aaos/qa-reports';
