...
/**
 * Get global Electron AAOS directory path
 * @returns {string} Path to ~/.electron-aaos/
 */
function getGlobalAiosDir() {
  return path.join(getHomeDir(), '.electron-aaos');
}

/**
 * Get global MCP directory path
 * @returns {string} Path to ~/.electron-aaos/mcp/
 */
 ...
 * @returns {string} Path to ~/.electron-aaos/mcp/global-config.json
 */
 ...
 * @returns {string} Path to ~/.electron-aaos/mcp/servers/
 */
 ...
 * @returns {string} Path to ~/.electron-aaos/mcp/cache/
 */
 ...
 * @returns {string} Path to ~/.electron-aaos/credentials/
 */
