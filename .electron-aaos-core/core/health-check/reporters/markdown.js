 ...
 *
 * @module @electron-aaos/electron-aaos-core/health-check/reporters/markdown
 * @version 1.0.0
...
class MarkdownReporter {
  ...
  generateHeader(timestamp, config) {
    ...
    return `# Electron AAOS Health Check Report
...
*Report generated by Electron AAOS Health Check System v1.0.0*
