 ...
 *
 * @module @electron-aaos/electron-aaos-core/health-check/checks/project/workflow-dependencies
 * @version 1.0.0
...
class WorkflowDependenciesCheck extends BaseCheck {
  constructor() {
    super({
      ...
      cacheable: true,
      healingTier: 0,
      tags: ['electron-aaos', 'workflows', 'dependencies'],
    });
  }
  ...
  async execute(context) {
    ...
    const workflowPaths = [
      path.join(projectRoot, '.electron-aaos-core', 'development', 'workflows'),
      path.join(projectRoot, '.electron-aaos-core', 'infrastructure', 'workflows'),
    ];
    ...
    const taskPaths = [
      path.join(projectRoot, '.electron-aaos-core', 'development', 'tasks'),
      path.join(projectRoot, '.electron-aaos-core', 'infrastructure', 'tasks'),
    ];
