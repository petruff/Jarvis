 ...
 *
 * @module @electron-aaos/electron-aaos-core/health-check/checks/project/agent-config
 * @version 1.0.0
...
class AgentConfigCheck extends BaseCheck {
  constructor() {
    super({
      ...
      tags: ['electron-aaos', 'agents', 'config'],
    });
  }
  ...
  async execute(context) {
    ...
    const agentPaths = [
      path.join(projectRoot, '.electron-aaos-core', 'development', 'agents'),
