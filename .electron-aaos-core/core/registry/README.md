# Electron AAOS Service Registry

The Service Registry is the central catalog of all workers, tasks, templates, scripts, and workflows in the Electron AAOS framework. It enables service discovery, search, and reuse across the system.
...
The builder scans:
- `.electron-aaos-core/development/tasks/**/*.md` → task
- `.electron-aaos-core/product/templates/**/*.md` → template
- `.electron-aaos-core/infrastructure/scripts/**/*.js` → script
- `.electron-aaos-core/product/checklists/**/*.md` → checklist
- `.electron-aaos-core/development/workflows/**/*.yaml` → workflow
- `.electron-aaos-core/core/data/**/*` → data
...
- **Discovery CLI** (Story 2.7-2.9): `electron-aaos search`, `electron-aaos info`, `electron-aaos list`
...
*Generated by Electron AAOS Framework v2.1*
