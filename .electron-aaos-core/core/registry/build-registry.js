 ...
 *
 * Scans Electron AAOS modules and builds the service registry JSON file.
...
const SCAN_SOURCES = [
  {
    pattern: '.electron-aaos-core/development/tasks/**/*.md',
    category: 'task',
  ...
  {
    pattern: '.electron-aaos-core/product/templates/**/*.md',
    category: 'template',
    taskFormat: 'TEMPLATE',
    subcategoryExtractor: (filePath) => {
  ...
  {
    pattern: '.electron-aaos-core/infrastructure/scripts/**/*.js',
    category: 'script',
    taskFormat: 'SCRIPT',
    subcategoryExtractor: (filePath) => {
  ...
  {
    pattern: '.electron-aaos-core/product/checklists/**/*.md',
    category: 'checklist',
    taskFormat: 'CHECKLIST',
    subcategoryExtractor: () => 'quality',
  },
  {
    pattern: '.electron-aaos-core/development/workflows/**/*.yaml',
    category: 'workflow',
    taskFormat: 'WORKFLOW',
    subcategoryExtractor: (filePath) => {
  ...
  {
    pattern: '.electron-aaos-core/core/data/**/*.md',
    category: 'data',
    taskFormat: 'TASK-FORMAT-V1',
    subcategoryExtractor: () => 'knowledge',
  },
  {
    pattern: '.electron-aaos-core/core/data/**/*.yaml',
    category: 'data',
    taskFormat: 'TASK-FORMAT-V1',
...
async function main() {
  ...
  const outputPath = process.argv[3] || path.join(baseDir, '.electron-aaos-core/core/registry/service-registry.json');
