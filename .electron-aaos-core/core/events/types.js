 ...
 * @property {string} [electron-aaos_agent] - Electron AAOS agent ID (dev, architect, qa, etc.)
 * @property {string} [electron-aaos_story_id] - Current story ID being worked on
