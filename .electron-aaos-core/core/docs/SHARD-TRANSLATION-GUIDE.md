...
Electron AAOS Electron AAOS now automatically translates Portuguese documentation into English filenames when sharding documents. This ensures consistency across all projects and compatibility with hardcoded English filenames in configuration files.
...
**See full dictionary:** `.electron-aaos-core/tasks/shard-doc.md` (Section 3)
...
**Configuration:** `.electron-aaos-core/core-config.yaml`
...
```bash
# Check for issues
node .electron-aaos-core/scripts/validate-filenames.js

# Auto-fix issues (renames files)
node .electron-aaos-core/scripts/validate-filenames.js --fix
```
...
Edit `.electron-aaos-core/tasks/shard-doc.md`, Section 3:
...
**Solution:**
1. Check you're using the updated `.electron-aaos-core/tasks/shard-doc.md`
2. Run validator to confirm: `node .electron-aaos-core/scripts/validate-filenames.js`
...
**Manual fix:**
Edit `.electron-aaos-core/core-config.yaml` to add more fallbacks.
...
```javascript
// .electron-aaos-core/scripts/validate-filenames.js
...
A: Edit `.electron-aaos-core/tasks/shard-doc.md`, Section 3, and add to the YAML dictionary.
...
2. Run the validator: `node .electron-aaos-core/scripts/validate-filenames.js`
3. Review `.electron-aaos-core/tasks/shard-doc.md` for translation rules
...
**Feature Version:** Electron AAOS v4.x
