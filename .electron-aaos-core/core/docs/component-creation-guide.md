...
This guide walks you through creating components in Electron AAOS Electron AAOS using the meta-agent's enhanced template system and interactive workflows.
...
```bash
DEBUG=electron-aaos:* *create-agent
```
...
1. **Check component examples**: `electron-aaos-core/agents/examples/`
2. **Review templates**: `electron-aaos-core/templates/`
...
Create custom templates in `electron-aaos-core/templates/custom/`:
