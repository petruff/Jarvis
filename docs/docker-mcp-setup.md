...
Guide for setting up Docker-based MCP (Model Context Protocol) servers with Electron AAOS.
...
- **Electron AAOS** project initialized
...
Electron AAOS uses Docker MCP Toolkit as the primary MCP infrastructure:
...
- [DevOps Agent](../.electron-aaos-core/development/agents/devops.md)

---

_Electron AAOS Electron AAOS Docker MCP Setup Guide v2.1.0_
