# Electron AAOS Technology Stack
...
**Migration Notice:** This document will migrate to `Electron AAOSAI/electron-aaos-core` repository in Q2 2026 (see Decision 005)
...
Electron AAOS is built on modern JavaScript/TypeScript with Node.js runtime, optimized for cross-platform CLI development with interactive UX and agent orchestration capabilities.
...
Electron AAOS integrates with Model Context Protocol (MCP) servers:
...
| 1.1     | 2025-12-14 | Updated migration notice to Electron AAOSAI/electron-aaos-core, semantic-release to v25.0.2 [Story 6.10] | Dex (dev)        |

---

_This is an official Electron AAOS framework standard. All technology choices must align with this stack._
