# Electron AAOS Framework Documentation
...
**Migration Target:** Q2 2026 → `Electron AAOSAI/electron-aaos-core` repository

---

## 📋 Overview

This directory contains **official Electron AAOS framework documentation** that defines standards, patterns, and structures applicable across all Electron AAOS projects (greenfield and brownfield).
...
**⚠️ IMPORTANT**: These documents are now in the `Electron AAOSAI/electron-aaos-core` repository. The migration from the old `electron-aaos/electron-aaos-core` org was completed in December 2024 as part of OSR-9 (Rebranding).

### Migration Timeline

- **Phase 1 (Q1 2026 - Story 6.1.2.6):** ✅ Framework docs separated into `docs/framework/`
- **Phase 2 (Q4 2024):** ✅ Repository migrated to `Electron AAOSAI/electron-aaos-core` (OSR-9)
...
- **Scope**: Portable across all Electron AAOS projects
- **Examples**: Coding standards, tech stack, source tree structure
- **Lifecycle**: Lives in `Electron AAOSAI/electron-aaos-core` repository
...
### For Developers
1. **Read framework docs during onboarding** - Understand Electron AAOS standards
...
### For Electron AAOS Framework Maintainers
...
**Maintainer**: Electron AAOS Framework Team
