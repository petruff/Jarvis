# Electron AAOS Electron AAOS Troubleshooting Guide

> 🌐 **EN** | [PT](./pt/troubleshooting.md) | [ES](./es/troubleshooting.md)

---

This comprehensive guide helps you diagnose and resolve common issues with Electron AAOS Electron AAOS.
...
```javascript
// Edit .electron-aaos/memory-config.json
{
...
2. **Collect information:**
   ...
   - Electron AAOS version: `npx @electron-aaos/electron-aaos-core version`
...
- **Stack Overflow**: Tag questions with `@electron-aaos/electron-aaos-core`
...
## Steps to Reproduce
1. Run `npx @electron-aaos/electron-aaos-core init test`
