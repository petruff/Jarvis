# Electron AAOS Git Workflow Guide
...
Electron AAOS Electron AAOS implements a **Defense in Depth** validation strategy with three progressive layers that catch issues early and ensure code quality before merge.
...
**Location:** `.electron-aaos-core/utils/electron-aaos-validator.js`
...
- [Open an Issue](https://github.com/Electron AAOSAI/electron-aaos-core/issues)
