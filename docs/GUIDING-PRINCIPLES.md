# Electron AAOS Method Guiding Principles

> 🌐 **EN** | [PT](./pt/GUIDING-PRINCIPLES.md) | [ES](./es/GUIDING-PRINCIPLES.md)

---

The Electron AAOS Method is a natural language framework for AI-assisted software development. These principles ensure contributions maintain the method's effectiveness.
...
Templates follow the [Electron AAOS Document Template](../common/utils/electron-aaos-doc-template.md) specification using YAML format:
