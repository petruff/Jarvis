...
Complete reference guide for all Electron AAOS Electron AAOS meta-agent commands.
...
Update Electron AAOS Electron AAOS.
...
```bash
Electron AAOS_AI_PROVIDER=openai          # AI provider
Electron AAOS_AI_MODEL=gpt-4             # AI model
Electron AAOS_LOG_LEVEL=debug            # Log level
Electron AAOS_TELEMETRY=disabled         # Telemetry setting
Electron AAOS_TIMEOUT=30000             # Command timeout (ms)
Electron AAOS_MEMORY_CACHE=true         # Memory caching
```
