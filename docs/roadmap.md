# Electron AAOS Roadmap

> 🇧🇷 [Versão em Português](ROADMAP-PT.md)

This document outlines the planned development direction for Electron AAOS.

> For detailed tracking, see our [GitHub Project](https://github.com/orgs/Electron AAOSAI/projects/1)

## Vision

Electron AAOS aims to be the most comprehensive open-source AI agent framework, enabling developers to build sophisticated AI-powered applications with specialized agent teams (Squads) and seamless IDE integration.
...
React with :+1: on existing [Ideas in Discussions](https://github.com/Electron AAOSAI/electron-aaos-core/discussions/categories/ideas) to show support.

### 2. Propose Features

Have a new idea? Open an [Idea Discussion](https://github.com/Electron AAOSAI/electron-aaos-core/discussions/new?category=ideas) to share it with the community.
...
5. Communicate significant changes via [Announcements](https://github.com/Electron AAOSAI/electron-aaos-core/discussions/categories/announcements)
...
|----------------|-------------------|
| [GitHub Project](https://github.com/orgs/Electron AAOSAI/projects/1) | `docs/stories/backlog.md` |
