...
# Guía de Flujo de Trabajo Git de Electron AAOS
...
Electron AAOS Electron AAOS implementa una estrategia de validación de **Defensa en Profundidad** con tres capas progresivas que detectan problemas tempranamente y aseguran la calidad del código antes del merge.
...
```bash
# Validación manual
node .electron-aaos-core/utils/electron-aaos-validator.js pre-push
node .electron-aaos-core/utils/electron-aaos-validator.js stories

# Validar una sola story
node .electron-aaos-core/utils/electron-aaos-validator.js story docs/stories/1.1-story.yaml
...
**Ubicación:** `.electron-aaos-core/utils/electron-aaos-validator.js`
...
- name: Validate story checkboxes
  run: node .electron-aaos-core/utils/electron-aaos-validator.js stories
```
...
# Verificar corrección
node .electron-aaos-core/utils/electron-aaos-validator.js story docs/stories/X.X-story.yaml
...
```javascript
// .electron-aaos-core/utils/custom-validator.js
...
```bash
# .husky/pre-commit
node .electron-aaos-core/utils/electron-aaos-validator.js pre-commit
node .electron-aaos-core/utils/custom-validator.js
```
...
- name: Custom validation
  run: node .electron-aaos-core/utils/custom-validator.js
```
...
- **Electron AAOS Validator:** [.electron-aaos-core/utils/electron-aaos-validator.js](../../.electron-aaos-core/utils/electron-aaos-validator.js)
...
- [Abrir un Issue](https://github.com/Electron AAOSAI/electron-aaos-core/issues)
