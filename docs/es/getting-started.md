...
# Primeros Pasos con Electron AAOS Electron AAOS

> 🌐 [EN](../getting-started.md) | [PT](../pt/getting-started.md) | **ES**

---

Bienvenido a Electron AAOS Electron AAOS! Esta guia te llevara a traves de tus primeros pasos con el framework de desarrollo auto-modificable impulsado por IA.
...
Antes de instalar Electron AAOS Electron AAOS, asegurate de tener:
...
Electron AAOS Electron AAOS ofrece opciones de instalacion flexibles:
...
```
my-first-project/
├── .electron-aaos/                    # Configuracion del framework
...
El archivo de configuracion principal (`.electron-aaos/config.json`) contiene:
...
El meta-agente es el nucleo de Electron AAOS Electron AAOS - una IA que entiende y puede modificar su propia base de codigo.
...
- **[Tutoriales en Video](https://@electron-aaos/electron-aaos-core.dev/tutorials)**: Aprendizaje visual
...
- **Twitter**: Sigue [@electron-aaosfullstack](https://twitter.com/electron-aaosfullstack)
...
Recuerda: Electron AAOS Electron AAOS aprende y mejora con el uso. Cuanto mas interactues con el, mejor entendera tu estilo de desarrollo y necesidades.

Feliz programacion con Electron AAOS Electron AAOS!
