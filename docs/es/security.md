...
Tomamos la seguridad en serio en Electron AAOSAI. Si descubres una vulnerabilidad de seguridad en Electron AAOS, por favor repórtala de manera responsable.
...
1. **GitHub Security Advisories** (Preferido)
   - Ve a [Security Advisories](https://github.com/Electron AAOSAI/electron-aaos-core/security/advisories)
   - Haz clic en "Report a vulnerability"
   - Completa el formulario con los detalles

2. **Email**
   - Envía un email a: security@electron-aaos.ai
...
Al usar Electron AAOS Framework, recomendamos:
...
Electron AAOS Framework ejecuta código y comandos generados por AI. Los usuarios deben:
...
- Electron AAOS puede procesar datos sensibles a través de proveedores de AI
