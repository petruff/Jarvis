# Electron AAOS Agent Flows - Documentacion Detallada de los Agentes

> [PT](../../electron-aaos-agent-flows/README.md) | [EN](../../en/electron-aaos-agent-flows/README.md) | **ES**
...
Esta carpeta contiene la documentacion detallada de todos los agentes de Electron AAOS, incluyendo:
...
|--------|---------|-----------|-----------|
| **@electron-aaos-master** | Orion | Orchestrator | [electron-aaos-master-system.md](./electron-aaos-master-system.md) |
...
| Electron AAOS Workflows | [docs/electron-aaos-workflows/](../../electron-aaos-workflows/) | Detalle de workflows |
...
*Electron AAOS Agent Flows Documentation v1.0 - Documentacion detallada del sistema de agentes*
