...
# Guía de Electron AAOS para GitHub Copilot
...
### ¿Por qué usar Electron AAOS con GitHub Copilot?
...
| **RAM** | 4GB | 8GB+ |
| **Node.js** | 18.0+ (para Electron AAOS) | 20.0+ |
...
│   ├── electron-aaos-dev.chatmode.md
│   ├── electron-aaos-qa.chatmode.md
│   └── ...
...
Este proyecto utiliza Electron AAOS Electron AAOS para desarrollo orquestado por IA.
...
<!-- electron-aaos-dev.chatmode.md -->
---
name: Electron AAOS Developer
description: Agente Senior Full Stack Developer
---

# Agente de Desarrollador

Eres un Senior Full Stack Developer trabajando con Electron AAOS Electron AAOS.
...
### Activando Modos de Agentes Electron AAOS
...
4. Para agentes Electron AAOS, usa modos de chat personalizados en `.github/chatmodes/`

### Modos Personalizados Electron AAOS

| Modo | Propósito |
|---|---|
| `electron-aaos-dev` | Desarrollo full-stack |
| `electron-aaos-qa` | Aseguramiento de calidad |
| `electron-aaos-architect` | Diseño de sistemas |
| `electron-aaos-pm` | Gestión de proyectos |

### Interacciones de Ejemplo

```
# En modo electron-aaos-dev:
Implementa la función de autenticación de usuario de la historia

# En modo electron-aaos-qa:
Revisa el módulo de auth para vulnerabilidades de seguridad

# En modo electron-aaos-architect:
...
```mermaid
flowchart LR
    Source["Electron AAOS Core<br/>.electron-aaos-core/development/agents"] --> Parser["Agent Parser"]
...
```
Problema: Los modos de agentes Electron AAOS no aparecen en el selector
```
**Solución:**
...
1. Instala Electron AAOS para Copilot:
   ```bash
   npx @anthropic/electron-aaos init --ide github-copilot
   ```
...
1. Los agentes almacenados en `.electron-aaos-core/` son portables
...
*Electron AAOS Electron AAOS - Guía de Plataforma GitHub Copilot v1.0*
