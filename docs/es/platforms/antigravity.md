...
# Guía Electron AAOS para AntiGravity
...
### ¿Por qué usar Electron AAOS con AntiGravity?
...
```markdown
# Reglas de Electron AAOS Electron AAOS para AntiGravity
...
1. Tus agentes en `.electron-aaos-core/` son portables
2. Inicializa AntiGravity:
   ```bash
   npx @anthropic/electron-aaos init --ide antigravity
   ```
3. Los archivos de flujo de trabajo se generan automáticamente

### De AntiGravity a Otros IDEs

1. Los agentes de Electron AAOS permanecen en `.electron-aaos-core/`
...
*Electron AAOS Electron AAOS - Guía de Plataforma AntiGravity v1.0*
