# Referencia de API Electron AAOS

> [EN](../../guides/api-reference.md) | [PT](../../pt/guides/api-reference.md) | **ES**

---

Referencia completa de la API para Electron AAOS Electron AAOS - el Sistema Orquestado por IA para Desarrollo Full Stack.
...
Electron AAOS proporciona una API unificada para interactuar con agentes de IA especializados a través de dos mecanismos principales:
...
| `@electron-aaos-master`   | Orion  | Orchestrator | Orquestación del framework, meta-operaciones   |

### Comportamiento de Activación

Cuando se activa un agente:

1. Se carga el archivo de definición del agente desde `.electron-aaos-core/development/agents/{id}.md`
...
### @electron-aaos-master (Orquestador)

**Desarrollo del Framework:**

| Comando                | Argumentos      | Descripción                                    |
| ---------------------- | --------------- | ---------------------------------------------- |
| `*create`              | `{type} {name}` | Crear componente Electron AAOS (agent/task/workflow)    |
...
| `*kb`   | -                          | Alternar modo KB (conocimiento Electron AAOS Method)   |
...
| -------------------- | ---------------------------------- | -------------------------------------- |
| `AGENT_NOT_FOUND`    | Definición de agente faltante      | Verificar `.electron-aaos-core/development/agents/` |
...
/electron-aaos-master  → Activa agente @electron-aaos-master
```
...
- [Guía de Usuario](./user-guide.md) - Comenzando con Electron AAOS
...
- [Guía de Squads](./squads-guide.md) - Extendiendo Electron AAOS con squads

---

_Electron AAOS Electron AAOS API Reference v2.1.0_
