...
Guia completa para crear, validar, publicar y gestionar Squads en Electron AAOS.

> **Electron AAOS Squads:** Equipos de agentes de IA trabajando contigo
...
Los Squads son equipos modulares de agentes de IA que extienden la funcionalidad de Electron AAOS. Cada squad es un paquete autocontenido que incluye:
...
| -------------------------------------------------------------------------- | ------- | ------------------------------------- |
| [etl-squad](https://github.com/Electron AAOSAI/electron-aaos-squads/tree/main/etl)         | 2.0.0   | Recoleccion y transformacion de datos |
| [creator-squad](https://github.com/Electron AAOSAI/electron-aaos-squads/tree/main/creator) | 1.0.0   | Utilidades de generacion de contenido |
...
- Node.js 18+
- Proyecto Electron AAOS inicializado (`.electron-aaos-core/` existe)
...
Las tareas deben seguir [TASK-FORMAT-SPECIFICATION-V1](../../../.electron-aaos-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md).
...
| Modo       | Comportamiento                                     |
| ---------- | -------------------------------------------------- |
| `extend`   | Agregar reglas del squad a las reglas base de Electron AAOS |
...
### Nivel 2: Repositorio electron-aaos-squads (Publico)
...
Esto crea un PR a [Electron AAOSAI/electron-aaos-squads](https://github.com/Electron AAOSAI/electron-aaos-squads).

### Nivel 3: Marketplace de Electron AAOS
...
3. **Agregar Campos** - `electron-aaos.type`, `electron-aaos.minVersion`
...
# - electron-aaos.type: debe ser "squad"
# - electron-aaos.minVersion: debe ser semver valido
```
...
**Squads** son el nuevo estandar (Electron AAOS 2.1+) que reemplaza a los Expansion Packs. Los Squads tienen:
...
3. Re-publicar: `*publish-squad` o `*sync-squad-electron-aaos`
...
- **Nivel 3**: Sincronizar con bandera `--private`: `*sync-squad-electron-aaos my-squad --private`

### Cual es la version minima de Electron AAOS para Squads?

Los Squads requieren Electron AAOS 2.1.0+. Configurar en el manifiesto:
...
- [Repositorio electron-aaos-squads](https://github.com/Electron AAOSAI/electron-aaos-squads)

---

## Obteniendo Ayuda

- [Discusiones de GitHub](https://github.com/Electron AAOSAI/electron-aaos-core/discussions)
- [Rastreador de Issues](https://github.com/Electron AAOSAI/electron-aaos-core/issues)

---

_Electron AAOS Squads: Equipos de agentes de IA trabajando contigo_
