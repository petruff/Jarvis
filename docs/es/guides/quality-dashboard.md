...
```bash
# Sincronizar desde .electron-aaos/data al dashboard
npm run sync-metrics
...
Esto copia `.electron-aaos/data/quality-metrics.json` a `tools/quality-dashboard/public/.electron-aaos/data/`.
