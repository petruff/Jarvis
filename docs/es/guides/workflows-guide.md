# Guia de Workflows de Electron AAOS
...
Los Workflows de Electron AAOS son secuencias orquestadas de actividades de agents que automatizan procesos de desarrollo complejos. Proporcionan patrones estructurados y repetibles para escenarios de desarrollo comunes.
...
El state se persiste en `.electron-aaos/{instance-id}-state.yaml`:
...
Electron AAOS detecta patrones comunes de workflow basados en el historial de comandos:
...
| **Ubicacion** | `.electron-aaos-core/development/workflows/` | `.electron-aaos-core/development/tasks/` |
...
*Guia de Workflows de Electron AAOS v1.0 - Orquestando la Colaboracion IA-Humano*
