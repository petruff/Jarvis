...
# Guía de Instalación y Solución de Problemas de Electron AAOS-Core
...
```bash
npx electron-aaos-core@latest
```

Este comando descarga y ejecuta la última versión del instalador de Electron AAOS-Core.
...
npx electron-aaos-core@2.2.0

# Show version
npx electron-aaos-core@latest --version

# Show help
npx electron-aaos-core@latest --help
```
...
```bash
npm install -g electron-aaos-core
electron-aaos-core
```
...
### Windows (CMD)
```cmd
curl -o diagnose.cmd https://raw.githubusercontent.com/Electron AAOSAI/electron-aaos-core/main/tools/quick-diagnose.cmd && diagnose.cmd
```

### Windows (PowerShell)
```powershell
irm https://raw.githubusercontent.com/Electron AAOSAI/electron-aaos-core/main/tools/quick-diagnose.ps1 | iex
```

### macOS/Linux
```bash
curl -fsSL https://raw.githubusercontent.com/Electron AAOSAI/electron-aaos-core/main/tools/diagnose-installation.js | node
```
...
npx --ignore-existing electron-aaos-core@latest
...
npm view electron-aaos-core version
...
1. **GitHub Issues**: https://github.com/Electron AAOSAI/electron-aaos-core/issues
2. **Ejecutar diagnósticos**: `npx electron-aaos-core@latest doctor`
3. **Verificar información del sistema**: `npx electron-aaos-core@latest info`
...
| Comando | Descripción |
|---------|-------------|
| `npx electron-aaos-core@latest` | Instalar/ejecutar asistente |
| `npx electron-aaos-core@latest --version` | Mostrar versión |
| `npx electron-aaos-core@latest --help` | Mostrar ayuda |
| `npx electron-aaos-core@latest install` | Instalar en directorio actual |
| `npx electron-aaos-core@latest init <name>` | Crear nuevo proyecto |
| `npx electron-aaos-core@latest doctor` | Ejecutar diagnósticos |
| `npx electron-aaos-core@latest info` | Mostrar información del sistema |

---

*Última actualización: Diciembre 2025 | Electron AAOS-Core v2.2.0*
