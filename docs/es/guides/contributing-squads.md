...
Como contribuir squads al ecosistema Electron AAOS.

## Descripcion General

Hay dos formas de compartir tu squad con la comunidad:

1. **Repositorio electron-aaos-squads** - Squads gratuitos y de codigo abierto en GitHub
2. **Marketplace de Electron AAOS** - Squads premium via API de Electron AAOS
...
| **Compatibilidad Electron AAOS** | `electron-aaos.minVersion: "2.1.0"` o superior |
...
## Publicando en electron-aaos-squads
...
Esto:
1. Hara fork de `Electron AAOSAI/electron-aaos-squads` (si es necesario)
...
## Publicando en el Marketplace de Electron AAOS

### Prerequisitos

1. Cuenta de Electron AAOS
...
*publish-squad ./squads/my-squad
# o
*sync-squad-electron-aaos ./squads/my-squad
```
...
- Seguir convenciones de Electron AAOS
...
- **Preguntas**: [Discusiones de GitHub](https://github.com/Electron AAOSAI/electron-aaos-core/discussions)
- **Issues**: [Rastreador de Issues](https://github.com/Electron AAOSAI/electron-aaos-core/issues)
