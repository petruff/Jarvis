# Guia de Testing de Electron AAOS Electron AAOS

> [EN](../../guides/testing-guide.md) | [PT](../../pt/guides/testing-guide.md) | **ES**

---

> Guia completa de la estrategia de testing, herramientas y mejores practicas para Electron AAOS Electron AAOS.
...
Electron AAOS sigue una estrategia de testing integral que asegura la calidad del codigo en todas las capas del framework. Nuestra filosofia de testing esta construida sobre:
...
module.exports = {
  ...
  testMatch: [
    '**/tests/**/*.test.js',
    '**/tests/**/*.spec.js',
    '**/.electron-aaos-core/**/__tests__/**/*.test.js',
  ],
...
const {
  QualityGateManager,
} = require('../../../.electron-aaos-core/core/quality-gates/quality-gate-manager');
...
process.env.Electron AAOS_DEBUG = 'false';
 ...
 * Tests de Compatibilidad Retroactiva de Agentes
 *
 * Asegura que agentes de versiones anteriores de Electron AAOS continuen funcionando.
 */

const { loadAgent } = require('../../.electron-aaos-core/core/registry/agent-loader');
...
Electron AAOS soporta Windows, macOS y Linux. El testing cross-platform asegura comportamiento consistente.
...
function getTempDir() {
  return path.join(os.tmpdir(), 'electron-aaos-tests');
}
...
module.exports = {
  collectCoverageFrom: [
    ...
    '!.electron-aaos-core/development/templates/**',
    '!.electron-aaos-core/product/templates/**',
    '!**/dist/**',
    // Excluir modulos con I/O intensivo (mejor para tests de integracion)
    '!.electron-aaos-core/core/health-check/checks/**',
    '!.electron-aaos-core/core/config/**',
    '!.electron-aaos-core/core/manifest/**',
    '!.electron-aaos-core/core/registry/**',
    '!.electron-aaos-core/core/utils/**',
  ],
...
│   └── .electron-aaos-core/       # Cobertura por modulo
...
El Sistema de Quality Gate de Electron AAOS (ver [Guia de Quality Gates](./quality-gates.md)) integra testing en multiples capas:
...
jest.mock('../../.electron-aaos-core/integrations/clickup-client');
const clickupClient = require('../../.electron-aaos-core/integrations/clickup-client');
...
_Guia de Testing de Electron AAOS Electron AAOS v2.1_
