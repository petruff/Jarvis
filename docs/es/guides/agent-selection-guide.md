...
| **@electron-aaos-master** (Orion)     | 👑    | Desarrollo del framework, orquestación multi-agente                                                                   | Tareas rutinarias (usar agentes especializados)    |
...
| `*list-gotchas` | Listar gotchas conocidos de .electron-aaos/gotchas.md |
