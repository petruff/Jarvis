...
**Opcion 1: Si tienes electron-aaos-core clonado**
```bash
# Desde el directorio electron-aaos-core
node .electron-aaos-core/infrastructure/scripts/llm-routing/install-llm-routing.js
```
...
**Windows:** `.electron-aaos-core/infrastructure/scripts/llm-routing/templates/claude-free.cmd`
**Unix:** `.electron-aaos-core/infrastructure/scripts/llm-routing/templates/claude-free.sh`
...
- **Definicion de Herramienta:** `.electron-aaos-core/infrastructure/tools/cli/llm-routing.yaml`
- **Script de Instalacion:** `.electron-aaos-core/infrastructure/scripts/llm-routing/install-llm-routing.js`
- **Definicion de Tarea:** `.electron-aaos-core/development/tasks/setup-llm-routing.md`
...
*Generado por Electron AAOS Framework - Story 6.7*
