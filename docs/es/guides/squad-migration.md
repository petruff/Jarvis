...
Como migrar squads legacy al formato Electron AAOS 2.1.

## Descripcion General

Electron AAOS 2.1 introdujo un nuevo formato de squad con:
...
| Campo de tipo Electron AAOS    | Faltante      | `electron-aaos.type: squad`         |
| Version minima        | Faltante      | `electron-aaos.minVersion: "2.1.0"` |
...
- Agrega campos `electron-aaos` faltantes al manifiesto
...
- [ ] `electron-aaos.type` es `"squad"`
- [ ] `electron-aaos.minVersion` es `"2.1.0"` o superior
