...
Guia completa para desarrolladores que quieren contribuir al proyecto Electron AAOS Electron AAOS.
...
| -------------------- | ------------------------------------------- |
| **Claude Code**      | Desarrollo potenciado por IA con agentes Electron AAOS |
| **VS Code / Cursor** | IDE con integracion Electron AAOS                    |
...
1. Navega a [github.com/Electron AAOSAI/electron-aaos-core](https://github.com/Electron AAOSAI/electron-aaos-core)
...
```bash
# Clonar tu fork
git clone https://github.com/YOUR_USERNAME/electron-aaos-core.git
cd electron-aaos-core

# Agregar remote upstream
git remote add upstream https://github.com/Electron AAOSAI/electron-aaos-core.git

# Verificar remotes
git remote -v
# origin    https://github.com/YOUR_USERNAME/electron-aaos-core.git (fetch)
# origin    https://github.com/YOUR_USERNAME/electron-aaos-core.git (push)
# upstream  https://github.com/Electron AAOSAI/electron-aaos-core.git (fetch)
# upstream  https://github.com/Electron AAOSAI/electron-aaos-core.git (push)
```
...
SYNKRA_API_TOKEN=your-electron-aaos-token
```
...
Sincroniza los agentes Electron AAOS con tu IDE:
...
Entendiendo la estructura de directorios de `electron-aaos-core`:

```
electron-aaos-core/
├── .electron-aaos-core/                    # Fuente del framework (committed)
...
│   ├── commands/Electron AAOS/agents/      # Comandos skill de agentes
...
| ----------------------------------- | -------------------------------- | ------------------------- |
| `.electron-aaos-core/development/agents/`    | Personas y comportamientos de agentes | Agregar/modificar agentes |
| `.electron-aaos-core/development/tasks/`     | Workflows de tasks ejecutables   | Agregar/modificar tasks   |
| `.electron-aaos-core/development/workflows/` | Orquestaciones multi-paso        | Crear workflows           |
...
Crea un nuevo archivo en `.electron-aaos-core/development/agents/`:

```bash
# Archivo: .electron-aaos-core/development/agents/my-agent.md
```
...
dependencies:
  tasks:
    - my-agent-task.md       # Crear en .electron-aaos-core/development/tasks/
  checklists:
    - my-agent-checklist.md  # Crear en .electron-aaos-core/development/checklists/
  tools:
    - git
    - context7
````
...
Crea un nuevo archivo en `.electron-aaos-core/development/tasks/`:
...
# Ejemplos:
# .electron-aaos-core/development/tasks/dev-build-component.md  (agente dev)
# .electron-aaos-core/development/tasks/create-doc.md          (compartida)
```
...
## Definicion de Task (Electron AAOS Task Format V1.0)
...
Crea un nuevo archivo en `.electron-aaos-core/development/workflows/`:

```bash
# Archivo: .electron-aaos-core/development/workflows/my-workflow.yaml
```
...
npx js-yaml .electron-aaos-core/development/agents/my-agent.md

# Verificar que existan dependencias
ls .electron-aaos-core/development/tasks/my-task.md
```
...
Electron AAOS_DEBUG=true npm run trace -- workflow-name

# Verificar estado de workflow
cat .electron-aaos/state/workflow-state.json
```
...
- Etiquetar `@Electron AAOSAI/core-team` para issues urgentes
...
_Electron AAOS Electron AAOS Guia de Configuracion para Desarrollo v1.0.0_
