...
# Guías de Electron AAOS

> 🌐 [EN](../../guides/README.md) | [PT](../../pt/guides/README.md) | **ES**

---

Índice completo de documentación para las guías del sistema Electron AAOS.
...
> **Nota:** La documentación de 1MCP ha sido descontinuada. Electron AAOS ahora usa Docker MCP Toolkit exclusivamente (Story 5.11). Los documentos archivados están disponibles en `.github/deprecated-docs/guides/`.
