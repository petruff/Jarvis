...
Introduccion a Electron AAOS Squads - equipos modulares de agentes IA que extienden la funcionalidad del framework.
...
Los Squads son equipos modulares de agentes IA que extienden la funcionalidad de Electron AAOS para dominios o casos de uso especificos. Cada squad es un paquete autocontenido que puede ser instalado, compartido y compuesto con otros squads.

> **Electron AAOS Squads:** Equipos de agentes IA trabajando contigo
...
| Agentes Tradicionales      | Electron AAOS Squads                    |
| -------------------------- | ------------------------------ |
...
| ----------------- | ------- | ------------------------------------- | -------------------------------------------------------------------------------- |
| **etl-squad**     | 2.0.0   | Recoleccion y transformacion de datos | [electron-aaos-squads/etl](https://github.com/Electron AAOSAI/electron-aaos-squads/tree/main/etl)         |
| **creator-squad** | 1.0.0   | Utilidades de generacion de contenido | [electron-aaos-squads/creator](https://github.com/Electron AAOSAI/electron-aaos-squads/tree/main/creator) |
...
│  Nivel 2: Electron AAOS-SQUADS  --> github.com/Electron AAOSAI (Publico)    │
...
Las tasks deben seguir [TASK-FORMAT-SPECIFICATION-V1](../../../.electron-aaos-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md).

### 2. Usar Herencia de Config Sabiamente

| Modo       | Comportamiento                              |
| ---------- | ------------------------------------------- |
| `extend`   | Agregar reglas del squad a reglas core Electron AAOS |
...
- **Explorar Squads Oficiales:** Revisar [repositorio electron-aaos-squads](https://github.com/Electron AAOSAI/electron-aaos-squads)
- **Contribuir:** Ver [Guia de Contribucion de Squads](./contributing-squads.md)
- **Aprender Formato de Tasks:** Leer [TASK-FORMAT-SPECIFICATION-V1](../../../.electron-aaos-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md)
...
- [Especificacion de Formato de Tasks](../../../.electron-aaos-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md)
...
**Squads** son el nuevo estandar (Electron AAOS 2.1+) reemplazando Expansion Packs. Los Squads tienen:
...
_Electron AAOS Squads: Equipos de agentes IA trabajando contigo_
