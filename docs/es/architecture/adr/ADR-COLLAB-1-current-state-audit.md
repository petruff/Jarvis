...
**Fuente:** `gh api repos/Electron AAOSAI/electron-aaos-core/branches/main/protection`
...
**Fuente:** `gh api repos/Electron AAOSAI/electron-aaos-core`
...
**Fuente:** `gh api repos/Electron AAOSAI/electron-aaos-core/actions/workflows`
...
1. Crear `.coderabbit.yaml` con reglas especificas de Electron AAOS
...
- `.electron-aaos/audit/branch-protection.json`
- `.electron-aaos/audit/repo-settings.json`
