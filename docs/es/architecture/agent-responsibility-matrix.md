...
Este documento define límites claros de responsabilidad para todos los agentes Electron AAOS, con enfoque particular en:
...
1. **Hook Git Pre-Push** (Aplicación Primaria)
   ...
   - Verifica: Variable de entorno `$Electron AAOS_ACTIVE_AGENT`
...
- [ ] **Crear Hook Git Pre-Push**
  - Ubicación: `.git/hooks/pre-push`
  - Contenido: Verificar `$Electron AAOS_ACTIVE_AGENT`, bloquear si != "github-devops"
...
- [ ] **Actualizar Scripts de Activación de Agentes**
  - Agregar configuración de variable de entorno: `Electron AAOS_ACTIVE_AGENT={agent_id}`
  - Configurar `Electron AAOS_GIT_PUSH_ALLOWED` apropiadamente
