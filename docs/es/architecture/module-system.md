...
# Arquitectura del Sistema de Módulos Electron AAOS

> 🌐 [EN](../../architecture/module-system.md) | [PT](../../pt/architecture/module-system.md) | **ES**

---

> Guía completa de la arquitectura modular v2.1 para Electron AAOS Electron AAOS.
...
Electron AAOS Electron AAOS organiza el directorio `.electron-aaos-core/` en cuatro módulos principales:
...
| `data/`          | `electron-aaos-kb.md`, `workflow-patterns.yaml`           | Base de conocimiento del framework     |
...
**Ruta:** `.electron-aaos-core/development/`
...
| --------------- | ------------------ | -------------------------- |
| Electron AAOS Master     | `electron-aaos-master`      | Orquestación del framework |
...
**Ruta:** `.electron-aaos-core/product/`
...
**Ruta:** `.electron-aaos-core/infrastructure/`
...
_Arquitectura del Sistema de Módulos Electron AAOS Electron AAOS v2.1_
