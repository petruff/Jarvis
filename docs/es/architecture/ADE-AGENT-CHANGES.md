# Cambios en los Agentes ADE - Alteraciones en los Agentes Electron AAOS
...
Este documento registra todas las alteraciones realizadas en los archivos de definición de los agentes Electron AAOS para soportar el Electron AAOS Autonomous Development Engine (ADE).

**Archivos modificados:**

- `.electron-aaos-core/development/agents/*.md` (fuente)
- `.claude/commands/Electron AAOS/agents/*.md` (sincronizado)
...
**Archivo:** `.electron-aaos-core/development/agents/devops.md`
...
**Archivo:** `.electron-aaos-core/development/agents/pm.md`
...
**Archivo:** `.electron-aaos-core/development/agents/architect.md`
...
**Archivo:** `.electron-aaos-core/development/agents/analyst.md`
...
**Archivo:** `.electron-aaos-core/development/agents/qa.md`
...
**Archivo:** `.electron-aaos-core/development/agents/dev.md`
...
- name: list-gotchas
  visibility: [full, quick]
  description: 'Listar gotchas conocidos de .electron-aaos/gotchas.md'
```
...
```
.electron-aaos-core/development/agents/   →   .claude/commands/Electron AAOS/agents/
         (fuente)                           (sincronizado)
```
...
- `.electron-aaos-core/infrastructure/schemas/agent-v3-schema.json`

**Comando para validar:**

```bash
node .electron-aaos-core/infrastructure/scripts/migrate-agent.js --validate
```
