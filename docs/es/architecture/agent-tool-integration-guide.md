...
Esta guía explica cómo se integran las herramientas con los agentes Electron AAOS. Las herramientas amplían las capacidades de los agentes proporcionando acceso a servicios externos, APIs y recursos del sistema.
...
| `tasks`      | Archivos de flujo de trabajo          | `.electron-aaos-core/development/tasks/`  |
| `checklists` | Listas de validación                  | `.electron-aaos-core/product/checklists/` |

### Ejemplo de Declaración

```yaml
# De .electron-aaos-core/development/agents/dev.md
dependencies:
  checklists:
...
Electron AAOS implementa gobernanza estricta de operaciones de git:
...
- [Definiciones de Agentes](../../../.electron-aaos-core/development/agents/)
