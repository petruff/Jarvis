...
Este documento describe las mejores prácticas para gestionar claves de API utilizadas por servidores MCP (Model Context Protocol) en Electron AAOS. La gestión adecuada de claves de API es crítica para la seguridad e integridad operacional.

---

## Arquitectura MCP en Electron AAOS

Electron AAOS utiliza Docker MCP Toolkit como la infraestructura principal de MCP:
...
## Gobernanza MCP en Electron AAOS
