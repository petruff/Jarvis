...
| **Icono** | 🏗️ |
| **Archivo** | `.electron-aaos-core/development/agents/squad-creator.md` |
...
| `*publish-squad` | squad-creator-publish.md | ⏳ Placeholder | Publicar a electron-aaos-squads |
| `*sync-squad-electron-aaos` | squad-creator-sync-electron-aaos.md | ⏳ Placeholder | Sincronizar al marketplace |
...
| SquadPublisher | squad-publisher.js | Publicar a electron-aaos-squads |
