...
**Propósito:** Definir patrones estándar para integrar scripts de utilidades en el framework Electron AAOS

---

## ¿Qué es la Integración de Utilidades?

**Definición:** La integración de utilidades es el proceso de hacer que un script de utilidad huérfano sea **descubrible, documentado y utilizable** dentro del framework Electron AAOS.
...
```yaml
# .electron-aaos-core/agents/dev.yaml
id: dev
...
- `.electron-aaos-core/agents/{agent}.yaml` (agregar a dependencies.utils)
- `.electron-aaos-core/core-config.yaml` (registrar si es necesario)
- `.electron-aaos-core/utils/README.md` (documentar utilidad)
...
```yaml
# .electron-aaos-core/tasks/generate-commit-message.md
...
**Archivos Modificados:**
- `.electron-aaos-core/tasks/{task}.md` (agregar execution.utils)
- `.electron-aaos-core/agents/{agent}.yaml` (agregar tarea a lista executes)
- `.electron-aaos-core/core-config.yaml` (registrar si es necesario)
- `.electron-aaos-core/utils/README.md` (documentar utilidad)
...
utils:
  framework:
    ...
    - electron-aaos-validator
```

**Archivos Modificados:**
- `.electron-aaos-core/core-config.yaml` (registrar bajo framework)
- `.electron-aaos-core/utils/README.md` (documentar como utilidad de framework)
...
```yaml
# .electron-aaos-core/agents/architect.yaml
dependencies:
  utils:
...
**Archivos Modificados:**
- `.electron-aaos-core/agents/{agent}.yaml`
- `.electron-aaos-core/tasks/{task}.md` (si se crea tarea)
- `.electron-aaos-core/core-config.yaml`
- `.electron-aaos-core/utils/README.md`
...
**Ejemplos:** electron-aaos-validator, code-quality-improver, coverage-analyzer
...
const utility = require('.electron-aaos-core/utils/{utility-name}');
...
**Ubicación:** `.electron-aaos-core/utils/{name}.js`
