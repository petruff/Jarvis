...
| ------------------------ | ------------------------------------------------------------ | --------- | ------ |
| worktree-manager.js      | `.electron-aaos-core/infrastructure/scripts/worktree-manager.js`      | JS Script | ✅     |
| story-worktree-hooks.js  | `.electron-aaos-core/infrastructure/scripts/story-worktree-hooks.js`  | JS Script | ✅     |
| project-status-loader.js | `.electron-aaos-core/infrastructure/scripts/project-status-loader.js` | JS Script | ✅     |
| auto-worktree.yaml       | `.electron-aaos-core/development/workflows/auto-worktree.yaml`        | Workflow  | ✅     |
| worktree-create.md       | `.electron-aaos-core/development/tasks/worktree-create.md`            | Task      | ✅     |
| worktree-list.md         | `.electron-aaos-core/development/tasks/worktree-list.md`              | Task      | ✅     |
| worktree-merge.md        | `.electron-aaos-core/development/tasks/worktree-merge.md`             | Task      | ✅     |
...
- **status.json**: Estado del worktree rastreado en `.electron-aaos/status.json`
- **Dashboard**: API de WorktreeManager consumida por Electron AAOS Dashboard
