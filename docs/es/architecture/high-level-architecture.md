...
# Arquitectura de Alto Nivel Electron AAOS v2.1
...
**Electron AAOS (AI Operating System)** es un framework sofisticado para orquestar agentes de IA, workers y humanos en flujos de trabajo complejos de desarrollo de software. La versión 2.1 introduce una arquitectura modular con 4 módulos, estrategia multi-repositorio y quality gates de 3 capas.
...
├── .electron-aaos-core/                    # Capa del framework
...
| ------------------ | ---------------------------- | ------------------------ | ----------------------------------- |
| **Core**           | `.electron-aaos-core/core/`           | Fundación del framework  | Config, Registry, QG, MCP, Session  |
| **Development**    | `.electron-aaos-core/development/`    | Artefactos de desarrollo | Agentes, Tareas, Workflows, Scripts |
| **Product**        | `.electron-aaos-core/product/`        | Artefactos PM            | Plantillas, Checklists, Data        |
| **Infrastructure** | `.electron-aaos-core/infrastructure/` | Config del sistema       | Scripts, Tools, Integraciones       |
...
| Pax    | `electron-aaos-master`   | Orquestador  | Orquestación del framework |
...
- [Electron AAOS-LIVRO-DE-OURO-V2.1-COMPLETE.md](../../../.electron-aaos-core/docs/standards/Electron AAOS-LIVRO-DE-OURO-V2.1-COMPLETE.md) - Guía completa del framework
