...
```
.electron-aaos-core/development/scripts/squad/
...
```
.electron-aaos-core/development/agents/squad-creator.md  # Agregar nuevos comandos
.electron-aaos-core/schemas/squad-schema.json            # (sin cambios necesarios)
```
...
2. **Crear Historia SQS-11** en `docs/stories/v2.1/sprint-XX/`
