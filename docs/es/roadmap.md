# Hoja de Ruta de Electron AAOS

> 🇧🇷 [Versão em Português](ROADMAP-PT.md)

Este documento describe la dirección de desarrollo planificada para Electron AAOS.

> Para seguimiento detallado, consulta nuestro [Proyecto de GitHub](https://github.com/orgs/Electron AAOSAI/projects/1)

## Visión

Electron AAOS tiene como objetivo ser el framework de agentes de IA de código abierto más completo, permitiendo a los desarrolladores construir aplicaciones sofisticadas impulsadas por IA con equipos especializados de agentes (Squads) e integración perfecta con IDEs.
...
Reacciona con :+1: en [Ideas en Discussions](https://github.com/Electron AAOSAI/electron-aaos-core/discussions/categories/ideas) existentes para mostrar apoyo.

### 2. Propón Características

¿Tienes una nueva idea? Abre una [Discusión de Idea](https://github.com/Electron AAOSAI/electron-aaos-core/discussions/new?category=ideas) para compartirla con la comunidad.
...
5. Comunicar cambios significativos vía [Anuncios](https://github.com/Electron AAOSAI/electron-aaos-core/discussions/categories/announcements)
...
|----------------|-------------------|
| [Proyecto de GitHub](https://github.com/orgs/Electron AAOSAI/projects/1) | `docs/stories/backlog.md` |
