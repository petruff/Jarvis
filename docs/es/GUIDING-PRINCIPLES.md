...
# Principios Rectores del Método Electron AAOS

> 🌐 [EN](../GUIDING-PRINCIPLES.md) | [PT](../pt/GUIDING-PRINCIPLES.md) | **ES**

---

El Método Electron AAOS es un framework de lenguaje natural para el desarrollo de software asistido por IA. Estos principios aseguran que las contribuciones mantengan la efectividad del método.
...
Las plantillas siguen la especificación de [Plantilla de Documento Electron AAOS](../../common/utils/electron-aaos-doc-template.md) usando formato YAML:
