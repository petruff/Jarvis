...
# Stack Tecnológico de Electron AAOS
...
**Aviso de Migración:** Este documento migrará al repositorio `Electron AAOSAI/electron-aaos-core` en Q2 2026 (ver Decision 005)
...
Electron AAOS está construido sobre JavaScript/TypeScript moderno con runtime Node.js, optimizado para desarrollo CLI multiplataforma con UX interactiva y capacidades de orquestación de agentes.
...
| 1.1     | 2025-12-14 | Actualizado aviso de migración a Electron AAOSAI/electron-aaos-core, semantic-release a v25.0.2 [Story 6.10] | Dex (dev)        |

---

_Este es un estándar oficial del framework Electron AAOS. Todas las elecciones tecnológicas deben alinearse con este stack._
