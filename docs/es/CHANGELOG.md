...
Todos los cambios notables en Electron AAOS Electron AAOS seran documentados en este archivo.
...
- **Estructura de Directorios**: Renombrado `.bmad-core/` a `.electron-aaos-core/`
...
- **Configuracion de IDE**: Agentes de Claude Code movidos a `.claude/commands/Electron AAOS/agents/`
...
- Proceso de instalacion manual (usar `npx @electron-aaos/electron-aaos-core install` en su lugar)
...
- Lanzamiento publico inicial de Electron AAOS Electron AAOS
...
**Cambios clave:**
1. Directorio renombrado: `.bmad-core/` → `.electron-aaos-core/`
