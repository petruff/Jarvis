<!--
  Traducción: ES
  Original: /docs/en/electron-aaos-nomenclature-specification.md
  Última sincronización: 2026-01-26
-->

# Especificación de Nomenclatura de Electron AAOS

> 🌐 [EN](../electron-aaos-nomenclature-specification.md) | [PT](../pt/electron-aaos-nomenclature-specification.md) | **ES**
...
Este documento establece nomenclatura clara para Electron AAOS para diferenciar entre:
...
**Características:**
- **Alcance:** Interno a un único archivo de tarea (`.electron-aaos-core/tasks/*.md`)
...
- **Ubicación:** Definido en `.electron-aaos-core/workflows/*.yaml` o secciones de workflow de stories
...
**Concepto:** Inspirado por el protocolo Organizer-Worker de AsyncThink, los workflows de Electron AAOS pueden usar un **Agente Organizador** que coordina **Agentes Trabajadores** ejecutando tareas en paralelo.

**Aplicación a Electron AAOS:**
...
workflow:
  ...
  organizer: electron-aaos-master
...
**Archivos de Tarea:**
- Ubicación: `.electron-aaos-core/tasks/{task-name}.md`
- Contiene: Task workflow (Step-by-Step Execution)
- Ejemplo: `.electron-aaos-core/tasks/security-scan.md`

**Archivos de Workflow:**
- Ubicación: `.electron-aaos-core/workflows/{workflow-name}.yaml`
- Contiene: Definición de orquestación multi-tarea
- Ejemplo: `.electron-aaos-core/workflows/story-development-workflow.yaml`
...
```yaml
# .electron-aaos-core/workflows/story-development-workflow.yaml
workflow:
  id: story-development-workflow
  name: Story Development Flow
...
3. **Gestión de Workflows Electron AAOS:** Patrones de workflow existentes en Electron AAOS
