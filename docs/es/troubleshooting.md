...
# Guia de Solucion de Problemas de Electron AAOS Electron AAOS

> 🌐 [EN](../troubleshooting.md) | [PT](../pt/troubleshooting.md) | **ES**

---

Esta guia completa te ayuda a diagnosticar y resolver problemas comunes con Electron AAOS Electron AAOS.
...
2. **Recopilar informacion:**
   ...
   - Version de Electron AAOS: `npx @electron-aaos/electron-aaos-core version`
...
- **Stack Overflow**: Etiqueta preguntas con `@electron-aaos/electron-aaos-core`
...
1. Ejecutar `npx @electron-aaos/electron-aaos-core init test`
