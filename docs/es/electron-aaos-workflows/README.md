# Electron AAOS Workflows - Documentacion Detallada de los Workflows

> [PT](../../electron-aaos-workflows/README.md) | [EN](../../en/electron-aaos-workflows/README.md) | **ES**
...
Esta carpeta contiene la documentacion detallada de todos los workflows de Electron AAOS, incluyendo:
...
| Agent Flows | [docs/electron-aaos-agent-flows/](../../electron-aaos-agent-flows/) | Detalles de agentes |
...
*Electron AAOS Workflows Documentation v1.0 - Documentacion detallada de los workflows de desarrollo*
