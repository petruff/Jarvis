...
# Documentación de Instalación de Electron AAOS Electron AAOS
...
Este directorio contiene documentación completa de instalación y configuración para Electron AAOS Electron AAOS.
...
3. Abra un [Issue en GitHub](https://github.com/Electron AAOSAI/electron-aaos-core/issues)
