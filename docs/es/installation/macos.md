...
# Guía de Instalación de Electron AAOS Electron AAOS para macOS
...
1. Los comandos se instalan en `.claude/commands/Electron AAOS/`
2. Use `/agent-name` para activar agentes

### Windsurf

1. Las reglas se instalan en `.windsurf/rules/`
2. Use `@agent-name` para activar agentes
...
sudo chown -R $(whoami) .electron-aaos-core
```
...
2. Electron AAOS Electron AAOS maneja automáticamente tanto sistemas de archivos sensibles como insensibles a mayúsculas
