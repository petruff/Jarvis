...
# Guía de Instalación Windows para Electron AAOS Electron AAOS
...
2. Comandos se instalan en `.claude\commands\Electron AAOS\`
...
### Configurar Electron AAOS con WSL
...
# - Hará respaldo de personalizaciones en .electron-aaos-backup\
