...
| `.electron-aaos-core/development/tasks/execute-checklist.md` | `*execute-checklist` | Executa checklist de validação |
...
| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/development/agents/electron-aaos-master.md` | Definição completa do agente (persona, comandos, dependencias) |
...
| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/development/templates/agent-template.yaml` | Template para criação de novos agentes |
| `.electron-aaos-core/development/templates/task-template.md` | Template para criação de novas tasks |
| `.electron-aaos-core/development/templates/workflow-template.yaml` | Template para criação de novos workflows |
