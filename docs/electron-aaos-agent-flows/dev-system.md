...
|---------|---------|-----------|
| `.electron-aaos-core/development/tasks/dev-develop-story.md` | `*develop {story-id}` | Task principal - desenvolve story completa com modos YOLO/Interactive/Pre-flight |
| `.electron-aaos-core/development/tasks/dev-improve-code-quality.md` | `*improve-code-quality <path>` | Melhora qualidade do codigo (formatting, linting, modern-syntax) |
| `.electron-aaos-core/development/tasks/dev-optimize-performance.md` | `*optimize-performance <path>` | Analisa e otimiza performance do codigo |
| `.electron-aaos-core/development/tasks/dev-suggest-refactoring.md` | `*suggest-refactoring <path>` | Sugere oportunidades de refactoring automatizado |
| `.electron-aaos-core/development/tasks/dev-backlog-debt.md` | `*backlog-debt` | Registra divida tecnica no backlog |
| `.electron-aaos-core/development/tasks/apply-qa-fixes.md` | `*apply-qa-fixes` | Aplica correcoes baseadas em feedback de QA |
| `.electron-aaos-core/development/tasks/execute-checklist.md` | `*execute-checklist` | Valida documentacao usando checklists |
| `.electron-aaos-core/development/tasks/validate-next-story.md` | `*validate-story-draft` | Valida qualidade e completude de stories |
| `.electron-aaos-core/development/tasks/sync-documentation.md` | `*sync-documentation` | Sincroniza documentacao com mudancas de codigo |
| `.electron-aaos-core/development/tasks/po-manage-story-backlog.md` | (usado internamente) | Gerencia backlog de stories |

### Arquivos de Definição do Agente

| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/development/agents/dev.md` | Definição core do agente @dev (persona, comandos, workflows) |
| `.claude/commands/Electron AAOS/agents/dev.md` | Comando Claude Code para ativar @dev |
...
| `.electron-aaos-core/product/checklists/pre-push-checklist.md` | Checklist antes de push |
| `.electron-aaos-core/product/checklists/change-checklist.md` | Validacao de mudancas |

### Arquivos Relacionados de Outros Agentes

| Arquivo | Agente | Propósito |
|---------|--------|-----------|
| `.electron-aaos-core/development/tasks/qa-backlog-add-followup.md` | @qa | QA adiciona follow-ups ao backlog |
| `.electron-aaos-core/development/tasks/qa-review-story.md` | @qa | QA revisa implementacao do @dev |
| `.electron-aaos-core/development/tasks/github-devops-pre-push-quality-gate.md` | @github-devops | Quality gate antes de push |
| `.electron-aaos-core/development/tasks/sm-create-next-story.md` | @sm | Scrum Master cria stories para @dev |

### Arquivos de Workflows que Usam @dev

| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/development/workflows/brownfield-fullstack.yaml` | Workflow full-stack brownfield |
| `.electron-aaos-core/development/workflows/brownfield-service.yaml` | Workflow de servico brownfield |
| `.electron-aaos-core/development/workflows/brownfield-ui.yaml` | Workflow UI brownfield |
| `.electron-aaos-core/development/workflows/greenfield-fullstack.yaml` | Workflow full-stack greenfield |
| `.electron-aaos-core/development/workflows/greenfield-service.yaml` | Workflow de servico greenfield |
| `.electron-aaos-core/development/workflows/greenfield-ui.yaml` | Workflow UI greenfield |
...
| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/core-config.yaml` | Configuracao central (devStoryLocation, coderabbit, etc.) |
| `.electron-aaos-core/development/scripts/greeting-builder.js` | Constroi greeting adaptativo |
| `.electron-aaos-core/scripts/decision-recorder.js` | Logging de decisoes (YOLO mode) |
...
### Tasks do @dev
- [dev-develop-story.md](.electron-aaos-core/development/tasks/dev-develop-story.md)
- [dev-improve-code-quality.md](.electron-aaos-core/development/tasks/dev-improve-code-quality.md)
- [dev-optimize-performance.md](.electron-aaos-core/development/tasks/dev-optimize-performance.md)
- [dev-suggest-refactoring.md](.electron-aaos-core/development/tasks/dev-suggest-refactoring.md)
- [dev-backlog-debt.md](.electron-aaos-core/development/tasks/dev-backlog-debt.md)
- [apply-qa-fixes.md](.electron-aaos-core/development/tasks/apply-qa-fixes.md)

### Checklists
- [story-dod-checklist.md](.electron-aaos-core/product/checklists/story-dod-checklist.md)
- [pre-push-checklist.md](.electron-aaos-core/product/checklists/pre-push-checklist.md)

### Agente
- [dev.md](.electron-aaos-core/development/agents/dev.md)
