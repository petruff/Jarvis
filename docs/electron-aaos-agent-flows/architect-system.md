...
O agente **@architect** (Aria) e o **Holistic System Architect & Full-Stack Technical Leader** do Electron AAOS. Este agente e responsavel por:
...
|---------|---------|-----------|
| `.electron-aaos-core/development/tasks/architect-analyze-impact.md` | `*analyze-impact` | Analisa impacto de modificacoes em componentes do framework |
| `.electron-aaos-core/development/tasks/document-project.md` | `*document-project` | Gera documentacao brownfield de projeto existente |
| `.electron-aaos-core/development/tasks/create-doc.md` | `*create-doc` | Cria documentos a partir de templates YAML |
| `.electron-aaos-core/development/tasks/collaborative-edit.md` | `*collaborative-edit` | Gerencia sessoes de edicao colaborativa |
| `.electron-aaos-core/development/tasks/create-deep-research-prompt.md` | `*research` | Gera prompts de pesquisa profunda |
| `.electron-aaos-core/development/tasks/execute-checklist.md` | `*execute-checklist` | Executa checklists de validação |
| `.electron-aaos-core/development/tasks/spec-assess-complexity.md` | `*assess-complexity` | Avalia complexidade de stories (Spec Pipeline) |

### Arquivos de Definição do Agente

| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/development/agents/architect.md` | Definição core do agente Architect |
| `.claude/commands/Electron AAOS/agents/architect.md` | Comando Claude Code para ativar @architect |

### Arquivos de Templates do @architect

| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/product/templates/architecture-tmpl.yaml` | Template para arquitetura backend |
| `.electron-aaos-core/product/templates/front-end-architecture-tmpl.yaml` | Template para arquitetura frontend |
| `.electron-aaos-core/product/templates/fullstack-architecture-tmpl.yaml` | Template para arquitetura fullstack |
| `.electron-aaos-core/product/templates/brownfield-architecture-tmpl.yaml` | Template para projetos brownfield |

### Arquivos de Dados de Suporte

| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/development/data/technical-preferences.md` | Preferencias tecnicas padrao do Electron AAOS |

### Arquivos Relacionados de Outros Agentes

| Arquivo | Agente | Propósito |
|---------|--------|-----------|
| `.electron-aaos-core/development/tasks/spec-gather-requirements.md` | @pm | Coleta requisitos que alimentam arquitetura |
| `.electron-aaos-core/development/tasks/spec-research-dependencies.md` | @analyst | Pesquisa dependencias para arquitetura |
| `.electron-aaos-core/development/tasks/spec-critique.md` | @qa | Valida specs que impactam arquitetura |
| `.electron-aaos-core/development/tasks/plan-create-implementation.md` | @architect | Cria plano de implementacao pos-spec |
| `.electron-aaos-core/development/agents/db-sage.md` | @db-sage | Colabora em arquitetura de dados |
| `.electron-aaos-core/development/agents/ux-design-expert.md` | @ux-design-expert | Colabora em arquitetura frontend |
| `.electron-aaos-core/development/agents/devops.md` | @devops | Colabora em infraestrutura |
...
**Arquivo:** `.electron-aaos-core/development/workflows/greenfield-fullstack.yaml`
...
**Arquivo:** `.electron-aaos-core/development/workflows/brownfield-fullstack.yaml`
...
**Arquivo:** `.electron-aaos-core/development/workflows/spec-pipeline.yaml`
...
**Arquivo:** `.electron-aaos-core/development/workflows/qa-loop.yaml`
...
```bash
# Analise basica
*analyze-impact modify .electron-aaos-core/agents/weather-agent.md

# Analise profunda com testes
*analyze-impact modify .electron-aaos-core/agents/weather-agent.md --depth deep --include-tests

# Deprecacao com output visual
*analyze-impact deprecate .electron-aaos-core/scripts/old-helper.js --output-format visual --save-report reports/deprecation.html

# Refatoracao com threshold de risco
*analyze-impact refactor .electron-aaos-core/tasks/process-data.md --depth shallow --risk-threshold medium
```
...
| `.electron-aaos/project-registry.yaml` | Registro de projetos |
...
**Solucao:**
1. Verificar `.electron-aaos-core/product/templates/`
...
- [architect-analyze-impact.md](.electron-aaos-core/development/tasks/architect-analyze-impact.md)
- [document-project.md](.electron-aaos-core/development/tasks/document-project.md)
- [create-doc.md](.electron-aaos-core/development/tasks/create-doc.md)
- [execute-checklist.md](.electron-aaos-core/development/tasks/execute-checklist.md)
- [spec-assess-complexity.md](.electron-aaos-core/development/tasks/spec-assess-complexity.md)

### Templates de Arquitetura

- [fullstack-architecture-tmpl.yaml](.electron-aaos-core/product/templates/fullstack-architecture-tmpl.yaml)
- [architecture-tmpl.yaml](.electron-aaos-core/product/templates/architecture-tmpl.yaml)
- [front-end-architecture-tmpl.yaml](.electron-aaos-core/product/templates/front-end-architecture-tmpl.yaml)
- [brownfield-architecture-tmpl.yaml](.electron-aaos-core/product/templates/brownfield-architecture-tmpl.yaml)

### Workflows Relacionados

- [greenfield-fullstack.yaml](.electron-aaos-core/development/workflows/greenfield-fullstack.yaml)
- [brownfield-fullstack.yaml](.electron-aaos-core/development/workflows/brownfield-fullstack.yaml)
- [spec-pipeline.yaml](.electron-aaos-core/development/workflows/spec-pipeline.yaml)

### Agentes Colaboradores

- [@db-sage](.electron-aaos-core/development/agents/db-sage.md) - Arquitetura de dados
- [@ux-design-expert](.electron-aaos-core/development/agents/ux-design-expert.md) - Arquitetura frontend
- [@pm](.electron-aaos-core/development/agents/pm.md) - Requisitos e PRD
- [@devops](.electron-aaos-core/development/agents/devops.md) - Git push e infraestrutura
