...
O **Squad Creator** (Craft) e o agente especializado do Electron AAOS para criação, validação, publicacao e gerenciamento de squads. Squads sao pacotes modulares de agentes, tasks, workflows e recursos que podem ser reutilizados entre projetos.
...
| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/development/agents/squad-creator.md` | Definição core do agente Squad Creator |
...
| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/schemas/squad-schema.json` | Schema de validação do squad.yaml |
| `.electron-aaos-core/schemas/squad-design-schema.json` | Schema de validação de blueprints |
