...
O agente **@sm (River)** e o Scrum Master tecnico do Electron AAOS, especializado em preparacao de stories e facilitacao de processos ageis. Seu papel principal e criar stories detalhadas e acionaveis que agentes desenvolvedores possam implementar com minima necessidade de pesquisa adicional.
...
|---------|---------|-----------|
| `.electron-aaos-core/development/tasks/sm-create-next-story.md` | `*draft` | Task principal para criar proxima story do backlog |
| `.electron-aaos-core/development/tasks/create-next-story.md` | `*draft` | Versao completa da task de criação de story |
| `.electron-aaos-core/development/tasks/execute-checklist.md` | `*story-checklist` | Executa checklist de validação de story draft |
| `.electron-aaos-core/development/tasks/correct-course.md` | `*correct-course` | Analisa e corrige desvios de processo |
| `.electron-aaos-core/development/tasks/collaborative-edit.md` | - | Edicao colaborativa de documentos |
| `.electron-aaos-core/development/tasks/init-project-status.md` | - | Inicializacao de status do projeto |

### Arquivos de Definição do Agente

| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/development/agents/sm.md` | Definição core do agente SM |
| `.claude/commands/Electron AAOS/agents/sm.md` | Comando Claude Code para ativar @sm |
...
| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/product/checklists/story-draft-checklist.md` | Valida qualidade e completude de story drafts |
| `.electron-aaos-core/product/checklists/story-dod-checklist.md` | Definition of Done para stories |
| `.electron-aaos-core/product/checklists/change-checklist.md` | Navegacao de mudancas e correcao de curso |
| `.electron-aaos-core/product/checklists/po-master-checklist.md` | Checklist mestre usado em validação |

### Arquivos Relacionados de Outros Agentes

| Arquivo | Agente | Propósito |
|---------|--------|-----------|
| `.electron-aaos-core/development/agents/po.md` | @po | Coordena com @sm em backlog e sprint planning |
| `.electron-aaos-core/development/agents/dev.md` | @dev | Recebe stories do @sm para implementacao |
| `.electron-aaos-core/development/agents/pm.md` | @pm | Cria epics que @sm quebra em stories |
| `.electron-aaos-core/development/agents/devops.md` | @github-devops | Recebe stories completas para push/PR |
| `.electron-aaos-core/development/agents/qa.md` | @qa | Coordena em risk profiling |

### Arquivos de Workflows que Utilizam @sm

| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/development/workflows/story-development-cycle.yaml` | Ciclo completo de desenvolvimento de stories |
| `.electron-aaos-core/development/workflows/greenfield-fullstack.yaml` | Workflow greenfield full-stack |
| `.electron-aaos-core/development/workflows/greenfield-service.yaml` | Workflow greenfield service |
| `.electron-aaos-core/development/workflows/greenfield-ui.yaml` | Workflow greenfield UI |
| `.electron-aaos-core/development/workflows/brownfield-fullstack.yaml` | Workflow brownfield full-stack |
| `.electron-aaos-core/development/workflows/brownfield-service.yaml` | Workflow brownfield service |
| `.electron-aaos-core/development/workflows/brownfield-ui.yaml` | Workflow brownfield UI |

### Arquivos de Configuracao

| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/core-config.yaml` | Configuracao central (devStoryLocation, etc.) |
| `.electron-aaos-core/development/scripts/greeting-builder.js` | Script de saudacao inteligente |
| `.electron-aaos-core/development/scripts/agent-assignment-resolver.js` | Resolucao de assignment de agentes |
...
**Solucao:**
1. Copiar de `GITHUB electron-aaos-core/core-config.yaml`
2. Ou executar Electron AAOS installer: `npm run electron-aaos:install`
...
### Arquivos do Agente
- [Agent: sm.md](.electron-aaos-core/development/agents/sm.md)
- [Task: create-next-story.md](.electron-aaos-core/development/tasks/create-next-story.md)
- [Task: execute-checklist.md](.electron-aaos-core/development/tasks/execute-checklist.md)
- [Task: correct-course.md](.electron-aaos-core/development/tasks/correct-course.md)

### Checklists
- [Checklist: story-draft-checklist.md](.electron-aaos-core/product/checklists/story-draft-checklist.md)
- [Checklist: story-dod-checklist.md](.electron-aaos-core/product/checklists/story-dod-checklist.md)
- [Checklist: change-checklist.md](.electron-aaos-core/product/checklists/change-checklist.md)

### Workflows
- [Workflow: story-development-cycle.yaml](.electron-aaos-core/development/workflows/story-development-cycle.yaml)
- [Workflow: greenfield-fullstack.yaml](.electron-aaos-core/development/workflows/greenfield-fullstack.yaml)
- [Workflow: brownfield-fullstack.yaml](.electron-aaos-core/development/workflows/brownfield-fullstack.yaml)
