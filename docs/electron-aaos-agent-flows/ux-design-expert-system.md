# Sistema UX-Design-Expert Electron AAOS
...
Este documento descreve o sistema completo do agente **UX-Design Expert (Uma)**, incluindo todos os arquivos envolvidos, fluxos de trabalho, comandos disponiveis, integracoes com outros agentes e workflows Electron AAOS.
...
| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/development/agents/ux-design-expert.md` | Definição completa do agente (persona, comandos, workflows) |
| `.claude/commands/Electron AAOS/agents/ux-design-expert.md` | Comando Claude Code para ativar @ux-design-expert |
...
|---------|---------|-----------|
| `.electron-aaos-core/development/tasks/ux-user-research.md` | `*research` | Conduzir pesquisa de usuario, criar personas e jornadas |
| `.electron-aaos-core/development/tasks/ux-create-wireframe.md` | `*wireframe` | Criar wireframes low/mid/high fidelity |
| `.electron-aaos-core/development/tasks/generate-ai-frontend-prompt.md` | `*generate-ui-prompt` | Gerar prompts para v0.dev, Lovable.ai |
| `.electron-aaos-core/development/tasks/create-doc.md` | `*create-front-end-spec` | Criar especificacao frontend detalhada |

#### Fase 2: Design System Audit (3 tasks)

| Arquivo | Comando | Propósito |
|---------|---------|-----------|
| `.electron-aaos-core/development/tasks/audit-codebase.md` | `*audit {path}` | Escanear codebase para redundancias UI |
| `.electron-aaos-core/development/tasks/consolidate-patterns.md` | `*consolidate` | Reduzir redundancia com clustering HSL |
| `.electron-aaos-core/development/tasks/generate-shock-report.md` | `*shock-report` | Gerar relatorio visual HTML |

#### Fase 3: Design Tokens & Setup (7 tasks)

| Arquivo | Comando | Propósito |
|---------|---------|-----------|
| `.electron-aaos-core/development/tasks/extract-tokens.md` | `*tokenize` | Extrair design tokens (YAML, JSON, CSS, DTCG) |
| `.electron-aaos-core/development/tasks/setup-design-system.md` | `*setup` | Inicializar estrutura do design system |
| `.electron-aaos-core/development/tasks/generate-migration-strategy.md` | `*migrate` | Gerar estrategia de migracao em 4 fases |
| `.electron-aaos-core/development/tasks/tailwind-upgrade.md` | `*upgrade-tailwind` | Upgrade para Tailwind CSS v4 |
| `.electron-aaos-core/development/tasks/audit-tailwind-config.md` | `*audit-tailwind-config` | Validar configuracao Tailwind |
| `.electron-aaos-core/development/tasks/export-design-tokens-dtcg.md` | `*export-dtcg` | Exportar tokens W3C DTCG |
| `.electron-aaos-core/development/tasks/bootstrap-shadcn-library.md` | `*bootstrap-shadcn` | Instalar Shadcn/Radix UI |

#### Fase 4: Atomic Component Building (3 tasks)

| Arquivo | Comando | Propósito |
|---------|---------|-----------|
| `.electron-aaos-core/development/tasks/build-component.md` | `*build {component}` | Construir componente atomico (React + TypeScript) |
| `.electron-aaos-core/development/tasks/compose-molecule.md` | `*compose {molecule}` | Compor molecule de atoms existentes |
| `.electron-aaos-core/development/tasks/extend-pattern.md` | `*extend {component}` | Adicionar variante a componente existente |

#### Fase 5: Quality & Documentation (3 tasks)

| Arquivo | Comando | Propósito |
|---------|---------|-----------|
| `.electron-aaos-core/development/tasks/generate-documentation.md` | `*document` | Gerar documentacao do pattern library |
| `.electron-aaos-core/development/tasks/calculate-roi.md` | `*calculate-roi` | Calcular ROI e cost savings |
| `.electron-aaos-core/development/checklists/accessibility-wcag-checklist.md` | `*a11y-check` | Auditoria de acessibilidade WCAG |

#### Tasks Universais (2 tasks)

| Arquivo | Comando | Propósito |
|---------|---------|-----------|
| `.electron-aaos-core/development/tasks/ux-ds-scan-artifact.md` | `*scan {path\|url}` | Analisar HTML/React para extrair padroes |
| `.electron-aaos-core/development/tasks/integrate-Squad.md` | `*integrate {pack}` | Conectar com expansion pack |

### Templates

| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/development/templates/front-end-spec-tmpl.yaml` | Template de especificacao frontend |
| `.electron-aaos-core/development/templates/tokens-schema-tmpl.yaml` | Schema de design tokens |
| `.electron-aaos-core/development/templates/component-react-tmpl.tsx` | Template de componente React |
| `.electron-aaos-core/development/templates/state-persistence-tmpl.yaml` | Template de persistencia de estado |
| `.electron-aaos-core/development/templates/shock-report-tmpl.html` | Template de shock report HTML |
| `.electron-aaos-core/development/templates/migration-strategy-tmpl.md` | Template de estrategia de migracao |
| `.electron-aaos-core/development/templates/token-exports-css-tmpl.css` | Template de export CSS |
| `.electron-aaos-core/development/templates/token-exports-tailwind-tmpl.js` | Template de export Tailwind |
| `.electron-aaos-core/development/templates/ds-artifact-analysis.md` | Template de analise de artefato |

### Checklists

| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/development/checklists/pattern-audit-checklist.md` | Checklist de auditoria de padroes |
| `.electron-aaos-core/development/checklists/component-quality-checklist.md` | Checklist de qualidade de componente |
| `.electron-aaos-core/development/checklists/accessibility-wcag-checklist.md` | Checklist WCAG AA/AAA |
| `.electron-aaos-core/development/checklists/migration-readiness-checklist.md` | Checklist de readiness para migracao |

### Data Files

| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/development/data/technical-preferences.md` | Preferencias tecnicas padrao |
| `.electron-aaos-core/development/data/atomic-design-principles.md` | Principios Atomic Design |
| `.electron-aaos-core/development/data/design-token-best-practices.md` | Best practices de design tokens |
| `.electron-aaos-core/development/data/consolidation-algorithms.md` | Algoritmos de consolidacao |
| `.electron-aaos-core/development/data/roi-calculation-guide.md` | Guia de calculo de ROI |
| `.electron-aaos-core/development/data/integration-patterns.md` | Padroes de integracao |
| `.electron-aaos-core/development/data/wcag-compliance-guide.md` | Guia de conformidade WCAG |

### Workflows Relacionados

| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/development/workflows/design-system-build-quality.yaml` | Pipeline pos-migracao (build, docs, a11y, ROI) |
| `.electron-aaos-core/development/workflows/brownfield-ui.yaml` | Workflow para UI brownfield |
| `.electron-aaos-core/development/workflows/brownfield-discovery.yaml` | Discovery para projetos existentes |
| `.electron-aaos-core/development/workflows/greenfield-ui.yaml` | Workflow para UI greenfield |
...
- [ux-user-research.md](../../.electron-aaos-core/development/tasks/ux-user-research.md)
- [ux-create-wireframe.md](../../.electron-aaos-core/development/tasks/ux-create-wireframe.md)
- [audit-codebase.md](../../.electron-aaos-core/development/tasks/audit-codebase.md)
- [consolidate-patterns.md](../../.electron-aaos-core/development/tasks/consolidate-patterns.md)
- [extract-tokens.md](../../.electron-aaos-core/development/tasks/extract-tokens.md)
- [build-component.md](../../.electron-aaos-core/development/tasks/build-component.md)
- [calculate-roi.md](../../.electron-aaos-core/development/tasks/calculate-roi.md)

### Arquivos de Workflow

- [design-system-build-quality.yaml](../../.electron-aaos-core/development/workflows/design-system-build-quality.yaml)
- [brownfield-ui.yaml](../../.electron-aaos-core/development/workflows/brownfield-ui.yaml)

### Definição do Agente

- [ux-design-expert.md](../../.electron-aaos-core/development/agents/ux-design-expert.md)
