...
O agente **@qa (Quinn)** e o Test Architect & Quality Advisor do Electron AAOS. Seu papel e fornecer analise abrangente de qualidade, decisoes de quality gates e recomendacoes acionaveis para equipes de desenvolvimento.
...
|---------|---------|-----------|
| `.electron-aaos-core/development/tasks/qa-gate.md` | `*gate {story}` | Criar arquivo de decisao de quality gate |
| `.electron-aaos-core/development/tasks/qa-review-story.md` | `*review {story}` | Revisao completa de story com decisao de gate |
| `.electron-aaos-core/development/tasks/qa-test-design.md` | `*test-design {story}` | Criar cenarios de teste abrangentes |
| `.electron-aaos-core/development/tasks/qa-risk-profile.md` | `*risk-profile {story}` | Gerar matriz de avaliacao de risco |
| `.electron-aaos-core/development/tasks/qa-nfr-assess.md` | `*nfr-assess {story}` | Validar requisitos não-funcionais |
| `.electron-aaos-core/development/tasks/qa-trace-requirements.md` | `*trace {story}` | Mapear requisitos para testes (Given-When-Then) |
| `.electron-aaos-core/development/tasks/qa-generate-tests.md` | `*generate-tests` | Gerar suites de teste automaticamente |
| `.electron-aaos-core/development/tasks/qa-run-tests.md` | `*run-tests` | Executar suite de testes com gate de qualidade |
| `.electron-aaos-core/development/tasks/qa-backlog-add-followup.md` | `*backlog-add` | Adicionar follow-ups ao backlog |
| `.electron-aaos-core/development/tasks/qa-create-fix-request.md` | `*create-fix-request {story}` | Gerar documento de fix request para @dev |

### Arquivos de Tasks Secundarias do @qa

| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/development/tasks/qa-browser-console-check.md` | Verificar erros no console do browser |
| `.electron-aaos-core/development/tasks/qa-evidence-requirements.md` | Requisitos de evidencia para QA |
| `.electron-aaos-core/development/tasks/qa-false-positive-detection.md` | Deteccao de falsos positivos |
| `.electron-aaos-core/development/tasks/qa-fix-issues.md` | Task para @dev aplicar fixes de QA |
| `.electron-aaos-core/development/tasks/qa-library-validation.md` | Validacao de bibliotecas |
| `.electron-aaos-core/development/tasks/qa-migration-validation.md` | Validacao de migracoes |
| `.electron-aaos-core/development/tasks/qa-review-build.md` | Revisao de builds |
| `.electron-aaos-core/development/tasks/qa-security-checklist.md` | Checklist de seguranca |
| `.electron-aaos-core/development/tasks/qa-review-proposal.md` | Revisao de propostas |

### Arquivos de Definição do Agente

| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/development/agents/qa.md` | Definição completa do agente QA |
| `.claude/commands/Electron AAOS/agents/qa.md` | Comando Claude Code para ativar @qa |

### Arquivos de Workflow

| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/development/workflows/qa-loop.yaml` | Orquestrador do loop QA (Review -> Fix -> Re-review) |

### Arquivos de Time

| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/development/agent-teams/team-qa-focused.yaml` | Configuracao do time focado em QA (@dev, @qa, @github-devops) |
...
| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/core-config.yaml` | Configuracao central (qa.qaLocation, etc.) |
| `.electron-aaos-core/development/data/technical-preferences.md` | Preferencias tecnicas para QA |
...
wsl bash -c 'cd /mnt/c/.../@electron-aaos/electron-aaos-core && ~/.local/bin/coderabbit --prompt-only -t uncommitted'

# Story review (committed changes vs main)
wsl bash -c 'cd /mnt/c/.../@electron-aaos/electron-aaos-core && ~/.local/bin/coderabbit --prompt-only -t committed --base main'
```
...
- [qa-gate.md](/.electron-aaos-core/development/tasks/qa-gate.md)
- [qa-review-story.md](/.electron-aaos-core/development/tasks/qa-review-story.md)
- [qa-test-design.md](/.electron-aaos-core/development/tasks/qa-test-design.md)
- [qa-risk-profile.md](/.electron-aaos-core/development/tasks/qa-risk-profile.md)
- [qa-nfr-assess.md](/.electron-aaos-core/development/tasks/qa-nfr-assess.md)
- [qa-trace-requirements.md](/.electron-aaos-core/development/tasks/qa-trace-requirements.md)

### Workflows

- [qa-loop.yaml](/.electron-aaos-core/development/workflows/qa-loop.yaml)

### Teams

- [team-qa-focused.yaml](/.electron-aaos-core/development/agent-teams/team-qa-focused.yaml)

### Agente

- [qa.md](/.electron-aaos-core/development/agents/qa.md)
