# Electron AAOS Agent Flows - Documentação Detalhada dos Agentes

> 🌐 **PT** | [EN](../en/electron-aaos-agent-flows/README.md) | [ES](../es/electron-aaos-agent-flows/README.md)
...
Esta pasta contém a documentação detalhada de todos os agentes do Electron AAOS, incluindo:
...
| Electron AAOS Workflows | [docs/electron-aaos-workflows/](../electron-aaos-workflows/) | Detalhamento de workflows |
...
*Electron AAOS Agent Flows Documentation v1.0 - Documentação detalhada do sistema de agentes*
