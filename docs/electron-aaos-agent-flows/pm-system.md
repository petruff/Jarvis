# Sistema do Agente Product Manager (PM) - Electron AAOS
...
Este documento descreve o sistema completo do agente Product Manager (PM) do Electron AAOS, incluindo todos os arquivos envolvidos, fluxos de trabalho, comandos disponiveis e integracoes entre agentes.
...
| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/development/agents/pm.md` | Definição core do agente PM |
| `.claude/commands/Electron AAOS/agents/pm.md` | Comando Claude Code para ativar @pm |

### Tasks do @pm

| Arquivo | Comando | Propósito |
|---------|---------|-----------|
| `.electron-aaos-core/development/tasks/create-doc.md` | `*create-prd` | Cria documentos a partir de templates YAML |
| `.electron-aaos-core/development/tasks/correct-course.md` | `*correct-course` | Analisa e corrige desvios de projeto |
| `.electron-aaos-core/development/tasks/create-deep-research-prompt.md` | `*research` | Gera prompts de pesquisa profunda |
| `.electron-aaos-core/development/tasks/brownfield-create-epic.md` | `*create-epic` | Cria epics para projetos brownfield |
| `.electron-aaos-core/development/tasks/brownfield-create-story.md` | `*create-story` | Cria stories para brownfield |
| `.electron-aaos-core/development/tasks/execute-checklist.md` | `*checklist` | Executa validação de checklists |
| `.electron-aaos-core/development/tasks/shard-doc.md` | `*shard-prd` | Fragmenta documentos grandes |

### Templates do @pm

| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/product/templates/prd-tmpl.yaml` | Template PRD para projetos greenfield |
| `.electron-aaos-core/product/templates/brownfield-prd-tmpl.yaml` | Template PRD para projetos brownfield |

### Checklists do @pm

| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/product/checklists/pm-checklist.md` | Checklist de validação de PRD |
| `.electron-aaos-core/product/checklists/change-checklist.md` | Checklist para navegacao de mudancas |

### Workflows que Utilizam o @pm

| Arquivo | Fase | Propósito |
|---------|------|-----------|
| `.electron-aaos-core/development/workflows/brownfield-discovery.yaml` | Fase 10 | Criacao de epics e stories pos-discovery |
...
**Solucao:**
- Verifique `.electron-aaos-core/product/templates/`
...
- [Agent Definition: pm.md](.electron-aaos-core/development/agents/pm.md)
- [Task: create-doc.md](.electron-aaos-core/development/tasks/create-doc.md)
- [Task: brownfield-create-epic.md](.electron-aaos-core/development/tasks/brownfield-create-epic.md)
- [Task: correct-course.md](.electron-aaos-core/development/tasks/correct-course.md)
- [Template: prd-tmpl.yaml](.electron-aaos-core/product/templates/prd-tmpl.yaml)
- [Template: brownfield-prd-tmpl.yaml](.electron-aaos-core/product/templates/brownfield-prd-tmpl.yaml)
- [Checklist: pm-checklist.md](.electron-aaos-core/product/checklists/pm-checklist.md)
