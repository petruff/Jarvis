# Sistema do Agente Analyst (@analyst) - Electron AAOS
...
| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/development/agents/analyst.md` | Definição core do agente Analyst |
| `.claude/commands/Electron AAOS/agents/analyst.md` | Comando Claude Code para ativar @analyst |

### Tasks do Analyst

| Arquivo | Comando | Propósito |
|---------|---------|-----------|
| `.electron-aaos-core/development/tasks/facilitate-brainstorming-session.md` | `*brainstorm {topic}` | Task principal - facilita sessoes de brainstorming estruturadas |
| `.electron-aaos-core/development/tasks/analyst-facilitate-brainstorming.md` | `*brainstorm {topic}` | Variante interativa da task de brainstorming |
| `.electron-aaos-core/development/tasks/create-deep-research-prompt.md` | `*research-prompt {topic}` | Gera prompts de pesquisa profunda para investigacao |
| `.electron-aaos-core/development/tasks/advanced-elicitation.md` | `*elicit` | Sessao avancada de elicitacao de requisitos |
| `.electron-aaos-core/development/tasks/create-doc.md` | `*doc-out` | Criacao de documentos a partir de templates YAML |
| `.electron-aaos-core/development/tasks/document-project.md` | `*create-project-brief` | Documentação de projetos existentes |
| `.electron-aaos-core/development/tasks/calculate-roi.md` | (relacionada) | Calculo de ROI e economia de custos |

### Tasks Relacionadas de Analise

| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/development/tasks/analyze-brownfield.md` | Analise de projetos brownfield |
| `.electron-aaos-core/development/tasks/analyze-framework.md` | Analise de frameworks existentes |
| `.electron-aaos-core/development/tasks/analyze-performance.md` | Analise de performance |
| `.electron-aaos-core/development/tasks/analyze-project-structure.md` | Analise de estrutura de projeto |
| `.electron-aaos-core/development/tasks/analyze-cross-artifact.md` | Analise cross-artifact |

### Templates do Analyst

| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/product/templates/project-brief-tmpl.yaml` | Template para Project Brief |
| `.electron-aaos-core/product/templates/market-research-tmpl.yaml` | Template para Pesquisa de Mercado |
| `.electron-aaos-core/product/templates/competitor-analysis-tmpl.yaml` | Template para Analise Competitiva |
| `.electron-aaos-core/product/templates/brainstorming-output-tmpl.yaml` | Template para output de sessoes de brainstorming |

### Arquivos de Dados

| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/development/data/electron-aaos-kb.md` | Knowledge base do Electron AAOS |
| `.electron-aaos-core/development/data/brainstorming-techniques.md` | Tecnicas de brainstorming disponiveis |

### Workflows que Usam o Analyst

| Arquivo | Fase | Propósito |
|---------|------|-----------|
| `.electron-aaos-core/development/workflows/greenfield-fullstack.yaml` | Fase 1 | Discovery & Planning - cria project-brief.md |
| `.electron-aaos-core/development/workflows/brownfield-discovery.yaml` | Fase 9 | Relatorio Executivo de Awareness |
...
- [Task: facilitate-brainstorming-session.md](.electron-aaos-core/development/tasks/facilitate-brainstorming-session.md)
- [Task: create-deep-research-prompt.md](.electron-aaos-core/development/tasks/create-deep-research-prompt.md)
- [Task: advanced-elicitation.md](.electron-aaos-core/development/tasks/advanced-elicitation.md)
- [Task: create-doc.md](.electron-aaos-core/development/tasks/create-doc.md)
- [Task: document-project.md](.electron-aaos-core/development/tasks/document-project.md)

### Templates

- [Template: project-brief-tmpl.yaml](.electron-aaos-core/product/templates/project-brief-tmpl.yaml)
- [Template: market-research-tmpl.yaml](.electron-aaos-core/product/templates/market-research-tmpl.yaml)
- [Template: competitor-analysis-tmpl.yaml](.electron-aaos-core/product/templates/competitor-analysis-tmpl.yaml)
- [Template: brainstorming-output-tmpl.yaml](.electron-aaos-core/product/templates/brainstorming-output-tmpl.yaml)

### Workflows

- [Workflow: greenfield-fullstack.yaml](.electron-aaos-core/development/workflows/greenfield-fullstack.yaml)
- [Workflow: brownfield-discovery.yaml](.electron-aaos-core/development/workflows/brownfield-discovery.yaml)

### Agente

- [Agent: analyst.md](.electron-aaos-core/development/agents/analyst.md)
