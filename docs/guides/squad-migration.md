...
How to migrate legacy squads to Electron AAOS 2.1 format.

## Overview

Electron AAOS 2.1 introduced a new squad format with:
...
| Electron AAOS type field | Missing | `electron-aaos.type: squad` |
| Min version | Missing | `electron-aaos.minVersion: "2.1.0"` |
...
**Result:**
- Adds missing `electron-aaos` fields to manifest
...
- [ ] `electron-aaos.type` is `"squad"`
- [ ] `electron-aaos.minVersion` is `"2.1.0"` or higher
