...
| `.electron-aaos-core/development/tasks/execute-checklist.md` | `*execute-checklist` | Executa checklists de validacao |
...
| Arquivo | Proposito |
|---------|-----------|
| `.electron-aaos-core/development/agents/architect.md` | Definicao core do agente Architect |
