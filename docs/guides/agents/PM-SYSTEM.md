...
| Arquivo | Proposito |
|---------|-----------|
| `.electron-aaos-core/development/agents/pm.md` | Definicao core do agente PM |
...
| `.electron-aaos-core/development/tasks/execute-checklist.md` | `*checklist` | Executa validacao de checklists |
...
| Arquivo | Proposito |
|---------|-----------|
| `.electron-aaos-core/product/checklists/pm-checklist.md` | Checklist de validacao de PRD |
