...
| Arquivo | Proposito |
|---------|-----------|
| `.electron-aaos-core/development/agents/analyst.md` | Definicao core do agente Analyst |
...
| `.electron-aaos-core/development/tasks/document-project.md` | `*create-project-brief` | Documentacao de projetos existentes |
