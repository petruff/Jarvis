...
| `.electron-aaos-core/development/tasks/qa-nfr-assess.md` | `*nfr-assess {story}` | Validar requisitos nao-funcionais |
...
| Arquivo | Proposito |
|---------|-----------|
| `.electron-aaos-core/development/agents/qa.md` | Definicao completa do agente QA |
