...
| `.electron-aaos-core/development/tasks/create-next-story.md` | `*draft` | Versao completa da task de criacao de story |
| `.electron-aaos-core/development/tasks/execute-checklist.md` | `*story-checklist` | Executa checklist de validacao de story draft |
...
| Arquivo | Proposito |
|---------|-----------|
| `.electron-aaos-core/development/agents/sm.md` | Definicao core do agente SM |
...
| `.electron-aaos-core/product/checklists/po-master-checklist.md` | Checklist mestre usado em validacao |
