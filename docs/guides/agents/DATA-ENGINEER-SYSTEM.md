...
O agente **@data-engineer (Dara)** e o Database Architect & Operations Engineer do Electron AAOS, responsavel pelo design de schemas, migracoes, seguranca (RLS), otimizacao de performance e operacoes de DBA. Este agente atua como um **Sage** que modela dominios de negocio, implementa migracoes seguras com snapshots e rollback, e garante integridade e seguranca dos dados.
...
|---------|---------|-----------|
| `.electron-aaos-core/development/tasks/db-domain-modeling.md` | `*model-domain` | Sessao interativa de modelagem de dominio |
| `.electron-aaos-core/development/tasks/setup-database.md` | `*setup-database [type]` | Setup de projeto de database (Supabase, PostgreSQL, MongoDB, MySQL, SQLite) |
| `.electron-aaos-core/development/tasks/db-bootstrap.md` | `*bootstrap` | Cria estrutura padrao de projeto Supabase |
| `.electron-aaos-core/development/tasks/db-env-check.md` | `*env-check` | Valida variaveis de ambiente do database |
| `.electron-aaos-core/development/tasks/db-apply-migration.md` | `*apply-migration {path}` | Aplica migracao com snapshot e lock advisory |
| `.electron-aaos-core/development/tasks/db-dry-run.md` | `*dry-run {path}` | Testa migracao sem commit |
| `.electron-aaos-core/development/tasks/db-seed.md` | `*seed {path}` | Aplica seed data (idempotent) |
| `.electron-aaos-core/development/tasks/db-snapshot.md` | `*snapshot {label}` | Cria snapshot do schema |
| `.electron-aaos-core/development/tasks/db-rollback.md` | `*rollback {snapshot_or_file}` | Restaura snapshot ou executa rollback |
| `.electron-aaos-core/development/tasks/db-smoke-test.md` | `*smoke-test {version}` | Testes abrangentes de database |
| `.electron-aaos-core/development/tasks/security-audit.md` | `*security-audit {scope}` | Auditoria de seguranca (rls, schema, full) |
| `.electron-aaos-core/development/tasks/analyze-performance.md` | `*analyze-performance {type}` | Analise de performance (query, hotpaths, interactive) |
| `.electron-aaos-core/development/tasks/db-policy-apply.md` | `*policy-apply {table} {mode}` | Instala politica RLS (KISS ou granular) |
| `.electron-aaos-core/development/tasks/test-as-user.md` | `*test-as-user {user_id}` | Emula usuario para testar RLS |
| `.electron-aaos-core/development/tasks/db-verify-order.md` | `*verify-order {path}` | Valida ordenacao DDL para dependencias |
| `.electron-aaos-core/development/tasks/db-load-csv.md` | `*load-csv {table} {file}` | Carregador seguro de CSV (staging->merge) |
| `.electron-aaos-core/development/tasks/db-run-sql.md` | `*run-sql {file_or_inline}` | Executa SQL raw com transacao |
| `.electron-aaos-core/development/tasks/create-deep-research-prompt.md` | `*research {topic}` | Gera prompt de pesquisa profunda |
| `.electron-aaos-core/development/tasks/execute-checklist.md` | `*execute-checklist {checklist}` | Executa checklist DBA |
| `.electron-aaos-core/development/tasks/create-doc.md` | `*doc-out` | Output de documento completo |
...
| Arquivo | Proposito |
|---------|-----------|
| `.electron-aaos-core/development/agents/data-engineer.md` | Definicao core do agente @data-engineer (persona, comandos, workflows) |
| `.claude/commands/Electron AAOS/agents/data-engineer.md` | Comando Claude Code para ativar @data-engineer |
...
| Arquivo | Proposito |
|---------|-----------|
| `.electron-aaos-core/development/workflows/brownfield-discovery.yaml` | Workflow de discovery brownfield (Fase 2 e 5) |
...
- [db-domain-modeling.md](.electron-aaos-core/development/tasks/db-domain-modeling.md)
- [setup-database.md](.electron-aaos-core/development/tasks/setup-database.md)
- [db-apply-migration.md](.electron-aaos-core/development/tasks/db-apply-migration.md)
- [security-audit.md](.electron-aaos-core/development/tasks/security-audit.md)
- [analyze-performance.md](.electron-aaos-core/development/tasks/analyze-performance.md)
- [db-snapshot.md](.electron-aaos-core/development/tasks/db-snapshot.md)
- [db-rollback.md](.electron-aaos-core/development/tasks/db-rollback.md)
- [db-bootstrap.md](.electron-aaos-core/development/tasks/db-bootstrap.md)

### Agente

- [data-engineer.md](.electron-aaos-core/development/agents/data-engineer.md)

### Workflows

- [brownfield-discovery.yaml](.electron-aaos-core/development/workflows/brownfield-discovery.yaml)
