...
O agente `@devops` (Gage) e o especialista em infraestrutura e operacoes do framework Electron AAOS. Ele e responsavel por:
...
|---------|---------|-----------|
| Definicao do Agente | `.electron-aaos-core/development/agents/devops.md` | Persona, comandos e comportamentos |

### Arquivos de Tasks

| Task | Caminho | Comando |
|------|---------|---------|
| Pre-Push Quality Gate | `.electron-aaos-core/development/tasks/github-devops-pre-push-quality-gate.md` | `*push` |
| Version Management | `.electron-aaos-core/development/tasks/github-devops-version-management.md` | `*version-check` |
| Repository Cleanup | `.electron-aaos-core/development/tasks/github-devops-repository-cleanup.md` | `*cleanup` |
| CI/CD Configuration | `.electron-aaos-core/development/tasks/ci-cd-configuration.md` | `*ci-cd` |
| Release Management | `.electron-aaos-core/development/tasks/release-management.md` | `*release` |
| Environment Bootstrap | `.electron-aaos-core/development/tasks/environment-bootstrap.md` | `*environment-bootstrap` |
| Search MCP | `.electron-aaos-core/development/tasks/search-mcp.md` | `*search-mcp` |
| Add MCP | `.electron-aaos-core/development/tasks/add-mcp.md` | `*add-mcp` |
| Setup MCP Docker | `.electron-aaos-core/development/tasks/setup-mcp-docker.md` | `*setup-mcp-docker` |
| Setup GitHub | `.electron-aaos-core/development/tasks/setup-github.md` | `*setup-github` |
| Security Audit | `.electron-aaos-core/development/tasks/security-audit.md` | `*security-audit` |
| Security Scan | `.electron-aaos-core/development/tasks/security-scan.md` | `*security-scan` |
...
flowchart TD
    ...
    STRUCTURE --> DIR3["docs/"]
    STRUCTURE --> DIR4[".electron-aaos-core/"]
...
| Task | Descricao |
|------|-----------|
| [Pre-Push Quality Gate](.electron-aaos-core/development/tasks/github-devops-pre-push-quality-gate.md) | Validacao antes do push |
| [Version Management](.electron-aaos-core/development/tasks/github-devops-version-management.md) | Gerenciamento de versoes |
| [CI/CD Configuration](.electron-aaos-core/development/tasks/ci-cd-configuration.md) | Configuracao de pipelines |
| [Release Management](.electron-aaos-core/development/tasks/release-management.md) | Gerenciamento de releases |
| [Environment Bootstrap](.electron-aaos-core/development/tasks/environment-bootstrap.md) | Bootstrap de ambientes |
...
*Documento gerado pelo Sistema Electron AAOS - 2026-02-04*
*Mantido por: @devops*
