# Sistema do Agente @electron-aaos-master

> **Versao:** 1.0.0
> **Criado:** 2026-02-04
> **Owner:** @electron-aaos-master (Orion)
...
O **@electron-aaos-master** (Orion - The Orchestrator) e o meta-agente principal do framework Electron AAOS-FULLSTACK. Ele atua como orquestrador universal, desenvolvedor de framework e especialista no metodo Electron AAOS. Suas principais responsabilidades incluem:
...
- **Knowledge Base**: Acesso ao conhecimento completo do Electron AAOS Method
...
- Acessar o Knowledge Base do Electron AAOS (*kb)

---

## Lista Completa de Arquivos

### Arquivos Core de Tasks do @electron-aaos-master

| Arquivo | Comando | Proposito |
|---------|---------|-----------|
| `.electron-aaos-core/development/tasks/create-agent.md` | `*create agent` | Cria nova definicao de agente usando sistema de templates |
| `.electron-aaos-core/development/tasks/create-task.md` | `*create task` | Cria novo arquivo de task com estrutura padronizada |
| `.electron-aaos-core/development/tasks/create-workflow.md` | `*create workflow` | Cria nova definicao de workflow multi-agente |
| `.electron-aaos-core/development/tasks/modify-agent.md` | `*modify agent` | Modifica agente existente com backup e rollback |
| `.electron-aaos-core/development/tasks/modify-task.md` | `*modify task` | Modifica task existente preservando compatibilidade |
| `.electron-aaos-core/development/tasks/modify-workflow.md` | `*modify workflow` | Modifica workflow existente mantendo integridade |
| `.electron-aaos-core/development/tasks/analyze-framework.md` | `*analyze-framework` | Analisa estrutura do framework, redundancias e performance |
| `.electron-aaos-core/development/tasks/deprecate-component.md` | `*deprecate-component` | Deprecia componente com timeline e migracao |
| `.electron-aaos-core/development/tasks/propose-modification.md` | `*propose-modification` | Cria proposta de modificacao para revisao colaborativa |
| `.electron-aaos-core/development/tasks/execute-checklist.md` | `*execute-checklist` | Executa checklist de validacao |
| `.electron-aaos-core/development/tasks/create-doc.md` | `*create-doc` | Cria documento a partir de template YAML |
| `.electron-aaos-core/development/tasks/advanced-elicitation.md` | `*advanced-elicitation` | Executa elicitacao avancada com multiplos metodos |
| `.electron-aaos-core/development/tasks/kb-mode-interaction.md` | `*kb` | Habilita modo Knowledge Base interativo |
| `.electron-aaos-core/development/tasks/correct-course.md` | `*correct-course` | Analisa e corrige desvios de processo/qualidade |
| `.electron-aaos-core/development/tasks/update-manifest.md` | `*update-manifest` | Atualiza manifesto de equipe com novos agentes |
| `.electron-aaos-core/development/tasks/create-next-story.md` | `*create-next-story` | Cria proxima user story |
| `.electron-aaos-core/development/tasks/create-deep-research-prompt.md` | - | Gera prompts de pesquisa profunda |
| `.electron-aaos-core/development/tasks/improve-self.md` | - | Auto-melhoria do agente |
| `.electron-aaos-core/development/tasks/shard-doc.md` | `*shard-doc` | Quebra documento em partes menores |
| `.electron-aaos-core/development/tasks/document-project.md` | `*document-project` | Gera documentacao do projeto |
| `.electron-aaos-core/development/tasks/index-docs.md` | `*index-docs` | Indexa documentacao para busca |

### Arquivos de Definicao do Agente

| Arquivo | Proposito |
|---------|-----------|
| `.electron-aaos-core/development/agents/electron-aaos-master.md` | Definicao completa do agente (persona, comandos, dependencias) |
| `.claude/commands/Electron AAOS/agents/electron-aaos-master.md` | Comando Claude Code para ativar @electron-aaos-master |

### Arquivos de Templates do @electron-aaos-master

| Arquivo | Proposito |
|---------|-----------|
| `.electron-aaos-core/development/templates/agent-template.yaml` | Template para criacao de novos agentes |
| `.electron-aaos-core/development/templates/task-template.md` | Template para criacao de novas tasks |
| `.electron-aaos-core/development/templates/workflow-template.yaml` | Template para criacao de novos workflows |
| `.electron-aaos-core/development/templates/prd-tmpl.yaml` | Template para PRD |
| `.electron-aaos-core/development/templates/story-tmpl.yaml` | Template para stories |
| `.electron-aaos-core/development/templates/architecture-tmpl.yaml` | Template para arquitetura |
| `.electron-aaos-core/development/templates/brownfield-prd-tmpl.yaml` | Template PRD brownfield |
| `.electron-aaos-core/development/templates/brownfield-architecture-tmpl.yaml` | Template arquitetura brownfield |
| `.electron-aaos-core/development/templates/competitor-analysis-tmpl.yaml` | Template analise de concorrentes |
| `.electron-aaos-core/development/templates/market-research-tmpl.yaml` | Template pesquisa de mercado |
| `.electron-aaos-core/development/templates/project-brief-tmpl.yaml` | Template brief de projeto |
| `.electron-aaos-core/development/templates/front-end-architecture-tmpl.yaml` | Template arquitetura frontend |
| `.electron-aaos-core/development/templates/front-end-spec-tmpl.yaml` | Template spec frontend |
| `.electron-aaos-core/development/templates/fullstack-architecture-tmpl.yaml` | Template arquitetura fullstack |

### Arquivos de Dados e Utilidades

| Arquivo | Proposito |
|---------|-----------|
| `.electron-aaos-core/development/data/electron-aaos-kb.md` | Knowledge Base do Electron AAOS Method |
| `.electron-aaos-core/development/data/brainstorming-techniques.md` | Tecnicas de brainstorming |
| `.electron-aaos-core/development/data/elicitation-methods.md` | Metodos de elicitacao |
| `.electron-aaos-core/development/data/technical-preferences.md` | Preferencias tecnicas |
| `.electron-aaos-core/development/utils/security-checker.js` | Validador de seguranca |
| `.electron-aaos-core/development/utils/yaml-validator.js` | Validador de YAML |
| `.electron-aaos-core/development/utils/workflow-management.md` | Gestao de workflows |

### Arquivos de Workflows do @electron-aaos-master

| Arquivo | Proposito |
|---------|-----------|
| `.electron-aaos-core/development/workflows/brownfield-fullstack.md` | Workflow fullstack brownfield |
| `.electron-aaos-core/development/workflows/brownfield-service.md` | Workflow servico brownfield |
| `.electron-aaos-core/development/workflows/brownfield-ui.md` | Workflow UI brownfield |
| `.electron-aaos-core/development/workflows/greenfield-fullstack.md` | Workflow fullstack greenfield |
| `.electron-aaos-core/development/workflows/greenfield-service.md` | Workflow servico greenfield |
| `.electron-aaos-core/development/workflows/greenfield-ui.md` | Workflow UI greenfield |

### Arquivos de Checklists do @electron-aaos-master

| Arquivo | Proposito |
|---------|-----------|
| `.electron-aaos-core/development/checklists/architect-checklist.md` | Checklist de arquitetura |
| `.electron-aaos-core/development/checklists/change-checklist.md` | Checklist de mudancas |
| `.electron-aaos-core/development/checklists/pm-checklist.md` | Checklist de PM |
| `.electron-aaos-core/development/checklists/po-master-checklist.md` | Checklist de PO |
| `.electron-aaos-core/development/checklists/story-dod-checklist.md` | Checklist DoD de stories |
| `.electron-aaos-core/development/checklists/story-draft-checklist.md` | Checklist draft de stories |

### Arquivos Relacionados de Outros Agentes

| Arquivo | Agente | Proposito |
|---------|--------|-----------|
| `.electron-aaos-core/development/tasks/brownfield-create-epic.md` | @pm | Criacao de epics (delegada) |
| `.electron-aaos-core/development/tasks/brownfield-create-story.md` | @pm | Criacao de stories (delegada) |
| `.electron-aaos-core/development/tasks/analyst-facilitate-brainstorming.md` | @analyst | Brainstorming (delegado) |
| `.electron-aaos-core/development/tasks/generate-ai-frontend-prompt.md` | @architect | Geracao de prompts AI (delegada) |
| `.electron-aaos-core/development/tasks/create-suite.md` | @qa | Criacao de suites de teste (delegada) |
...
flowchart TB
    subgraph ACTIVATION["🚀 ATIVACAO"]
        USER["👤 Usuario"]
        ACTIVATE["@electron-aaos-master"]
        GREETING["greeting-builder.js<br/>Saudacao Inteligente"]
    end

    USER -->|"@electron-aaos-master"| ACTIVATE
    ACTIVATE --> GREETING
    ...
    subgraph OUTPUTS["📁 OUTPUTS"]
        AGENTS_DIR[".electron-aaos-core/agents/"]
        TASKS_DIR[".electron-aaos-core/tasks/"]
        WORKFLOWS_DIR[".electron-aaos-core/workflows/"]
        DOCS_DIR["docs/"]
    end
...
```mermaid
flowchart LR
    subgraph MASTER["👑 @electron-aaos-master (Orion)"]
...
| Arquivo | Proposito |
|---------|-----------|
| `.electron-aaos-core/core-config.yaml` | Configuracao central do framework |
| `.electron-aaos-core/install-manifest.yaml` | Manifesto de instalacao |
| `.electron-aaos-core/config/agent-config-requirements.yaml` | Requisitos de configuracao de agentes |
| `.electron-aaos/project-registry.yaml` | Registry central de projetos |
...
**Solucao:**
1. Liste templates disponiveis: verifique `.electron-aaos-core/development/templates/`
...
**Solucao:**
1. Verifique existencia de `.electron-aaos-core/development/data/electron-aaos-kb.md`
...
- [Agente electron-aaos-master](.electron-aaos-core/development/agents/electron-aaos-master.md)
- [Knowledge Base](.electron-aaos-core/development/data/electron-aaos-kb.md)
- [Guia do Usuario](.electron-aaos-core/user-guide.md)

### Standards e Documentacao

- [Electron AAOS Framework Master](.electron-aaos-core/docs/standards/Electron AAOS-FRAMEWORK-MASTER.md)
- [Electron AAOS Livro de Ouro](.electron-aaos-core/docs/standards/Electron AAOS-LIVRO-DE-OURO.md)
- [Agent Personalization Standard](.electron-aaos-core/docs/standards/AGENT-PERSONALIZATION-STANDARD-V1.md)

### Diretorio de Tasks

- [Tasks Directory](.electron-aaos-core/development/tasks/)
- [Templates Directory](.electron-aaos-core/development/templates/)
- [Workflows Directory](.electron-aaos-core/development/workflows/)
...
| Aspecto | Detalhes |
|---------|----------|
| **Nome do Agente** | Orion (electron-aaos-master) |
...
|------|-------|-----------|
| 2026-02-04 | @electron-aaos-master | Documento inicial criado com mapeamento completo |
