...
> Agent definition: `.electron-aaos-core/development/agents/po.md`
...
|-------|------|--------|---------|
| 1 | `.electron-aaos-core/development/agents/po.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.electron-aaos-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.electron-aaos-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: devStoryLocation, prd, storyBacklog, templatesLocation |
| 4 | `.electron-aaos-core/data/workflow-patterns.yaml` | WorkflowNavigator._loadPatterns() | Workflow state detection |
| 5 | `.electron-aaos-core/product/data/elicitation-methods.md` | AgentConfigLoader.loadFile() | Elicitation methods (always loaded, 5KB) |
...
po:
  config_sections:
    ...
    - templatesLocation
  files_loaded:
    - path: .electron-aaos-core/product/data/elicitation-methods.md
      lazy: false
      size: 5KB
  lazy_loading:
...
**Task file:** `.electron-aaos-core/development/tasks/po-backlog-add.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `po-backlog-add.md` | Task | EXISTS |
| `.electron-aaos-core/product/data/elicitation-methods.md` | Data | EXISTS (pre-loaded) |
...
**Task file:** `.electron-aaos-core/development/tasks/po-manage-story-backlog.md`
...
**Task file:** `.electron-aaos-core/development/tasks/po-stories-index.md`
...
**Task file:** `.electron-aaos-core/development/tasks/validate-next-story.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `validate-next-story.md` | Task | EXISTS |
| `.electron-aaos-core/product/templates/story-tmpl.yaml` | Template | EXISTS |
| `.electron-aaos-core/product/checklists/po-master-checklist.md` | Checklist | EXISTS |
...
**Task file:** `.electron-aaos-core/development/tasks/po-sync-story.md`
...
flowchart TD
    ...
    E -->|None configured| J[Prompt: run electron-aaos init]
...
**Task file:** `.electron-aaos-core/development/tasks/po-pull-story.md`
...
| @po -> @electron-aaos-master | Escalate | Course corrections via `*correct-course` |
...
**Delegates to @electron-aaos-master when:**
