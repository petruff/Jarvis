...
> Agent definition: `.electron-aaos-core/development/agents/analyst.md`
...
|-------|------|--------|---------|
| 1 | `.electron-aaos-core/development/agents/analyst.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.electron-aaos-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.electron-aaos-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: dataLocation, analyticsLocation |
| 4 | `.electron-aaos-core/data/workflow-patterns.yaml` | WorkflowNavigator._loadPatterns() | Workflow state detection |
| 5 | `.electron-aaos-core/product/data/brainstorming-techniques.md` | AgentConfigLoader.loadFile() | Brainstorming techniques (always loaded, 2KB) |
...
analyst:
  config_sections:
    ...
    - analyticsLocation
  files_loaded:
    - path: .electron-aaos-core/product/data/brainstorming-techniques.md
      lazy: false
      size: 2KB
...
**Template:** `.electron-aaos-core/product/templates/project-brief-tmpl.yaml` (EXISTS)
...
| `.electron-aaos-core/product/data/elicitation-methods.md` | Data | Referenced by create-doc |
...
**Task file:** `.electron-aaos-core/development/tasks/create-doc.md`
**Template:** `.electron-aaos-core/product/templates/market-research-tmpl.yaml` (EXISTS)
...
**Task file:** `.electron-aaos-core/development/tasks/create-doc.md`
**Template:** `.electron-aaos-core/product/templates/competitor-analysis-tmpl.yaml` (EXISTS)
...
**Task file:** `.electron-aaos-core/development/tasks/facilitate-brainstorming-session.md`
**Template:** `.electron-aaos-core/product/templates/brainstorming-output-tmpl.yaml` (EXISTS)
**Data file:** `.electron-aaos-core/product/data/brainstorming-techniques.md` (EXISTS)
...
**Task file:** `.electron-aaos-core/development/tasks/spec-research-dependencies.md`
...
**Script:** `.electron-aaos-core/infrastructure/scripts/pattern-extractor.js` (EXISTS)
