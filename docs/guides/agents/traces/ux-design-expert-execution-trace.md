...
> Agent definition: `.electron-aaos-core/development/agents/ux-design-expert.md`
...
|-------|------|--------|---------|
| 1 | `.electron-aaos-core/development/agents/ux-design-expert.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.electron-aaos-core/core-config.yaml` | generate-greeting.js (fs.readFile + yaml.load) | Core configuration |
| 3 | `.electron-aaos-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: dataLocation, uxLocation |
| 4 | `.electron-aaos-core/data/workflow-patterns.yaml` | WorkflowNavigator._loadPatterns() | Workflow state detection |
| 5 | `.electron-aaos/session-state.json` | SessionContextLoader.loadContext() | Session type detection (sessionType, previousAgent, lastCommands) |
| 6 | `.electron-aaos/project-status.yaml` | loadProjectStatus() | Cached project status (60s TTL) |
...
**Task file:** `.electron-aaos-core/development/tasks/ux-user-research.md`
...
**Task file:** `.electron-aaos-core/development/tasks/ux-create-wireframe.md`
...
**Task file:** `.electron-aaos-core/development/tasks/generate-ai-frontend-prompt.md`
...
**Template:** `.electron-aaos-core/product/templates/front-end-spec-tmpl.yaml`
...
**Task file:** `.electron-aaos-core/development/tasks/audit-codebase.md`
...
**Task file:** `.electron-aaos-core/development/tasks/consolidate-patterns.md`
...
**Task file:** `.electron-aaos-core/development/tasks/generate-shock-report.md`
**Template:** `.electron-aaos-core/product/templates/shock-report-tmpl.html`
...
**Task file:** `.electron-aaos-core/development/tasks/extract-tokens.md`
**Template:** `.electron-aaos-core/product/templates/tokens-schema-tmpl.yaml`
...
**Task file:** `.electron-aaos-core/development/tasks/setup-design-system.md`
...
**Task file:** `.electron-aaos-core/development/tasks/generate-migration-strategy.md`
**Template:** `.electron-aaos-core/product/templates/migration-strategy-tmpl.md`
...
**Task file:** `.electron-aaos-core/development/tasks/tailwind-upgrade.md`
...
**Task file:** `.electron-aaos-core/development/tasks/audit-tailwind-config.md`
...
**Task file:** `.electron-aaos-core/development/tasks/export-design-tokens-dtcg.md`
**Templates:** `.electron-aaos-core/product/templates/token-exports-css-tmpl.css`, `.electron-aaos-core/product/templates/token-exports-tailwind-tmpl.js`
...
**Task file:** `.electron-aaos-core/development/tasks/bootstrap-shadcn-library.md`
...
**Task file:** `.electron-aaos-core/development/tasks/build-component.md`
**Template:** `.electron-aaos-core/product/templates/component-react-tmpl.tsx`
...
**Task file:** `.electron-aaos-core/development/tasks/compose-molecule.md`
...
**Task file:** `.electron-aaos-core/development/tasks/extend-pattern.md`
...
**Task file:** `.electron-aaos-core/development/tasks/generate-documentation.md`
...
**Checklist file:** `.electron-aaos-core/product/checklists/accessibility-wcag-checklist.md`
...
**Task file:** `.electron-aaos-core/development/tasks/calculate-roi.md`
...
**Task file:** `.electron-aaos-core/development/tasks/ux-ds-scan-artifact.md`
**Template:** `.electron-aaos-core/product/templates/ds-artifact-analysis.md`
...
**Task file:** `.electron-aaos-core/development/tasks/integrate-Squad.md` (MISSING)
...
The agent definition references dependencies using short names (e.g., `electron-aaos-core/tasks/...`). The actual resolution paths are:

| Dependency Type | Agent Definition Path | Actual Disk Location |
|-----------------|----------------------|---------------------|
| Tasks | `electron-aaos-core/tasks/{name}` | `.electron-aaos-core/development/tasks/{name}` |
| Templates | `electron-aaos-core/templates/{name}` | `.electron-aaos-core/product/templates/{name}` |
| Checklists | `electron-aaos-core/checklists/{name}` | `.electron-aaos-core/product/checklists/{name}` |
| Data | `electron-aaos-core/data/{name}` | `.electron-aaos-core/data/{name}` or `.electron-aaos-core/product/data/{name}` |

All 9 templates, all 4 checklists, and all 7 data files resolve correctly to files in `product/` directories. The `development/data/` directory does not exist; data files live under `.electron-aaos-core/data/` and `.electron-aaos-core/product/data/`.
...
**Template for state persistence:** `.electron-aaos-core/product/templates/state-persistence-tmpl.yaml` (EXISTS)
