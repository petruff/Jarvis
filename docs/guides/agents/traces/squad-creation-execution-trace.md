...
> Agent definition: `.electron-aaos-core/development/agents/squad-creator.md`
...
|-------|------|--------|---------|
| 1 | `.electron-aaos-core/development/agents/squad-creator.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.electron-aaos-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.electron-aaos-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: dataLocation (no squad-creator entry found) |
| 4 | `.electron-aaos-core/data/workflow-patterns.yaml` | WorkflowNavigator._loadPatterns() | Workflow state detection |
| 5 | `.electron-aaos/session-state.json` | ContextDetector._detectFromFile() | Session type detection (if no conversation history) |
| 6 | `.electron-aaos/project-status.yaml` | ProjectStatusLoader.loadCache() | Cached project status (60s TTL) |
...
| `*sync-squad-electron-aaos` | squad-creator-sync-electron-aaos.md | full | No |
...
**Task file:** `.electron-aaos-core/development/tasks/squad-creator-design.md`
...
**Task file:** `.electron-aaos-core/development/tasks/squad-creator-create.md`
...
| `.electron-aaos-core/development/templates/squad-template/` | Template scaffold | EXISTS |
...
**Task file:** `.electron-aaos-core/development/tasks/squad-creator-validate.md`
...
**Task file:** `.electron-aaos-core/development/tasks/squad-creator-list.md`
...
**Task file:** `.electron-aaos-core/development/tasks/squad-creator-migrate.md`
...
flowchart TD
    ...
    C --> D["Detect: config.yaml, flat structure,<br/>missing electron-aaos.type, missing electron-aaos.minVersion"]
    D --> E{Needs migration?}
...
**Migration detections:** config.yaml (rename to squad.yaml), flat structure (create dirs), missing fields (electron-aaos.type, electron-aaos.minVersion, name, version)

---

### `*analyze-squad`

**Task file:** `.electron-aaos-core/development/tasks/squad-creator-analyze.md`
...
**Task file:** `.electron-aaos-core/development/tasks/squad-creator-extend.md`
...
| `squad-validator.js` | Script | EXISTS |
| `.electron-aaos-core/development/templates/squad/agent-template.md` | Template | EXISTS |
| `.electron-aaos-core/development/templates/squad/task-template.md` | Template | EXISTS |
| `.electron-aaos-core/development/templates/squad/workflow-template.yaml` | Template | EXISTS |
| `.electron-aaos-core/development/templates/squad/checklist-template.md` | Template | EXISTS |
| `.electron-aaos-core/development/templates/squad/template-template.md` | Template | EXISTS |
| `.electron-aaos-core/development/templates/squad/tool-template.js` | Template | EXISTS |
| `.electron-aaos-core/development/templates/squad/script-template.js` | Template | EXISTS |
| `.electron-aaos-core/development/templates/squad/data-template.yaml` | Template | EXISTS |
...
**Task file:** `.electron-aaos-core/development/tasks/squad-creator-download.md`
...
flowchart TD
    ...
    B --> C{--list flag?}
    C -->|yes| D[Fetch registry.json from electron-aaos-squads]
...
**Source:** `github.com/Electron AAOSAI/electron-aaos-squads`

---

### `*publish-squad`

**Task file:** `.electron-aaos-core/development/tasks/squad-creator-publish.md`
**Status:** Active (Sprint 8)
...
flowchart TD
    ...
    G -->|no| I[Fork/clone electron-aaos-squads]
...
**Target:** `github.com/Electron AAOSAI/electron-aaos-squads` via Pull Request

**Tools used:** github-cli (gh auth, gh pr create)

---

### `*sync-squad-electron-aaos`

**Task file:** `.electron-aaos-core/development/tasks/squad-creator-sync-electron-aaos.md`
**Status:** Active (Sprint 8)

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `squad-creator-sync-electron-aaos.md` | Task | EXISTS |
| `squad-validator.js` | Script | EXISTS |
...
```mermaid
flowchart TD
    A["*sync-squad-electron-aaos {path}"] --> B[Load squad-creator-sync-electron-aaos.md task]
...
**API endpoint:** `https://api.electron-aaos.dev/api/squads/sync`
...
graph TD
    ...
    subgraph "Task Files"
        ...
        T10[squad-creator-sync-electron-aaos.md]
...
| @electron-aaos-master -> @squad-creator | Invokes | Component creation (agents, tasks, workflows) |
...
- `.electron-aaos-core/development/tasks/squad-creator-design.md`
- `.electron-aaos-core/development/tasks/squad-creator-create.md`
- `.electron-aaos-core/development/tasks/squad-creator-validate.md`
- `.electron-aaos-core/development/tasks/squad-creator-list.md`
- `.electron-aaos-core/development/tasks/squad-creator-migrate.md`
- `.electron-aaos-core/development/tasks/squad-creator-analyze.md`
- `.electron-aaos-core/development/tasks/squad-creator-extend.md`
- `.electron-aaos-core/development/tasks/squad-creator-download.md`
- `.electron-aaos-core/development/tasks/squad-creator-publish.md`
- `.electron-aaos-core/development/tasks/squad-creator-sync-electron-aaos.md`
- `.electron-aaos-core/development/tasks/squad-creator-sync-ide-command.md`

**Scripts (11 files in squad/ dir, all EXISTS):**
- `.electron-aaos-core/development/scripts/squad/index.js`
- `.electron-aaos-core/development/scripts/squad/squad-loader.js`
- `.electron-aaos-core/development/scripts/squad/squad-validator.js`
- `.electron-aaos-core/development/scripts/squad/squad-generator.js`
- `.electron-aaos-core/development/scripts/squad/squad-designer.js`
- `.electron-aaos-core/development/scripts/squad/squad-migrator.js`
- `.electron-aaos-core/development/scripts/squad/squad-analyzer.js`
- `.electron-aaos-core/development/scripts/squad/squad-extender.js`
- `.electron-aaos-core/development/scripts/squad/squad-downloader.js`
- `.electron-aaos-core/development/scripts/squad/squad-publisher.js`
- `.electron-aaos-core/development/scripts/squad/README.md`

**Schemas (2 files, all EXISTS):**
- `.electron-aaos-core/schemas/squad-schema.json`
- `.electron-aaos-core/schemas/squad-design-schema.json`

**Component Templates (8 files, all EXISTS):**
- `.electron-aaos-core/development/templates/squad/agent-template.md`
- `.electron-aaos-core/development/templates/squad/task-template.md`
- `.electron-aaos-core/development/templates/squad/workflow-template.yaml`
- `.electron-aaos-core/development/templates/squad/checklist-template.md`
- `.electron-aaos-core/development/templates/squad/template-template.md`
- `.electron-aaos-core/development/templates/squad/tool-template.js`
- `.electron-aaos-core/development/templates/squad/script-template.js`
- `.electron-aaos-core/development/templates/squad/data-template.yaml`

**Squad Template Scaffold (10 files, all EXISTS):**
- `.electron-aaos-core/development/templates/squad-template/squad.yaml`
- `.electron-aaos-core/development/templates/squad-template/README.md`
- `.electron-aaos-core/development/templates/squad-template/package.json`
- `.electron-aaos-core/development/templates/squad-template/.gitignore`
- `.electron-aaos-core/development/templates/squad-template/LICENSE`
- `.electron-aaos-core/development/templates/squad-template/agents/example-agent.yaml`
- `.electron-aaos-core/development/templates/squad-template/tasks/example-task.yaml`
- `.electron-aaos-core/development/templates/squad-template/workflows/example-workflow.yaml`
- `.electron-aaos-core/development/templates/squad-template/templates/example-template.md`
- `.electron-aaos-core/development/templates/squad-template/tests/example-agent.test.js`
...
*Traced from source on 2026-02-05 | Story Electron AAOS-TRACE-001*
