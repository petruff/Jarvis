...
> Agent definition: `.electron-aaos-core/development/agents/dev.md`
...
|-------|------|--------|---------|
| 1 | `.electron-aaos-core/development/agents/dev.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.electron-aaos-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration + devLoadAlwaysFiles list |
| 3 | `.electron-aaos-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: devLoadAlwaysFiles, devStoryLocation, dataLocation |
...
| 8 | `.electron-aaos-core/data/technical-preferences.md` | AgentConfigLoader.loadFile() | Technical preferences (always loaded, 15KB) |
| 9 | `.electron-aaos/session-state.json` | ContextDetector._detectFromFile() | Session type detection (if no conversation history) |
| 10 | `.electron-aaos/project-status.yaml` | ProjectStatusLoader.loadCache() | Cached project status (60s TTL) |
...
**Task file:** `.electron-aaos-core/development/tasks/dev-develop-story.md`
...
**Task file:** `.electron-aaos-core/development/tasks/plan-execute-subtask.md`
...
**Task file:** `.electron-aaos-core/development/tasks/build-autonomous.md`
...
**Task files:** `.electron-aaos-core/development/tasks/gotcha.md`, `.electron-aaos-core/development/tasks/gotchas.md`
...
**Task files:** `.electron-aaos-core/development/tasks/create-worktree.md`, `list-worktrees.md`, `remove-worktree.md`
...
**Task file:** `.electron-aaos-core/development/tasks/qa-fix-issues.md`
...
**Task file:** `.electron-aaos-core/development/tasks/waves.md`
...
**Task file:** `.electron-aaos-core/development/tasks/create-service.md`
