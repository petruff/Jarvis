...
> Agent definition: `.electron-aaos-core/development/agents/sm.md`
...
|-------|------|--------|---------|
| 1 | `.electron-aaos-core/development/agents/sm.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.electron-aaos-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.electron-aaos-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: devStoryLocation, storyBacklog, dataLocation |
| 4 | `.electron-aaos-core/data/workflow-patterns.yaml` | WorkflowNavigator._loadPatterns() | Workflow state detection |
| 5 | `.electron-aaos-core/product/data/mode-selection-best-practices.md` | AgentConfigLoader.loadFile() | Mode selection best practices (always loaded, 10KB) |
...
sm:
  config_sections:
    ...
    - dataLocation
  files_loaded:
    - path: .electron-aaos-core/product/data/mode-selection-best-practices.md
      lazy: false
      size: 10KB
    - path: .electron-aaos-core/data/workflow-patterns.yaml
      lazy: false
      size: 8KB
...
**Task file:** `.electron-aaos-core/development/tasks/sm-create-next-story.md`
**Template:** `.electron-aaos-core/development/templates/story-tmpl.yaml` (MISSING in development/, EXISTS in `.electron-aaos-core/product/templates/story-tmpl.yaml`)
...
| `.electron-aaos-core/product/data/mode-selection-best-practices.md` | Data | Referenced by sm config |
...
**Checklist:** `.electron-aaos-core/development/checklists/story-draft-checklist.md` (MISSING in development/, EXISTS in `.electron-aaos-core/product/checklists/story-draft-checklist.md`)
...
- Course corrections needed (`@electron-aaos-master *correct-course`)
...
|------|------|---------------|--------|
| `story-tmpl.yaml` | Template | `*draft` (sm-create-next-story.md) | MISSING in `.electron-aaos-core/development/templates/`, EXISTS in `.electron-aaos-core/product/templates/story-tmpl.yaml` |
| `story-draft-checklist.md` | Checklist | `*story-checklist` (execute-checklist.md) | MISSING in `.electron-aaos-core/development/checklists/`, EXISTS in `.electron-aaos-core/product/checklists/story-draft-checklist.md` |
