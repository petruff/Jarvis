...
> Agent definition: `.electron-aaos-core/development/agents/pm.md`
...
|-------|------|--------|---------|
| 1 | `.electron-aaos-core/development/agents/pm.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.electron-aaos-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.electron-aaos-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: devStoryLocation, storyBacklog |
...
|-----------|---------|--------|
| `correct-course.md` | Delegated to @electron-aaos-master | EXISTS |
...
**Template:** `.electron-aaos-core/development/templates/prd-tmpl.yaml` (MISSING in development/templates/)
...
| `.electron-aaos-core/product/templates/prd-tmpl.yaml` | Template | EXISTS (fallback) |
...
**Task file:** `.electron-aaos-core/development/tasks/create-doc.md`
**Template:** `.electron-aaos-core/development/templates/brownfield-prd-tmpl.yaml` (MISSING in development/templates/)
...
| `.electron-aaos-core/product/templates/brownfield-prd-tmpl.yaml` | Template | EXISTS (fallback) |
...
**Task file:** `.electron-aaos-core/development/tasks/brownfield-create-epic.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `brownfield-create-epic.md` | Task | EXISTS |
| `.electron-aaos-core/product/templates/prd-tmpl.yaml` | Template | EXISTS (epic structure) |
| `.electron-aaos-core/product/checklists/pm-checklist.md` | Checklist | EXISTS |
...
**Task file:** `.electron-aaos-core/development/tasks/brownfield-create-story.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `brownfield-create-story.md` | Task | EXISTS |
| `.electron-aaos-core/product/templates/story-tmpl.yaml` | Template | EXISTS (in product/templates/) |
...
**Task file:** `.electron-aaos-core/development/tasks/spec-gather-requirements.md`
...
**Task file:** `.electron-aaos-core/development/tasks/spec-write-spec.md`
...
| @pm -> @electron-aaos-master | Escalate | Course corrections via `*correct-course` |
| @pm -> @devops | Delegate | Git push operations, PR creation |
| @analyst -> @pm | Receives | Project brief for PRD creation |
| @electron-aaos-master -> @pm | Receives | Framework modification requests |
...
| Module | Path | Status |
|--------|------|--------|
| TerminalSpawner | `.electron-aaos-core/core/orchestration/terminal-spawner.js` | EXISTS |
| ExecutorAssignment | `.electron-aaos-core/core/orchestration/executor-assignment.js` | EXISTS |
| PM Script | `.electron-aaos-core/scripts/pm.sh` | EXISTS |
...
**Escalates to @electron-aaos-master when:**
...
**Note:** All 9 task files referenced in dependencies exist in `.electron-aaos-core/development/tasks/`. The 2 templates and 2 checklists are missing from `development/` but exist in `product/` as fallback locations.
