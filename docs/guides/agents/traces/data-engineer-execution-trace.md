...
> Agent definition: `.electron-aaos-core/development/agents/data-engineer.md`
...
|-------|------|--------|---------|
| 1 | `.electron-aaos-core/development/agents/data-engineer.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.electron-aaos-core/core-config.yaml` | generate-greeting.js (CLI wrapper) | Core configuration |
| 3 | `.electron-aaos-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: dataLocation, etlLocation |
...
| 6 | `.electron-aaos/session-state.json` | SessionContextLoader.loadContext() | Session type detection (CLI wrapper pre-loads) |
...
> to GreetingBuilder. See `.electron-aaos-core/development/scripts/generate-greeting.js`.
...
**Template:** `.electron-aaos-core/development/templates/schema-design-tmpl.yaml` (MISSING)
...
| `.electron-aaos-core/data/technical-preferences.md` | Data | Loaded at activation |
...
**Task file:** `.electron-aaos-core/development/tasks/create-doc.md`
**Template:** `.electron-aaos-core/development/templates/rls-policies-tmpl.yaml` (MISSING)
...
**Task file:** `.electron-aaos-core/development/tasks/create-doc.md`
**Template:** `.electron-aaos-core/development/templates/migration-plan-tmpl.yaml` (MISSING)
...
**Task file:** `.electron-aaos-core/development/tasks/create-doc.md`
**Template:** `.electron-aaos-core/development/templates/index-strategy-tmpl.yaml` (MISSING)
...
**Task file:** `.electron-aaos-core/development/tasks/db-domain-modeling.md`
...
**Task file:** `.electron-aaos-core/development/tasks/db-env-check.md`
...
**Task file:** `.electron-aaos-core/development/tasks/db-bootstrap.md`
...
**Task file:** `.electron-aaos-core/development/tasks/db-apply-migration.md`
...
**Task file:** `.electron-aaos-core/development/tasks/db-dry-run.md`
...
**Task file:** `.electron-aaos-core/development/tasks/db-seed.md`
...
**Task file:** `.electron-aaos-core/development/tasks/db-snapshot.md`
...
**Task file:** `.electron-aaos-core/development/tasks/db-rollback.md`
...
**Task file:** `.electron-aaos-core/development/tasks/db-smoke-test.md`
...
**Task file:** `.electron-aaos-core/development/tasks/security-audit.md`
...
**Task file:** `.electron-aaos-core/development/tasks/analyze-performance.md`
...
**Task file:** `.electron-aaos-core/development/tasks/db-policy-apply.md`
...
**Task file:** `.electron-aaos-core/development/tasks/test-as-user.md`
...
**Task file:** `.electron-aaos-core/development/tasks/db-verify-order.md`
...
**Task file:** `.electron-aaos-core/development/tasks/db-load-csv.md`
...
**Task file:** `.electron-aaos-core/development/tasks/db-run-sql.md`
...
**Task file:** `.electron-aaos-core/development/tasks/setup-database.md`
...
flowchart TD
    ...
    B --> C[Resolve checklist from .electron-aaos-core/development/checklists/]
...
**Task file:** `.electron-aaos-core/development/tasks/create-deep-research-prompt.md`
