...
> Agent definition: `.electron-aaos-core/development/agents/devops.md`
...
|-------|------|--------|---------|
| 1 | `.electron-aaos-core/development/agents/devops.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.electron-aaos-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.electron-aaos-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: dataLocation, cicdLocation |
...
| 6 | `.electron-aaos/session-state.json` | ContextDetector._detectFromFile() | Session type detection (if no conversation history) |
| 7 | `.electron-aaos/project-status.yaml` | ProjectStatusLoader.loadCache() | Cached project status (60s TTL) |
...
**Task file:** `.electron-aaos-core/development/tasks/github-devops-pre-push-quality-gate.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `github-devops-pre-push-quality-gate.md` | Task | EXISTS |
| `pre-push-checklist.md` | Checklist | EXISTS (at `.electron-aaos-core/product/checklists/`) |
...
|------|------|--------|
| `github-devops-pre-push-quality-gate.md` | Task | EXISTS |
| `repository-detector.js` | Script | EXISTS (at `.electron-aaos-core/infrastructure/scripts/`) |
...
**Task file:** `.electron-aaos-core/development/tasks/github-devops-github-pr-automation.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `github-devops-github-pr-automation.md` | Task | EXISTS |
| `github-pr-template.md` | Template | EXISTS (at `.electron-aaos-core/product/templates/`) |
...
**Task file:** `.electron-aaos-core/development/tasks/github-devops-version-management.md`
...
**Task file:** `.electron-aaos-core/development/tasks/release-management.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `release-management.md` | Task | EXISTS |
| `changelog-template.md` | Template | EXISTS (at `.electron-aaos-core/product/templates/`) |
| `release-checklist.md` | Checklist | EXISTS (at `.electron-aaos-core/product/checklists/`) |
...
**Task file:** `.electron-aaos-core/development/tasks/ci-cd-configuration.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `ci-cd-configuration.md` | Task | EXISTS |
| `github-actions-ci.yml` | Template | EXISTS (at `.electron-aaos-core/product/templates/`) |
| `github-actions-cd.yml` | Template | EXISTS (at `.electron-aaos-core/product/templates/`) |
...
**Task file:** `.electron-aaos-core/development/tasks/github-devops-repository-cleanup.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `github-devops-repository-cleanup.md` | Task | EXISTS |
| `branch-manager.js` | Script | EXISTS (at `.electron-aaos-core/infrastructure/scripts/`) |
...
**Task file:** `.electron-aaos-core/development/tasks/environment-bootstrap.md`
...
**Task file:** `.electron-aaos-core/development/tasks/setup-github.md`
...
**Task file:** `.electron-aaos-core/development/tasks/check-docs-links.md`
...
**Workflow file:** `.electron-aaos-core/development/workflows/auto-worktree.yaml` (EXISTS)
...
**Scripts:** `.electron-aaos-core/infrastructure/scripts/asset-inventory.js`, `path-analyzer.js`, `migrate-agent.js`
...
**Task file:** `.electron-aaos-core/development/tasks/init-project-status.md`
...
flowchart TD
    ...
    D --> E["Create: .electron-aaos/project-status.yaml"]
...
- Checks `$Electron AAOS_ACTIVE_AGENT` environment variable
...
|------|------|-------------------|-----------------|--------|
| `github-pr-template.md` | Template | `.electron-aaos-core/development/templates/` | `.electron-aaos-core/product/templates/` | Path mismatch -- file exists but at different path |
| `github-actions-ci.yml` | Template | `.electron-aaos-core/development/templates/` | `.electron-aaos-core/product/templates/` | Path mismatch -- file exists but at different path |
| `github-actions-cd.yml` | Template | `.electron-aaos-core/development/templates/` | `.electron-aaos-core/product/templates/` | Path mismatch -- file exists but at different path |
| `changelog-template.md` | Template | `.electron-aaos-core/development/templates/` | `.electron-aaos-core/product/templates/` | Path mismatch -- file exists but at different path |
| `pre-push-checklist.md` | Checklist | `.electron-aaos-core/development/checklists/` | `.electron-aaos-core/product/checklists/` | Path mismatch -- file exists but at different path |
| `release-checklist.md` | Checklist | `.electron-aaos-core/development/checklists/` | `.electron-aaos-core/product/checklists/` | Path mismatch -- file exists but at different path |
| `gitignore-manager` | Util | `.electron-aaos-core/development/utils/` | (not found anywhere) | MISSING -- command may fall back to manual gitignore handling |
| `version-tracker` | Util | `.electron-aaos-core/development/utils/` | (not found anywhere) | MISSING -- version tracking relies on git tags and package.json |

**Note on path resolution:** The `dependencies.templates` and `dependencies.checklists` in the agent YAML resolve via `IDE-FILE-RESOLUTION` to `.electron-aaos-core/development/{type}/{name}`. However, all 4 templates and 2 checklists actually reside in `.electron-aaos-core/product/{type}/`. The 3 infrastructure scripts (`asset-inventory.js`, `path-analyzer.js`, `migrate-agent.js`) and 3 utils (`branch-manager.js`, `repository-detector.js`, `git-wrapper.js`) exist at `.electron-aaos-core/infrastructure/scripts/`, not at the declared path.
