...
> Agent definition: `.electron-aaos-core/development/agents/architect.md`
...
|-------|------|--------|---------|
| 1 | `.electron-aaos-core/development/agents/architect.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.electron-aaos-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.electron-aaos-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: architecture, dataLocation, templatesLocation |
...
**Template:** `.electron-aaos-core/development/templates/fullstack-architecture-tmpl.yaml` (MISSING)
...
| `.electron-aaos-core/data/elicitation-methods` | Data | Referenced by create-doc |
| `.electron-aaos-core/product/templates/` | Templates dir | Scanned dynamically |
...
**Task file:** `.electron-aaos-core/development/tasks/create-doc.md`
**Template:** `.electron-aaos-core/development/templates/architecture-tmpl.yaml` (MISSING)
...
**Task file:** `.electron-aaos-core/development/tasks/create-doc.md`
**Template:** `.electron-aaos-core/development/templates/front-end-architecture-tmpl.yaml` (MISSING)
...
**Task file:** `.electron-aaos-core/development/tasks/create-doc.md`
**Template:** `.electron-aaos-core/development/templates/brownfield-architecture-tmpl.yaml` (MISSING)
...
| `.electron-aaos-core/scripts/execute-task.js` | Script | Referenced |
...
flowchart TD
    ...
    B --> C[Resolve checklist file from .electron-aaos-core/product/checklists/]
...
**Task file:** `.electron-aaos-core/development/tasks/analyze-project-structure.md`
...
**Task file:** `.electron-aaos-core/development/tasks/validate-tech-preset.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `validate-tech-preset.md` | Task | EXISTS |
| `.electron-aaos-core/data/tech-presets/{name}.md` | Data | Validated |
| `.electron-aaos-core/data/tech-presets/_template.md` | Template | Reference |
...
flowchart TD
    ...
    B --> C[Load preset from .electron-aaos-core/data/tech-presets/{name}.md]
...
**Task file:** `.electron-aaos-core/development/tasks/spec-assess-complexity.md`
...
**Task file:** `.electron-aaos-core/development/tasks/plan-create-implementation.md`
...
**Task file:** `.electron-aaos-core/development/tasks/plan-create-context.md`

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `plan-create-context.md` | Task | EXISTS |
| `.electron-aaos-core/core-config.yaml` | Config | Required |
...
**Script:** `.electron-aaos-core/development/scripts/codebase-mapper.js` (MISSING)
