...
> Agent definition: `.electron-aaos-core/development/agents/qa.md`
...
|-------|------|--------|---------|
| 1 | `.electron-aaos-core/development/agents/qa.md` | AgentConfigLoader.loadAgentDefinition() | Agent definition (YAML block) |
| 2 | `.electron-aaos-core/core-config.yaml` | GreetingBuilder._loadConfig() | Core configuration |
| 3 | `.electron-aaos-core/data/agent-config-requirements.yaml` | AgentConfigLoader.loadRequirements() | Config sections: qaLocation, dataLocation, storyBacklog |
| 4 | `.electron-aaos-core/data/workflow-patterns.yaml` | WorkflowNavigator._loadPatterns() | Workflow state detection |
| 5 | `.electron-aaos-core/data/technical-preferences.md` | AgentConfigLoader.loadFile() | Technical preferences (always loaded, 15KB) |
| 6 | `.electron-aaos-core/product/data/test-levels-framework.md` | AgentConfigLoader.loadFile() | Test levels framework (always loaded, 8KB) |
| 7 | `.electron-aaos-core/product/data/test-priorities-matrix.md` | AgentConfigLoader.loadFile() | Test priorities matrix (always loaded, 6KB) |
| 8 | `.electron-aaos/session-state.json` | ContextDetector._detectFromFile() | Session type detection (if no conversation history) |
| 9 | `.electron-aaos/project-status.yaml` | ProjectStatusLoader.loadCache() | Cached project status (60s TTL) |
...
qa:
  config_sections:
    ...
    - storyBacklog
  files_loaded:
    - path: .electron-aaos-core/data/technical-preferences.md
      lazy: false
      size: 15KB
    - path: .electron-aaos-core/product/data/test-levels-framework.md
      lazy: false
      size: 8KB
    - path: .electron-aaos-core/product/data/test-priorities-matrix.md
      lazy: false
      size: 6KB
  lazy_loading:
...
**Task file:** `.electron-aaos-core/development/tasks/qa-run-tests.md`
...
**Task file:** `.electron-aaos-core/development/tasks/qa-review-story.md`
...
| `.electron-aaos-core/product/data/test-levels-framework.md` | Data | Loaded at activation |
| `.electron-aaos-core/product/data/test-priorities-matrix.md` | Data | Loaded at activation |
...
**Task file:** `.electron-aaos-core/development/tasks/qa-review-build.md`
...
**Task file:** `.electron-aaos-core/development/tasks/qa-gate.md`
**Template:** `.electron-aaos-core/product/templates/qa-gate-tmpl.yaml` (EXISTS in product/templates)

**Dependencies loaded:**
| File | Type | Status |
|------|------|--------|
| `qa-gate.md` | Task | EXISTS |
| `qa-gate-tmpl.yaml` | Template | EXISTS (in `.electron-aaos-core/product/templates/`) |
| `docs/stories/{storyId}` | Input | Required |
...
**Task file:** `.electron-aaos-core/development/tasks/qa-nfr-assess.md`
...
**Task file:** `.electron-aaos-core/development/tasks/qa-risk-profile.md`
...
**Task file:** `.electron-aaos-core/development/tasks/qa-create-fix-request.md`
...
**Task file:** `.electron-aaos-core/development/tasks/qa-library-validation.md`
...
**Task file:** `.electron-aaos-core/development/tasks/qa-security-checklist.md`
...
**Task file:** `.electron-aaos-core/development/tasks/qa-migration-validation.md`
...
**Task file:** `.electron-aaos-core/development/tasks/qa-evidence-requirements.md`
...
**Task file:** `.electron-aaos-core/development/tasks/qa-false-positive-detection.md`
...
**Task file:** `.electron-aaos-core/development/tasks/qa-browser-console-check.md`
...
**Task file:** `.electron-aaos-core/development/tasks/qa-test-design.md`
...
**Task file:** `.electron-aaos-core/development/tasks/qa-trace-requirements.md`
...
**Task file:** `.electron-aaos-core/development/tasks/create-suite.md`
...
**Task file:** `.electron-aaos-core/development/tasks/spec-critique.md`
...
**Task file:** `.electron-aaos-core/development/tasks/manage-story-backlog.md` (MISSING)
...
| `qa-gate-tmpl.yaml` | Template | `*gate` (in `dependencies.templates`) | EXISTS in `.electron-aaos-core/product/templates/` but NOT in `.electron-aaos-core/development/templates/` per IDE-FILE-RESOLUTION |
| `story-tmpl.yaml` | Template | (in `dependencies.templates`) | EXISTS in `.electron-aaos-core/product/templates/` but NOT in `.electron-aaos-core/development/templates/` per IDE-FILE-RESOLUTION |
| `test-levels-framework.md` | Data | `agent-config-requirements.yaml` | EXISTS at `.electron-aaos-core/product/data/` (NOT in `.electron-aaos-core/data/` where `dependencies.data` resolves) |
| `test-priorities-matrix.md` | Data | `agent-config-requirements.yaml` | EXISTS at `.electron-aaos-core/product/data/` (NOT in `.electron-aaos-core/data/` where `dependencies.data` resolves) |

**Path Resolution Note:** The `IDE-FILE-RESOLUTION` rule in the agent definition maps `dependencies` to `.electron-aaos-core/development/{type}/{name}`. However, 2 templates and 2 data files exist under `.electron-aaos-core/product/` instead. The `agent-config-requirements.yaml` correctly references the full paths under `.electron-aaos-core/product/data/`, but the agent definition's `dependencies` block uses short names that resolve to `.electron-aaos-core/development/templates/` and `.electron-aaos-core/development/data/` respectively, where these files do not exist. Actual runtime loading uses `agent-config-requirements.yaml` paths, so functionality is preserved.
