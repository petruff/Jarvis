...
Complete guide for developers who want to contribute to the Electron AAOS Electron AAOS project.
...
| Tool                 | Purpose                                 |
| -------------------- | --------------------------------------- |
| **Claude Code**      | AI-powered development with Electron AAOS agents |
| **VS Code / Cursor** | IDE with Electron AAOS integration               |
...
1. Navigate to [github.com/Electron AAOSAI/electron-aaos-core](https://github.com/Electron AAOSAI/electron-aaos-core)
...
Sync Electron AAOS agents to your IDE:
...
Understanding the `electron-aaos-core` directory structure:

```
electron-aaos-core/
├── .electron-aaos-core/                    # Framework source (committed)
...
│   ├── commands/Electron AAOS/agents/      # Agent skill commands
│   ├── hooks/                     # Governance hooks
│   └── rules/                     # AI behavior rules
│
├── bin/                           # CLI entry points
│   ├── electron-aaos.js                    # Main CLI
│   └── electron-aaos-minimal.js            # Minimal CLI
│
...
| ----------------------------------- | ---------------------------- | ----------------------- |
| `.electron-aaos-core/development/agents/`    | Agent personas and behaviors | Adding/modifying agents |
| `.electron-aaos-core/development/tasks/`     | Executable task workflows    | Adding/modifying tasks  |
| `.electron-aaos-core/development/workflows/` | Multi-step orchestrations    | Creating workflows      |
...
Create a new file in `.electron-aaos-core/development/agents/`:

```bash
# File: .electron-aaos-core/development/agents/my-agent.md
```
...
dependencies:
  tasks:
    - my-agent-task.md       # Create in .electron-aaos-core/development/tasks/
  checklists:
    - my-agent-checklist.md  # Create in .electron-aaos-core/development/checklists/
  tools:
    - git
    - context7
````
...
Create a new file in `.electron-aaos-core/development/tasks/`:
...
# Examples:
# .electron-aaos-core/development/tasks/dev-build-component.md  (dev agent)
# .electron-aaos-core/development/tasks/create-doc.md          (shared)
```
...
Create a new file in `.electron-aaos-core/development/workflows/`:

```bash
# File: .electron-aaos-core/development/workflows/my-workflow.yaml
```
...
- Tag `@Electron AAOSAI/core-team` for urgent issues
