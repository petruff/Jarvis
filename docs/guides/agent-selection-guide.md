...
| **@electron-aaos-master** (Orion)     | 👑   | Framework development, multi-agent orchestration                                            | Routine tasks (use specialized agents)   |
...
| `*list-gotchas` | List known gotchas from .electron-aaos/gotchas.md |
