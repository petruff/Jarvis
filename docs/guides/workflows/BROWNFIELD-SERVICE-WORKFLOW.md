...
|---------|-----------|---------|
| Workflow Definition | Definicao YAML do workflow | `.electron-aaos-core/development/workflows/brownfield-service.yaml` |
...
| PO Master Checklist | Checklist de validacao | `.electron-aaos-core/development/checklists/po-master-checklist.md` |
...
- [Technical Preferences](../../../.electron-aaos-core/development/data/technical-preferences.md) - Preferencias tecnicas do projeto
