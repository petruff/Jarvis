...
**Versao:** 1.0
**Criado:** 2026-02-04
**Fonte:** `.electron-aaos-core/development/workflows/greenfield-service.yaml`
...
**Referencia:** `.electron-aaos-core/data/electron-aaos-kb.md#IDE Development Workflow`
...
| Arquivo | Descricao |
|---------|-----------|
| `.electron-aaos-core/core-config.yaml` | Configuracao do framework |
...
|----------|-------------|--------|
| `project-brief-tmpl.yaml` | `.electron-aaos-core/development/templates/` | analyst |
| `prd-tmpl.yaml` | `.electron-aaos-core/development/templates/` | pm |
| `architecture-tmpl.yaml` | `.electron-aaos-core/development/templates/` | architect |
| `story-tmpl.yaml` | `.electron-aaos-core/development/templates/` | sm |
| `qa-gate-tmpl.yaml` | `.electron-aaos-core/development/templates/` | qa |
...
| Tipo | Localizacao |
|------|-------------|
| Logs do agente | `.electron-aaos/logs/agent.log` |
| Status do projeto | `.electron-aaos/project-registry.yaml` |
...
cat .electron-aaos/project-status.yaml

# Listar stories em progresso
ls docs/stories/epic-*/

# Verificar logs do agente
tail -f .electron-aaos/logs/agent.log

# Habilitar modo debug
export Electron AAOS_DEBUG=true
```
...
| Arquivo | Descricao |
|---------|-----------|
| `.electron-aaos-core/development/workflows/greenfield-service.yaml` | Definicao do workflow |
| `.electron-aaos-core/data/electron-aaos-kb.md` | Knowledge base do Electron AAOS |

### Agentes

| Arquivo | Agente |
|---------|--------|
| `.electron-aaos-core/development/agents/analyst.md` | Atlas (Analyst) |
| `.electron-aaos-core/development/agents/pm.md` | Morgan (PM) |
| `.electron-aaos-core/development/agents/architect.md` | Aria (Architect) |
| `.electron-aaos-core/development/agents/po.md` | Pax (PO) |
| `.electron-aaos-core/development/agents/sm.md` | River (SM) |
| `.electron-aaos-core/development/agents/dev.md` | Dex (Dev) |
| `.electron-aaos-core/development/agents/qa.md` | Quinn (QA) |

### Tasks Principais

| Arquivo | Task |
|---------|------|
| `.electron-aaos-core/development/tasks/create-doc.md` | Criacao de documentos |
| `.electron-aaos-core/development/tasks/shard-doc.md` | Fragmentacao de documentos |
| `.electron-aaos-core/development/tasks/sm-create-next-story.md` | Criacao de stories |
| `.electron-aaos-core/development/tasks/dev-develop-story.md` | Implementacao de stories |
| `.electron-aaos-core/development/tasks/qa-review-story.md` | Revisao de implementacao |
| `.electron-aaos-core/development/tasks/execute-checklist.md` | Execucao de checklists |

### Templates

| Arquivo | Template |
|---------|----------|
| `.electron-aaos-core/development/templates/project-brief-tmpl.yaml` | Project Brief |
| `.electron-aaos-core/development/templates/prd-tmpl.yaml` | PRD |
| `.electron-aaos-core/development/templates/architecture-tmpl.yaml` | Arquitetura |
| `.electron-aaos-core/development/templates/story-tmpl.yaml` | User Story |
| `.electron-aaos-core/development/templates/qa-gate-tmpl.yaml` | QA Gate |

### Checklists

| Arquivo | Checklist |
|---------|-----------|
| `.electron-aaos-core/development/checklists/po-master-checklist.md` | Validacao PO |
| `.electron-aaos-core/development/checklists/story-draft-checklist.md` | Validacao Story Draft |
| `.electron-aaos-core/development/checklists/story-dod-checklist.md` | Definition of Done |
...
*Documentacao gerada automaticamente a partir de `.electron-aaos-core/development/workflows/greenfield-service.yaml`*
