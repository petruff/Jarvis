...
> **Arquivo Fonte:** `.electron-aaos-core/development/workflows/brownfield-fullstack.yaml`
...
**Arquivo de Task:** `.electron-aaos-core/development/tasks/document-project.md`
...
**Arquivo de Checklist:** `.electron-aaos-core/product/checklists/po-master-checklist.md`
...
**Arquivo de Task:** `.electron-aaos-core/development/tasks/shard-doc.md`
...
**Arquivos de Task:**
- `.electron-aaos-core/development/tasks/create-next-story.md`
- `.electron-aaos-core/development/tasks/create-brownfield-story.md`
...
- [ ] Core config Electron AAOS configurado (`.electron-aaos-core/core-config.yaml`)
...
| Arquivo | Proposito |
|---------|-----------|
| `.electron-aaos-core/development/workflows/brownfield-fullstack.yaml` | Definicao do workflow |
| `.electron-aaos-core/development/tasks/brownfield-create-story.md` | Task para criar story simples |
| `.electron-aaos-core/development/tasks/brownfield-create-epic.md` | Task para criar epic |
| `.electron-aaos-core/development/tasks/document-project.md` | Task para documentar projeto existente |
| `.electron-aaos-core/development/tasks/shard-doc.md` | Task para fragmentar documentos |
| `.electron-aaos-core/development/tasks/create-brownfield-story.md` | Task para criar story brownfield |
| `.electron-aaos-core/development/tasks/create-next-story.md` | Task para criar story de PRD |
| `.electron-aaos-core/product/checklists/po-master-checklist.md` | Checklist de validacao PO |

### Arquivos de Agentes

| Arquivo | Agente |
|---------|--------|
| `.electron-aaos-core/development/agents/analyst.md` | @analyst (Atlas) |
| `.electron-aaos-core/development/agents/architect.md` | @architect (Aria) |
| `.electron-aaos-core/development/agents/pm.md` | @pm (Morgan) |
| `.electron-aaos-core/development/agents/po.md` | @po (Pax) |
| `.electron-aaos-core/development/agents/sm.md` | @sm (River) |
| `.electron-aaos-core/development/agents/dev.md` | @dev (Dex) |
| `.electron-aaos-core/development/agents/qa.md` | @qa (Quinn) |
...
| `.electron-aaos-core/working-in-the-brownfield.md` | Guia de trabalho brownfield |
