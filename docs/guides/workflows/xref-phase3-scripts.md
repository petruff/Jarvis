...
> **Scope:** `.electron-aaos-core/development/scripts/` (38 files)
...
| 26 | `workflow-validator.js` | Validates workflow YAML files against Electron AAOS conventions (9 checks) | `fs.promises`, `path`, `js-yaml` | 18 files: `validate-workflow.md`, `squad-validator.js`, tasks | @qa, @architect | No |
...
| S6 | `squad-migrator.js` | Migrates legacy squad formats to Electron AAOS 2.1 standard (SQS-7) | `fs.promises`, `path`, `js-yaml` | `index.js`, `squad-creator-migrate.md`, tests | @squad-creator | No |
| S7 | `squad-downloader.js` | Downloads squads from electron-aaos-squads GitHub repository (SQS-6) | `https`, `fs.promises`, `path` | `index.js`, `squad-creator-download.md`, tests | @squad-creator | No |
| S8 | `squad-publisher.js` | Publishes squads to electron-aaos-squads GitHub repo via PR (SQS-6) | `child_process`, `fs.promises`, `path` | `index.js`, `squad-creator-publish.md`, tests | @squad-creator | No |
...
The Electron AAOS greeting system generates contextual, session-aware greetings when agents are activated. It consists of **8 greeting-related files** in the development scripts directory plus supporting infrastructure.
...
| `.electron-aaos-core/product/templates/activation-instructions-inline-greeting.yaml` | Template | ~64 | YAML template for inline greeting logic in agent files |
| `.claude/commands/greet.md` | Slash Command | ~102 | `/greet` slash command definition for Claude Code |

**External copies (in `.claude/commands/Electron AAOS/scripts/`):**
| File | Purpose |
|------|---------|
...
The preference is stored in `.electron-aaos-core/core-config.yaml` under `agentIdentity.greeting.preference`.
...
Used by: @dev, @qa, @architect, @pm, @po, @sm, @analyst, @electron-aaos-master, @squad-creator

```yaml
activation-instructions:
  - STEP 3: |
      Build intelligent greeting using .electron-aaos-core/development/scripts/greeting-builder.js
...
| @electron-aaos-master | `\U0001f9e0` | Orchestrator | Leo | "Electron AAOS Master Orchestrator ready!" |
...
```
greeting-builder.js
  |-- context-detector.js          (.electron-aaos-core/core/session/)
  |-- git-config-detector.js       (.electron-aaos-core/infrastructure/scripts/)
  |-- workflow-navigator.js        (sibling in development/scripts/)
  |-- greeting-preference-manager.js (sibling)
  |-- project-status-loader.js     (.electron-aaos-core/infrastructure/scripts/)
  |-- PermissionMode               (.electron-aaos-core/core/permissions/)
  |-- js-yaml
  |-- fs, path

generate-greeting.js
  |-- greeting-builder.js          (sibling)
  |-- session-context-loader.js    (.electron-aaos-core/scripts/)
  |-- project-status-loader.js     (.electron-aaos-core/infrastructure/scripts/)
...
| @electron-aaos-master | greeting-builder, agent-config-loader | 2 |
...
```
C:\Users\AllFluence-User\Workspaces\Electron AAOS\Electron AAOSAI\electron-aaos-core\.electron-aaos-core\development\scripts\
```

Full absolute paths for top-level scripts:
```
.electron-aaos-core/development/scripts/agent-assignment-resolver.js
.electron-aaos-core/development/scripts/agent-config-loader.js
.electron-aaos-core/development/scripts/agent-exit-hooks.js
.electron-aaos-core/development/scripts/apply-inline-greeting-all-agents.js
.electron-aaos-core/development/scripts/audit-agent-config.js
.electron-aaos-core/development/scripts/backlog-manager.js
.electron-aaos-core/development/scripts/batch-update-agents-session-context.js
.electron-aaos-core/development/scripts/decision-context.js
.electron-aaos-core/development/scripts/decision-log-generator.js
.electron-aaos-core/development/scripts/decision-log-indexer.js
.electron-aaos-core/development/scripts/decision-recorder.js
.electron-aaos-core/development/scripts/dev-context-loader.js
.electron-aaos-core/development/scripts/generate-greeting.js
.electron-aaos-core/development/scripts/greeting-builder.js
.electron-aaos-core/development/scripts/greeting-config-cli.js
.electron-aaos-core/development/scripts/greeting-preference-manager.js
.electron-aaos-core/development/scripts/migrate-task-to-v2.js
.electron-aaos-core/development/scripts/story-index-generator.js
.electron-aaos-core/development/scripts/story-manager.js
.electron-aaos-core/development/scripts/story-update-hook.js
.electron-aaos-core/development/scripts/task-identifier-resolver.js
.electron-aaos-core/development/scripts/test-greeting-system.js
.electron-aaos-core/development/scripts/validate-task-v2.js
.electron-aaos-core/development/scripts/verify-workflow-gaps.js
.electron-aaos-core/development/scripts/workflow-navigator.js
.electron-aaos-core/development/scripts/workflow-state-manager.js
.electron-aaos-core/development/scripts/workflow-validator.js
```
...
*Cross-Reference Phase 3 Analysis - Electron AAOS Framework*
*Generated: 2026-02-05*
