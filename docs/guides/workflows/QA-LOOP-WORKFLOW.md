...
**Localizacao:** `.electron-aaos-core/development/tasks/qa-review-story.md`
...
**Localizacao:** `.electron-aaos-core/development/tasks/qa-create-fix-request.md`
...
**Localizacao:** `.electron-aaos-core/development/tasks/dev-apply-qa-fixes.md`
