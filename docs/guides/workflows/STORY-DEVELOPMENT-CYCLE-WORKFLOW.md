...
**Autor:** Orion (Electron AAOS Master)
...
O **Story Development Cycle** e o workflow central do Electron AAOS para desenvolvimento de stories. Ele automatiza o fluxo completo desde a criacao ate a entrega com quality gate integrado, seguindo a sequencia: **criar -> validar -> implementar -> QA review**.
...
1. **core-config.yaml** - Arquivo de configuracao Electron AAOS obrigatorio
...
2. **Story Template** - `story-tmpl.yaml` disponivel em `.electron-aaos-core/development/templates/`
...
| Story template | YAML | `.electron-aaos-core/development/templates/` | Template padrao |
...
| Arquivo | Caminho |
|---------|---------|
| Workflow Definition | `.electron-aaos-core/development/workflows/story-development-cycle.yaml` |
| SM Agent | `.electron-aaos-core/development/agents/sm.md` |
| PO Agent | `.electron-aaos-core/development/agents/po.md` |
| Dev Agent | `.electron-aaos-core/development/agents/dev.md` |
| QA Agent | `.electron-aaos-core/development/agents/qa.md` |
| Create Story Task | `.electron-aaos-core/development/tasks/create-next-story.md` |
| Validate Story Task | `.electron-aaos-core/development/tasks/validate-next-story.md` |
| Develop Story Task | `.electron-aaos-core/development/tasks/dev-develop-story.md` |
| QA Gate Task | `.electron-aaos-core/development/tasks/qa-gate.md` |
| Story Template | `.electron-aaos-core/development/templates/story-tmpl.yaml` |
