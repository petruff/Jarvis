...
| **Templates Electron AAOS** | Templates instalados | Verificar `.electron-aaos-core/development/templates/` |
| **Agentes Configurados** | Todos os agentes do workflow | Verificar `.electron-aaos-core/development/agents/` |
...
|-----------|-------------|-----------------|
| Templates de PRD | `.electron-aaos-core/development/templates/brownfield-prd-tmpl.yaml` | Step 2 |
| Template Frontend | `.electron-aaos-core/development/templates/front-end-spec-tmpl.yaml` | Step 3 |
| Template Arquitetura | `.electron-aaos-core/development/templates/brownfield-architecture-tmpl.yaml` | Step 4 |
| Checklist PO | `.electron-aaos-core/development/checklists/po-master-checklist.md` | Step 5 |
| Template Story | `.electron-aaos-core/development/templates/story-tmpl.yaml` | Step 8 |
...
```bash
ls .electron-aaos-core/development/templates/
```

2. Verificar nome correto do template no workflow
3. Se necessario, reinstalar templates do Electron AAOS core
...
|-----------|-------------|-----------|
| Electron AAOS Knowledge Base | `.electron-aaos-core/data/electron-aaos-kb.md` | Base de conhecimento Electron AAOS |
| IDE Development Workflow | `.electron-aaos-core/data/electron-aaos-kb.md#IDE Development Workflow` | Workflow de desenvolvimento IDE |
| Brownfield PRD Template | `.electron-aaos-core/development/templates/brownfield-prd-tmpl.yaml` | Template PRD brownfield |
| Frontend Spec Template | `.electron-aaos-core/development/templates/front-end-spec-tmpl.yaml` | Template especificacao frontend |
| Brownfield Architecture Template | `.electron-aaos-core/development/templates/brownfield-architecture-tmpl.yaml` | Template arquitetura brownfield |
| PO Master Checklist | `.electron-aaos-core/development/checklists/po-master-checklist.md` | Checklist de validacao PO |

### Agentes

| Agente | Arquivo | Documentacao |
|--------|---------|--------------|
| @architect | `.electron-aaos-core/development/agents/architect.md` | Aria - Holistic System Architect |
| @pm | `.electron-aaos-core/development/agents/pm.md` | Morgan - Product Manager |
| @ux-expert | `.electron-aaos-core/development/agents/ux-design-expert.md` | Uma - UX/UI Designer |
| @po | `.electron-aaos-core/development/agents/po.md` | Pax - Product Owner |
| @sm | `.electron-aaos-core/development/agents/sm.md` | River - Scrum Master |
| @analyst | `.electron-aaos-core/development/agents/analyst.md` | Atlas - Business Analyst |
| @dev | `.electron-aaos-core/development/agents/dev.md` | Dex - Full Stack Developer |
| @qa | `.electron-aaos-core/development/agents/qa.md` | Quinn - Test Architect |
...
*Documentacao gerada automaticamente a partir de `.electron-aaos-core/development/workflows/brownfield-ui.yaml`*
