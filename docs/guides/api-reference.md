# Electron AAOS API Reference

> **EN** | [PT](../pt/guides/api-reference.md) | [ES](../es/guides/api-reference.md)

---

Complete API reference for Electron AAOS Electron AAOS - the AI-Orchestrated System for Full Stack Development.
...
Electron AAOS provides a unified API for interacting with specialized AI agents through two primary mechanisms:
...
| `@electron-aaos-master`   | Orion  | Orchestrator | Framework orchestration, meta-operations |

### Activation Behavior

When an agent is activated:

1. Agent definition file is loaded from `.electron-aaos-core/development/agents/{id}.md`
...
| Command                | Arguments       | Description                                 |
| ---------------------- | --------------- | ------------------------------------------- |
| `*create`              | `{type} {name}` | Create Electron AAOS component (agent/task/workflow) |
...
| `*kb`   | -                          | Toggle KB mode (Electron AAOS Method knowledge) |
...
| -------------------- | ------------------------------- | -------------------------------------- |
| `AGENT_NOT_FOUND`    | Agent definition missing        | Check `.electron-aaos-core/development/agents/` |
...
/electron-aaos-master  → Activates @electron-aaos-master agent
```
...
- [User Guide](./user-guide.md) - Getting started with Electron AAOS
...
- [Squads Guide](./squads-guide.md) - Extending Electron AAOS with squads
