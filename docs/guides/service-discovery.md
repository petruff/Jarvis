# Electron AAOS Service Discovery Guide

> **EN** | [PT](../pt/guides/service-discovery.md) | [ES](../es/guides/service-discovery.md)

---

> How to discover, query, and use workers in the Electron AAOS framework.
...
The Service Discovery system enables finding and using workers (tasks, templates, scripts, workflows) across the Electron AAOS framework. The **Service Registry** is the central catalog containing metadata about all available workers.
...
**Location:** `.electron-aaos-core/infrastructure/scripts/`
...
_Electron AAOS Electron AAOS v2.1 Service Discovery Guide_
