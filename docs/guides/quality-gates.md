# Electron AAOS Quality Gate System Guide

> **EN** | [PT](../pt/guides/quality-gates.md) | [ES](../es/guides/quality-gates.md)

---

> Comprehensive guide to the 3-layer quality gate system for Electron AAOS Electron AAOS.
...
The Electron AAOS Quality Gate System provides automated quality assurance through three progressive layers of validation. Each layer catches different types of issues at the appropriate stage of development.
...
# Run with options
electron-aaos qa run --verbose          # Detailed output
electron-aaos qa run --fail-fast        # Stop on first failure
electron-aaos qa run --continue-on-fail # Continue despite failures
```
...
_Electron AAOS Electron AAOS v2.1 Quality Gate System Guide_
