...
## Electron AAOS Integration Overview

In Electron AAOS, CodeRabbit is integrated into the Quality Gates system as part of **Layer 2: PR Automation**.
...
### Electron AAOS Agent Configuration

CodeRabbit is configured in agent definition files:

**Location:** `.electron-aaos-core/development/agents/qa.md` and `devops.md`
...
coderabbit_integration:
  ...
  wsl_config:
    ...
    working_directory: /mnt/c/Users/.../electron-aaos-core
```
...
wsl bash -c 'cd /mnt/c/.../electron-aaos-core && ~/.local/bin/coderabbit --prompt-only -t uncommitted'
```
...
# Direct command
wsl bash -c 'cd /mnt/c/.../electron-aaos-core && ~/.local/bin/coderabbit --prompt-only -t committed --base main'
```
...
# Direct command
wsl bash -c 'cd /mnt/c/.../electron-aaos-core && ~/.local/bin/coderabbit --prompt-only --base main'
```
...
| Severity     | Description                               | Electron AAOS Action                      |
| ------------ | ----------------------------------------- | -------------------------------- |
...
## Integration with Electron AAOS Workflow
...
- [Quality Gates Specification](../../../.electron-aaos-core/docs/standards/QUALITY-GATES-SPECIFICATION.md)
- [@qa Agent Definition](../../../.electron-aaos-core/development/agents/qa.md)
- [@devops Agent Definition](../../../.electron-aaos-core/development/agents/devops.md)
- [Pre-Push Quality Gate Task](../../../.electron-aaos-core/development/tasks/github-devops-pre-push-quality-gate.md)
