# Electron AAOS Electron AAOS Testing Guide

> **EN** | [PT](../pt/guides/testing-guide.md) | [ES](../es/guides/testing-guide.md)

---

> Comprehensive guide to the testing strategy, tools, and best practices for Electron AAOS Electron AAOS.
...
Electron AAOS follows a comprehensive testing strategy that ensures code quality across all layers of the framework. Our testing philosophy is built on:
 ...
 * Agent Backward Compatibility Tests
 *
 * Ensures agents from previous Electron AAOS versions continue to work.
 */
...
Electron AAOS supports Windows, macOS, and Linux. Cross-platform testing ensures consistent behavior.
...
│   ├── index.html        # Overview
│   └── .electron-aaos-core/       # Per-module coverage
...
The Electron AAOS Quality Gate System (see [Quality Gates Guide](./quality-gates.md)) integrates testing at multiple layers:
...
_Electron AAOS Electron AAOS v2.1 Testing Guide_
