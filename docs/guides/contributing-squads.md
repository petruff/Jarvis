...
How to contribute squads to the Electron AAOS ecosystem.

## Overview

There are two ways to share your squad with the community:

1. **electron-aaos-squads Repository** - Free, open-source squads on GitHub
2. **Electron AAOS Marketplace** - Premium squads via Electron AAOS API
...
| **Electron AAOS compatibility** | `electron-aaos.minVersion: "2.1.0"` or higher |
...
## Publishing to electron-aaos-squads
...
This will:
1. Fork `Electron AAOSAI/electron-aaos-squads` (if needed)
...
## Publishing to Electron AAOS Marketplace

### Prerequisites

1. Electron AAOS account
...
- Follow Electron AAOS conventions
...
- **Questions**: [GitHub Discussions](https://github.com/Electron AAOSAI/electron-aaos-core/discussions)
