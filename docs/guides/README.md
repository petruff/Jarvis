# Electron AAOS Guides

> **EN** | [PT](../pt/guides/README.md) | [ES](../es/guides/README.md)

---

Complete documentation index for Electron AAOS system guides.
...
> **Note:** 1MCP documentation has been deprecated. Electron AAOS now uses Docker MCP Toolkit exclusively (Story 5.11). Archived docs available in `.github/deprecated-docs/guides/`.
