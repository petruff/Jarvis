...
entities:
  tasks:
    create-story:
      path: ".electron-aaos-core/development/tasks/create-story.md"
      type: "task"
...
electron-aaos ids:query "deploy automático"
...
# Backup do registry
electron-aaos ids:backup

# Forçar sync completo
electron-aaos ids:sync
```
