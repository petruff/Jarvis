...
### Configuration
- `.electron-aaos-core/core-config.yaml` - Configuração global (git + agentIdentity sections)

### Agents (Updated)
- `.electron-aaos-core/agents/dev.md` - ✅ Command visibility metadata
- `.electron-aaos-core/agents/po.md` - ✅ Command visibility metadata
- `.electron-aaos-core/agents/*.md` - ⏳ Remaining 9 agents (pending update)
...
A: Use o script de teste: `node .electron-aaos-core/development/scripts/test-greeting-system.js`
