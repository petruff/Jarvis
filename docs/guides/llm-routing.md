...
**Option 1: If you have electron-aaos-core cloned**
```bash
# From electron-aaos-core directory
...
- **Tool Definition:** `.electron-aaos-core/infrastructure/tools/cli/llm-routing.yaml`
- **Install Script:** `.electron-aaos-core/infrastructure/scripts/llm-routing/install-llm-routing.js`
- **Task Definition:** `.electron-aaos-core/development/tasks/setup-llm-routing.md`
...
*Generated by Electron AAOS Framework - Story 6.7*
