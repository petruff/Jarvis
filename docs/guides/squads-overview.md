...
Introduction to Electron AAOS Squads - modular teams of AI agents that extend framework functionality.
...
Squads are modular teams of AI agents that extend Electron AAOS functionality for specific domains or use cases. Each squad is a self-contained package that can be installed, shared, and composed with other squads.

> **Electron AAOS Squads:** AI agent teams working with you
...
| Traditional Agents   | Electron AAOS Squads                |
| -------------------- | -------------------------- |
...
| ----------------- | ------- | ---------------------------------- | -------------------------------------------------------------------------------- |
| **etl-squad**     | 2.0.0   | Data collection and transformation | [electron-aaos-squads/etl](https://github.com/Electron AAOSAI/electron-aaos-squads/tree/main/etl)         |
| **creator-squad** | 1.0.0   | Content generation utilities       | [electron-aaos-squads/creator](https://github.com/Electron AAOSAI/electron-aaos-squads/tree/main/creator) |
...
│  Level 2: Electron AAOS-SQUADS  --> github.com/Electron AAOSAI (Public)     │
...
- **Explore Official Squads:** Check [electron-aaos-squads repository](https://github.com/Electron AAOSAI/electron-aaos-squads)
- **Contribute:** See [Contributing Squads Guide](./contributing-squads.md)
- **Learn Task Format:** Read [TASK-FORMAT-SPECIFICATION-V1](../../.electron-aaos-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md)
...
- [Task Format Specification](../../.electron-aaos-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md)
...
_Electron AAOS Squads: AI agent teams working with you_
