...
> Control how much autonomy Electron AAOS agents have over your system.

---

## Overview

Permission Modes let you control the level of autonomy Electron AAOS agents have. Whether you're exploring a new codebase or running fully autonomous builds, there's a mode for your workflow.
...
Mode is persisted in `.electron-aaos/config.yaml`:
...
Check `.electron-aaos/config.yaml` exists and is writable:
