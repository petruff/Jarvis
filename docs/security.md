...
We take security seriously at Electron AAOSAI. If you discover a security vulnerability in Electron AAOS, please report it responsibly.
...
1. **GitHub Security Advisories** (Preferred)
   - Go to [Security Advisories](https://github.com/Electron AAOSAI/electron-aaos-core/security/advisories)
   - Click "Report a vulnerability"
   - Fill out the form with details

2. **Email**
   - Send an email to: security@electron-aaos.ai
...
When using Electron AAOS Framework, we recommend:
...
Electron AAOS Framework executes AI-generated code and commands. Users should:
...
- Electron AAOS may process sensitive data through AI providers
