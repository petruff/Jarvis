# Contribuindo para o Electron AAOS Electron AAOS

> **[English Version](CONTRIBUTING.md)**

Bem-vindo ao Electron AAOS! Obrigado pelo seu interesse em contribuir. Este guia vai ajuda-lo a entender nosso fluxo de trabalho, processo de contribuicao e como submeter suas alteracoes.
...
git clone https://github.com/SEU_USUARIO/electron-aaos-core.git
...
```
.electron-aaos-core/development/agents/seu-agent.md
```
...
```
.electron-aaos-core/development/tasks/sua-task.md
```
...
- [Discussoes de Squads](https://github.com/Electron AAOSAI/electron-aaos-core/discussions/categories/ideas) - Compartilhe ideias
...
- Padroes especificos do Electron AAOS (agents, tasks, workflows)
...
Electron AAOS implementa uma estrategia de **Defesa em Profundidade** com 3 camadas de validacao:
...
- **GitHub Issues:** [Abra uma issue](https://github.com/Electron AAOSAI/electron-aaos-core/issues)
- **Discussoes:** [Inicie uma discussao](https://github.com/Electron AAOSAI/electron-aaos-core/discussions)
...
**Obrigado por contribuir para o Electron AAOS Electron AAOS!**
