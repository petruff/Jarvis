...
**@docs (Ajax)** e um agente de IA especializado em criar **documentacao educacional** para o Electron AAOS. Diferente da documentacao tecnica (JSDoc/Typedoc), Ajax foca em **tutoriais, guias de onboarding, explicadores visuais e materiais de treinamento para parceiros**.
...
whenToUse: |
  ...
  - Tutoriais explicando como usar recursos do Electron AAOS
...
Checklist:
  ...
  acceptance-criteria:
    ...
    - check: "Usa estilo consistente (paleta de cores Electron AAOS)"
      blocker: false
...
whenToUse: |
  ...
  - Novo parceiro entra no ecossistema Electron AAOS
...
Checklist:
  ...
  acceptance-criteria:
    ...
    - check: "Links para documentacao Electron AAOS relevante"
      blocker: false
...
[Nome do Agente] e o agente de [funcao] do Electron AAOS, especializado em [expertise principal].
...
**Notas do Template:**
- Use paleta de cores Electron AAOS (Azul primario, Roxo secundario, Rosa terciario)
...
```bash
#!/bin/bash
# Hook de Auto-Atualizacao @docs do Electron AAOS
...
- [ ] Criar `expansion-packs/electron-aaos/agents/docs/agent.yaml`
...
- [ ] **Reconhecimento da Industria:** Docs do Electron AAOS citados como "melhor no espaco de agentes de IA"
...
Com a adicao do @docs (Ajax), Electron AAOS agora tem **13 agentes nomeados**:
...
| 13 | @electron-aaos-master | Orion | Commander | Aries | Cyan |
