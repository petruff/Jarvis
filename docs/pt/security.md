...
Levamos a segurança a sério na Electron AAOSAI. Se você descobrir uma vulnerabilidade de segurança no Electron AAOS, por favor reporte de forma responsável.
...
1. **GitHub Security Advisories** (Preferido)
   - Vá para [Security Advisories](https://github.com/Electron AAOSAI/electron-aaos-core/security/advisories)
   - Clique em "Report a vulnerability"
   - Preencha o formulário com detalhes

2. **Email**
   - Envie um email para: security@electron-aaos.ai
...
Ao usar o Electron AAOS Framework, recomendamos:
...
O Electron AAOS Framework executa código e comandos gerados por IA. Usuários devem:
...
- Electron AAOS pode processar dados sensíveis através de provedores de IA
...
- [GitHub Security Advisories](https://github.com/Electron AAOSAI/electron-aaos-core/security/advisories)
