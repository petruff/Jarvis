# Guia Electron AAOS para Cursor
...
### Por que usar Electron AAOS com Cursor?

O Cursor é uma das **IDEs com IA mais populares** com excelente integração Electron AAOS:
...
Verifique se os arquivos Electron AAOS foram criados:
...
- Integração do framework Electron AAOS
...
### Iniciando o Cursor com Electron AAOS
...
| `@docs`        | Documentação                 |
| `@web`         | Busca web                    |
| `@nome-agente` | Agente Electron AAOS                  |
...
R: Execute `npm run sync:agents` após atualizações do Electron AAOS.
...
2. Inicialize Electron AAOS para Claude Code:
...
2. Inicialize Electron AAOS para Windsurf:
...
- [Guia de Integração Electron AAOS](../README.md)

---

_Electron AAOS Electron AAOS - Guia da Plataforma Cursor v1.0_
