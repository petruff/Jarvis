# Guia Electron AAOS para AntiGravity
...
### Por que usar Electron AAOS com AntiGravity?
...
```markdown
# Regras Electron AAOS Electron AAOS para AntiGravity
...
1. Seus agentes em `.electron-aaos-core/` são portáveis
...
1. Agentes Electron AAOS permanecem em `.electron-aaos-core/`
...
*Electron AAOS Electron AAOS - Guia da Plataforma AntiGravity v1.0*
