...
**Aviso de Migração:** Este documento migrará para o repositório `Electron AAOSAI/electron-aaos-core` em Q2 2026 (veja Decision 005)
...
O Electron AAOS é construído com JavaScript/TypeScript moderno com runtime Node.js, otimizado para desenvolvimento de CLI multiplataforma com UX interativa e capacidades de orquestração de agentes.
...
O Electron AAOS integra com servidores Model Context Protocol (MCP):
...
Electron AAOS_DEBUG=true                    # Enable debug logging
Electron AAOS_CONFIG_PATH=/custom/path      # Custom config location
Electron AAOS_YOLO_MODE=true               # Force yolo mode
