...
# Documentação do Framework Electron AAOS
...
**Destino de Migração:** Q2 2026 → repositório `Electron AAOSAI/electron-aaos-core`

---

## Visão Geral

Este diretório contém **documentação oficial do framework Electron AAOS** que define padrões, patterns e estruturas aplicáveis em todos os projetos Electron AAOS (greenfield e brownfield).
...
**IMPORTANTE**: Estes documentos agora estão no repositório `Electron AAOSAI/electron-aaos-core`. A migração do antigo org `electron-aaos/electron-aaos-core` foi concluída em dezembro de 2024 como parte do OSR-9 (Rebranding).

### Cronograma de Migração

- **Fase 1 (Q1 2026 - Story 6.1.2.6):** Docs do framework separados em `docs/framework/`
- **Fase 2 (Q4 2024):** Repositório migrado para `Electron AAOSAI/electron-aaos-core` (OSR-9)
...
- **Escopo**: Portável entre todos os projetos Electron AAOS
- **Exemplos**: Padrões de código, tech stack, estrutura de source tree
- **Ciclo de vida**: Vive no repositório `Electron AAOSAI/electron-aaos-core`
...
1. **Leia os docs do framework durante o onboarding** - Entenda os padrões Electron AAOS
...
### Para Mantenedores do Framework Electron AAOS
...
**Mantenedor**: Equipe do Framework Electron AAOS
