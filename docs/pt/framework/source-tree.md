...
# Estrutura do Source Tree Electron AAOS
...
**Repositório:** Electron AAOSAI/electron-aaos-core
...
O Electron AAOS usa uma **arquitetura modular** com clara separação de responsabilidades:

1. **Framework Core** (`.electron-aaos-core/`) - Componentes portáveis do framework organizados por domínio
...
│   └── electron-aaos-kb.md                     # Base de conhecimento Electron AAOS
│
├── development/                       # Assets de Desenvolvimento
│   ├── agents/                        # Definições de agentes (11 agentes core)
│   │   ├── electron-aaos-master.md             # Orquestrador master
...
│   ├── electron-aaos migration/                # Stories de migração Electron AAOS
│   │   ├── story-6.1.2.1.md
│   │   ├── story-6.1.2.2.md
│   │   ├── story-6.1.2.3.md
│   │   ├── story-6.1.2.4.md
...
Squads são extensões modulares que adicionam capacidades especializadas ao Electron AAOS. Diferente dos Squads deprecados, Squads seguem uma estrutura de template padronizada.
...
```
squads/
├── verified/                          # Squads curados pelo Electron AAOS
│   ├── github-devops/
│   ├── db-sage/
│   └── coderabbit-workflow/
│
...
| 1.1    | 2025-12-14 | Atualizado org para Electron AAOSAI, substituído Squads pelo sistema Squads [Story 6.10]                                       | Dex (dev)        |
...
_Este é um padrão oficial do framework Electron AAOS. Todo posicionamento de arquivos deve seguir esta estrutura._
