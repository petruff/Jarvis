# Roadmap do Electron AAOS

> 🇺🇸 [English Version](ROADMAP.md)

Este documento descreve a direção de desenvolvimento planejada para o Electron AAOS.

> Para rastreamento detalhado, veja nosso [Projeto GitHub](https://github.com/orgs/Electron AAOSAI/projects/1)

## Visão

O Electron AAOS visa ser o framework de agentes IA open-source mais abrangente, permitindo que desenvolvedores construam aplicações sofisticadas com equipes de agentes especializados (Squads) e integração perfeita com IDEs.
...
Reaja com :+1: em [Ideias nas Discussões](https://github.com/Electron AAOSAI/electron-aaos-core/discussions/categories/ideas) existentes para mostrar apoio.

### 2. Proponha Features

Tem uma nova ideia? Abra uma [Discussão de Ideia](https://github.com/Electron AAOSAI/electron-aaos-core/discussions/new?category=ideas) para compartilhar com a comunidade.
...
5. Comunicar mudanças significativas via [Anúncios](https://github.com/Electron AAOSAI/electron-aaos-core/discussions/categories/announcements)
...
|-----------------|---------------------|
| [Projeto GitHub](https://github.com/orgs/Electron AAOSAI/projects/1) | `docs/stories/backlog.md` |
