...
**Propósito:** Definir padrões para integração de scripts utilitários no framework Electron AAOS

---

## O que é Integração de Utilitários?

**Definição:** Integração de utilitários é o processo de tornar um script utilitário órfão **descobrível, documentado e utilizável** dentro do framework Electron AAOS.
...
- `.electron-aaos-core/agents/{agent}.yaml` (adicionar a dependencies.utils)
- `.electron-aaos-core/core-config.yaml` (registrar se necessário)
- `.electron-aaos-core/utils/README.md` (documentar utilitário)
...
**Arquivos Modificados:**
- `.electron-aaos-core/tasks/{task}.md` (adicionar execution.utils)
- `.electron-aaos-core/agents/{agent}.yaml` (adicionar task à lista executes)
- `.electron-aaos-core/core-config.yaml` (registrar se necessário)
- `.electron-aaos-core/utils/README.md` (documentar utilitário)
...
**Arquivos Modificados:**
- `.electron-aaos-core/core-config.yaml` (registrar em framework)
- `.electron-aaos-core/utils/README.md` (documentar como utilitário de framework)
...
- `.electron-aaos-core/tasks/{task}.md` (se criar task)
- `.electron-aaos-core/core-config.yaml`
...
**Exemplos:** electron-aaos-validator, code-quality-improver, coverage-analyzer
...
**Localização:** `.electron-aaos-core/utils/{name}.js`
