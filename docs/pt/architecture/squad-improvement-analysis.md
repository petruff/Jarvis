...
| **Ícone** | 🏗️ |
| **Arquivo** | `.electron-aaos-core/development/agents/squad-creator.md` |
...
| `*publish-squad` | squad-creator-publish.md | ⏳ Placeholder | Publicar no electron-aaos-squads |
| `*sync-squad-electron-aaos` | squad-creator-sync-electron-aaos.md | ⏳ Placeholder | Sincronizar com marketplace |
...
| SquadPublisher | squad-publisher.js | Publicar no electron-aaos-squads |
