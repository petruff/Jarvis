# Electron AAOS Architecture Documentation Index
...
This index provides navigation to all architecture documentation for Electron AAOS v2.1.
...
|----------|-------------|--------|
| [High-Level Architecture](./high-level-architecture.md) | Overview of Electron AAOS v2.1 architecture | ✅ Current |
...
```
┌─────────────────────────────────────────────────────────────────────────┐
│                     Electron AAOS v2.1 ARCHITECTURE                              │
│                                                                         │
│   ┌─────────────────────────────────────────────────────────────────┐   │
│   │                    MULTI-REPO STRUCTURE                          │   │
│   │                                                                  │   │
│   │   Electron AAOSAI/electron-aaos-core ◄───── Central Hub                       │   │
│   │          │                    - Framework core                   │   │
│   │          │                    - 11 base agents                   │   │
│   │          │                    - Discussions hub                  │   │
│   │          │                                                       │   │
...
│   │   │              │                                               │   │
│   │   ▼              ▼                                               │   │
│   │ electron-aaos-squads   mcp-ecosystem                                      │   │
│   │ (MIT)         (Apache 2.0)                                       │   │
│   └─────────────────────────────────────────────────────────────────┘   │
│                                                                         │
│   ┌─────────────────────────────────────────────────────────────────┐   │
