...
Este documento consolida as descobertas de pesquisa sobre melhores práticas para workflows de contribuidores externos em projetos open source, especificamente para habilitar contribuições seguras da comunidade para agentes e tarefas do Electron AAOS.
...
### 2.3 Recomendações Específicas para Electron AAOS
...
### 3.3 Estrutura Específica do Electron AAOS
...
## 7. Recomendações para Electron AAOS
...
1. **Criar `.coderabbit.yaml`** com instruções de path específicas do Electron AAOS
