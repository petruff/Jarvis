...
| -------------------- | -------------------------------------------------------- | ----------- | ------ |
| asset-inventory.js   | `.electron-aaos-core/infrastructure/scripts/asset-inventory.js`   | JS Script   | ✅     |
| path-analyzer.js     | `.electron-aaos-core/infrastructure/scripts/path-analyzer.js`     | JS Script   | ✅     |
| migrate-agent.js     | `.electron-aaos-core/infrastructure/scripts/migrate-agent.js`     | JS Script   | ✅     |
| agent-v3-schema.json | `.electron-aaos-core/infrastructure/schemas/agent-v3-schema.json` | JSON Schema | ✅     |
| task-v3-schema.json  | `.electron-aaos-core/infrastructure/schemas/task-v3-schema.json`  | JSON Schema | ✅     |
...
- **Todos os agents** sincronizados em `.claude/commands/Electron AAOS/agents/`
