...
**Fonte:** `gh api repos/Electron AAOSAI/electron-aaos-core/branches/main/protection`
...
**Fonte:** `gh api repos/Electron AAOSAI/electron-aaos-core`
...
**Fonte:** `gh api repos/Electron AAOSAI/electron-aaos-core/actions/workflows`
...
1. Criar `.coderabbit.yaml` com regras específicas do Electron AAOS
