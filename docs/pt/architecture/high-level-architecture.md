...
# Arquitetura de Alto Nível do Electron AAOS v2.1
...
**Electron AAOS (AI Operating System)** é um framework sofisticado para orquestração de agentes de IA, workers e humanos em fluxos de trabalho complexos de desenvolvimento de software. A versão 2.1 introduz uma arquitetura modular com 4 módulos, estratégia multi-repositório e quality gates de 3 camadas.
...
```
┌─────────────────────────────────────────────────────────────────────────┐
│                     FRAMEWORK Electron AAOS v2.1                                 │
│                     ═══════════════════                                 │
│                                                                         │
│   ┌─────────────────────────────────────────────────────────────────┐   │
│   │                        CLI / FERRAMENTAS                        │   │
│   │  (electron-aaos agents, electron-aaos tasks, electron-aaos squads, electron-aaos workflow)          │   │
│   └─────────────────────────────────────────────────────────────────┘   │
│                                │                                        │
│          ┌────────────────────┼────────────────────┐                   │
│          │                    │                    │                   │
...
| --------------------- | ----------- | -------------- |
| `@electron-aaos/core`          | npm público | Commons Clause |
| `@electron-aaos/squad-etl`     | npm público | MIT            |
| `@electron-aaos/squad-creator` | npm público | MIT            |
| `@electron-aaos/squad-mmos`    | npm público | MIT            |
| `@electron-aaos/mcp-presets`   | npm público | Apache 2.0     |
...
```
@electron-aaos/electron-aaos-core/
├── .electron-aaos-core/                    # Camada do Framework
...
| ------------------ | ---------------------------- | --------------------- | ------------------------------------ |
| **Core**           | `.electron-aaos-core/core/`           | Fundação do framework | Config, Registry, QG, MCP, Session   |
| **Development**    | `.electron-aaos-core/development/`    | Artefatos de dev      | Agentes, Tarefas, Workflows, Scripts |
| **Product**        | `.electron-aaos-core/product/`        | Artefatos PM          | Templates, Checklists, Dados         |
| **Infrastructure** | `.electron-aaos-core/infrastructure/` | Config do sistema     | Scripts, Ferramentas, Integrações    |
...
| Pax    | `electron-aaos-master`   | Orchestrator | Orquestração do framework |
...
- [Electron AAOS-LIVRO-DE-OURO-V2.1-COMPLETE.md](../../../.electron-aaos-core/docs/standards/Electron AAOS-LIVRO-DE-OURO-V2.1-COMPLETE.md) - Guia completo do framework
