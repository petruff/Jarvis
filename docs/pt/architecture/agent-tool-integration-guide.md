...
Este guia explica como ferramentas são integradas com agentes Electron AAOS. Ferramentas estendem as capacidades dos agentes fornecendo acesso a serviços externos, APIs e recursos do sistema.
...
| `tasks`        | Arquivos de workflow de tarefas     | `.electron-aaos-core/development/tasks/`    |
| `checklists`   | Checklists de validação             | `.electron-aaos-core/product/checklists/`   |

### Exemplo de Declaração

```yaml
# Do arquivo .electron-aaos-core/development/agents/dev.md
dependencies:
  checklists:
...
Electron AAOS implementa governança rigorosa de operações git:
...
- [Definições de Agentes](../../../.electron-aaos-core/development/agents/)
