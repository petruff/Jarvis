...
```
.electron-aaos-core/development/agents/squad-creator.md  # Adicionar novos comandos
.electron-aaos-core/schemas/squad-schema.json            # (sem alterações necessárias)
```
