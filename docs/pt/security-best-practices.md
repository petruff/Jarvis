...
# Melhores Práticas de Segurança do Electron AAOS Electron AAOS

> 🌐 [EN](../security-best-practices.md) | **PT** | [ES](../es/security-best-practices.md)

---

Este guia fornece recomendações abrangentes de segurança para implantação e manutenção do Electron AAOS Electron AAOS em ambientes de produção.
...
O Electron AAOS Electron AAOS implementa uma abordagem de segurança em múltiplas camadas:
...
AUDIT_LOG_FILE=/var/log/electron-aaos/audit.log
```
...
chmod 600 .env
chmod 600 .electron-aaos/config.json
chmod 600 .electron-aaos/users.json
chmod 600 .electron-aaos/sessions.json
...
Para dúvidas ou preocupações de segurança, contate: security@electron-aaos/electron-aaos-core.dev
