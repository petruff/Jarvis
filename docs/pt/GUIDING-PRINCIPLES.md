...
# Princípios Orientadores do Método Electron AAOS

> 🌐 [EN](../GUIDING-PRINCIPLES.md) | **PT** | [ES](../es/GUIDING-PRINCIPLES.md)

---

O Método Electron AAOS é um framework em linguagem natural para desenvolvimento de software assistido por IA. Estes princípios garantem que as contribuições mantenham a efetividade do método.
...
Templates seguem a especificação do [Electron AAOS Document Template](../../common/utils/electron-aaos-doc-template.md) usando formato YAML:
