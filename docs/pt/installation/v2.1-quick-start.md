# Guia de Início Rápido Electron AAOS v2.1

> 🌐 [EN](../../installation/v2.1-quick-start.md) | **PT** | [ES](../../es/installation/v2.1-quick-start.md)
...
## Passo 1: Instalar Electron AAOS Core
...
npx @electron-aaos/electron-aaos-core@latest init meu-projeto
cd meu-projeto
```
...
Electron AAOS usa agentes especializados para diferentes tarefas. Na sua IDE com IA ou Claude Code CLI, digite:
...
Stories direcionam o desenvolvimento no Electron AAOS. Ative o Product Owner e crie uma:
...
```bash
# Instalação e setup
npx @electron-aaos/electron-aaos-core@latest           # Executar wizard
npx @electron-aaos/electron-aaos-core@latest doctor    # Executar diagnósticos
npx @electron-aaos/electron-aaos-core@latest info      # Mostrar info do sistema

# Desenvolvimento
npm run lint                           # Verificar estilo de código
npm run typecheck                      # Verificar tipos TypeScript
npm test                               # Executar testes unitários
npm run validate:structure             # Validar estrutura Electron AAOS
```
...
```
seu-projeto/
├── .electron-aaos-core/                    # Core do framework
│   ├── core/                      # Módulos core
...
3. **Aprenda sobre agentes:** [Definições de Agentes](../../../.electron-aaos-core/development/agents/)
...
3. Verifique se o arquivo do agente existe: `ls .electron-aaos-core/development/agents/`
...
### Estrutura Electron AAOS não encontrada

```bash
# Reinstalar Electron AAOS no projeto atual
...
- **Documentação:** [Repositório GitHub](https://github.com/Electron AAOSAI/electron-aaos-core)
...
**Bem-vindo ao Electron AAOS! Bom coding!**
