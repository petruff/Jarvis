...
### Problema 1: "npx @electron-aaos/electron-aaos-core is not recognized"
...
```bash
# Verifique status da instalação Electron AAOS
npx @electron-aaos/electron-aaos-core status
...
```bash
# Verifique estrutura .electron-aaos-core
...
1. Execute `npx @electron-aaos/electron-aaos-core status` e anote a saída
2. Consulte este guia de solução de problemas
3. Pesquise [Issues existentes no GitHub](https://github.com/Electron AAOSAI/electron-aaos-core/issues)
...
- **Issues no GitHub**: [@electron-aaos/electron-aaos-core/issues](https://github.com/Electron AAOSAI/electron-aaos-core/issues)
