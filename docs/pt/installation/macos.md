...
# Guia de Instalação para macOS - Electron AAOS Electron AAOS
...
1. Os comandos são instalados em `.claude/commands/Electron AAOS/`
...
2. O Electron AAOS Electron AAOS lida automaticamente com sistemas de arquivos case-sensitive e case-insensitive
