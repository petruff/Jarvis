...
# Guia de Instalação Linux para Electron AAOS Electron AAOS
...
2. Comandos são instalados em `.claude/commands/Electron AAOS/`
3. Use `/nome-do-agente` para ativar agentes

### Windsurf

1. Instale de [codeium.com/windsurf](https://codeium.com/windsurf)
2. Regras são instaladas em `.windsurf/rules/`
3. Use `@nome-do-agente` para ativar agentes
...
- Fazer backup de customizações em `.electron-aaos-backup/`
