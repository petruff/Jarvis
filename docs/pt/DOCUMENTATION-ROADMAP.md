...
# Roadmap de Documentação Electron AAOS
...
| `internal-tools-analysis.md`                      | `.electron-aaos-core/infrastructure/tools/README.md`  | Referenciar existente               |
| `.electron-aaos-core/core/registry/README.md`              | **JÁ EXISTE**                                | Nenhuma ação necessária             |
