...
# Guia de Instalação e Solução de Problemas do Electron AAOS-Core
...
Este comando baixa e executa a versão mais recente do instalador do Electron AAOS-Core.
...
2. **Execute diagnósticos**: `npx electron-aaos-core@latest doctor`
3. **Verifique informações do sistema**: `npx electron-aaos-core@latest info`
...
| Comando | Descrição |
|---------|-----------|
| `npx electron-aaos-core@latest` | Instalar/executar assistente |
| `npx electron-aaos-core@latest --version` | Mostrar versão |
| `npx electron-aaos-core@latest --help` | Mostrar ajuda |
| `npx electron-aaos-core@latest install` | Instalar no diretório atual |
| `npx electron-aaos-core@latest init <name>` | Criar novo projeto |
| `npx electron-aaos-core@latest doctor` | Executar diagnósticos |
| `npx electron-aaos-core@latest info` | Mostrar informações do sistema |

---

*Última atualização: Dezembro 2025 | Electron AAOS-Core v2.2.0*
