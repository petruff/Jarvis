...
**Opção 1: Se você tem o electron-aaos-core clonado**
```bash
# Do diretório electron-aaos-core
...
- **Definição da Ferramenta:** `.electron-aaos-core/infrastructure/tools/cli/llm-routing.yaml`
- **Script de Instalação:** `.electron-aaos-core/infrastructure/scripts/llm-routing/install-llm-routing.js`
- **Definição de Tarefa:** `.electron-aaos-core/development/tasks/setup-llm-routing.md`
...
*Gerado pelo Electron AAOS Framework - Story 6.7*
