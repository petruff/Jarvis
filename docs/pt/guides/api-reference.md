# Referência de API do Electron AAOS

> [EN](../../guides/api-reference.md) | **PT** | [ES](../../es/guides/api-reference.md)

---

Referência completa de API para o Electron AAOS Electron AAOS - o Sistema Orquestrado por IA para Desenvolvimento Full Stack.
...
O Electron AAOS fornece uma API unificada para interagir com agentes de IA especializados através de dois mecanismos principais:
...
| `@electron-aaos-master`   | Orion  | Orchestrator | Orquestração do framework, meta-operações       |

### Comportamento de Ativação

Quando um agente é ativado:

1. O arquivo de definição do agente é carregado de `.electron-aaos-core/development/agents/{id}.md`
...
*develop story-1.2.3
    │
    ▼
.electron-aaos-core/development/tasks/dev-develop-story.md
    │
    ▼
...
### @electron-aaos-master (Orchestrator)

**Desenvolvimento do Framework:**

| Comando                | Argumentos      | Descrição                                           |
| ---------------------- | --------------- | --------------------------------------------------- |
| `*create`              | `{type} {name}` | Criar componente Electron AAOS (agent/task/workflow)         |
...
| `*kb`   | -                          | Alternar modo KB (conhecimento do Electron AAOS Method)   |
...
```bash
# Iniciar workflow
@electron-aaos-master *workflow greenfield-fullstack
...
| -------------------- | ------------------------------- | --------------------------------------------- |
| `AGENT_NOT_FOUND`    | Definição de agente ausente     | Verificar `.electron-aaos-core/development/agents/`    |
...
/electron-aaos-master  → Ativa agente @electron-aaos-master
```
...
- [Guia do Usuário](./user-guide.md) - Começando com Electron AAOS
...
- [Guia de Squads](./squads-guide.md) - Estendendo Electron AAOS com squads

---

_Electron AAOS Electron AAOS Referência de API v2.1.0_
