...
Introdução aos Electron AAOS Squads - equipes modulares de agentes de IA que estendem a funcionalidade do framework.
...
Squads são equipes modulares de agentes de IA que estendem a funcionalidade do Electron AAOS para domínios ou casos de uso específicos. Cada squad é um pacote autocontido que pode ser instalado, compartilhado e composto com outros squads.

> **Electron AAOS Squads:** Equipes de agentes de IA trabalhando com você
...
| Agentes Tradicionais   | Electron AAOS Squads                  |
| ---------------------- | ---------------------------- |
...
| ----------------- | ------ | ---------------------------------- | -------------------------------------------------------------------------------- |
| **etl-squad**     | 2.0.0  | Coleta e transformação de dados    | [electron-aaos-squads/etl](https://github.com/Electron AAOSAI/electron-aaos-squads/tree/main/etl)         |
| **creator-squad** | 1.0.0  | Utilitários de geração de conteúdo | [electron-aaos-squads/creator](https://github.com/Electron AAOSAI/electron-aaos-squads/tree/main/creator) |
...
│  Nível 2: Electron AAOS-SQUADS  --> github.com/Electron AAOSAI (Público)     │
...
| Modo       | Comportamento                           |
| ---------- | --------------------------------------- |
| `extend`   | Adiciona regras do squad às regras Electron AAOS |
| `override` | Substitui regras Electron AAOS pelas do squad    |
...
- **Explore Squads Oficiais:** Confira o [repositório electron-aaos-squads](https://github.com/Electron AAOSAI/electron-aaos-squads)
- **Contribua:** Veja o [Guia de Contribuição de Squads](./contributing-squads.md)
- **Aprenda o Formato de Task:** Leia [TASK-FORMAT-SPECIFICATION-V1](../../../.electron-aaos-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md)
...
- [Especificação de Formato de Task](../../../.electron-aaos-core/docs/standards/TASK-FORMAT-SPECIFICATION-V1.md)
...
_Electron AAOS Squads: Equipes de agentes de IA trabalhando com você_
