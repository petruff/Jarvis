...
HybridOps integra com os quality gates de 3 camadas do Electron AAOS:
...
- [Arquitetura de Alto Nivel Electron AAOS](../../architecture/high-level-architecture.md)
