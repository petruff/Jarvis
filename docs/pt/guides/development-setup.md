...
Guia completo para desenvolvedores que desejam contribuir com o projeto Electron AAOS Electron AAOS.
...
| -------------------- | --------------------------------------------- |
| **Claude Code**      | Desenvolvimento com IA usando agentes Electron AAOS    |
| **VS Code / Cursor** | IDE com integração Electron AAOS                       |
...
1. Navegue até [github.com/Electron AAOSAI/electron-aaos-core](https://github.com/Electron AAOSAI/electron-aaos-core)
...
Sincronizar agentes Electron AAOS com sua IDE:
...
Entendendo a estrutura de diretórios do `electron-aaos-core`:

```
electron-aaos-core/
├── .electron-aaos-core/                    # Fonte do framework (commitado)
...
| ----------------------------------- | ----------------------------- | ------------------------- |
| `.electron-aaos-core/development/agents/`    | Personas e comportamentos de agentes | Adicionar/modificar agentes |
| `.electron-aaos-core/development/tasks/`     | Workflows de tasks executáveis | Adicionar/modificar tasks |
| `.electron-aaos-core/development/workflows/` | Orquestrações multi-etapas    | Criar workflows           |
...
Crie um novo arquivo em `.electron-aaos-core/development/agents/`:

```bash
# Arquivo: .electron-aaos-core/development/agents/my-agent.md
```
...
dependencies:
  tasks:
    - my-agent-task.md       # Criar em .electron-aaos-core/development/tasks/
  checklists:
    - my-agent-checklist.md  # Criar em .electron-aaos-core/development/checklists/
  tools:
    - git
    - context7
````
...
Crie um novo arquivo em `.electron-aaos-core/development/tasks/`:
...
# .electron-aaos-core/development/tasks/create-doc.md          (compartilhada)
```
...
## Definição da Task (Electron AAOS Task Format V1.0)
...
Crie um novo arquivo em `.electron-aaos-core/development/workflows/`:

```bash
# Arquivo: .electron-aaos-core/development/workflows/my-workflow.yaml
```
...
- Marque `@Electron AAOSAI/core-team` para issues urgentes
...
_Electron AAOS Electron AAOS Development Setup Guide v1.0.0_
