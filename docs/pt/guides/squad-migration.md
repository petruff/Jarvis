...
Como migrar squads legados para o formato Electron AAOS 2.1.

## Visão Geral

Electron AAOS 2.1 introduziu um novo formato de squad com:
...
| Campo Electron AAOS type      | Ausente       | `electron-aaos.type: squad`         |
| Versão mínima        | Ausente       | `electron-aaos.minVersion: "2.1.0"` |
...
- Adiciona campos `electron-aaos` ausentes ao manifesto
...
- [ ] `electron-aaos.type` é `"squad"`
- [ ] `electron-aaos.minVersion` é `"2.1.0"` ou superior
