...
# Guia do Sistema de Quality Gates Electron AAOS

> 🌐 [EN](../../guides/quality-gates.md) | **PT** | [ES](../../es/guides/quality-gates.md)

---

> Guia completo para o sistema de quality gates de 3 camadas do Electron AAOS Electron AAOS.
...
O Sistema de Quality Gates do Electron AAOS fornece garantia de qualidade automatizada através de três camadas progressivas de validação. Cada camada captura diferentes tipos de problemas no estágio apropriado do desenvolvimento.
...
# Executar com opções
electron-aaos qa run --verbose          # Saída detalhada
electron-aaos qa run --fail-fast        # Parar na primeira falha
electron-aaos qa run --continue-on-fail # Continuar apesar de falhas
```
...
_Guia do Sistema de Quality Gates Electron AAOS Electron AAOS v2.1_
