# Guia de Workflows do Electron AAOS
...
Os Workflows do Electron AAOS sao sequencias orquestradas de atividades de agents que automatizam processos de desenvolvimento complexos. Eles fornecem padroes estruturados e repetitivos para cenarios de desenvolvimento comuns.
...
O state e persistido em `.electron-aaos/{instance-id}-state.yaml`:
...
O Electron AAOS detecta padroes comuns de workflow baseados no historico de comandos:
...
| **Localizacao** | `.electron-aaos-core/development/workflows/` | `.electron-aaos-core/development/tasks/` |
...
*Guia de Workflows do Electron AAOS v1.0 - Orquestrando Colaboracao IA-Humano*
