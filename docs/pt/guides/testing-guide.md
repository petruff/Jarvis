# Guia de Testes do Electron AAOS Electron AAOS

> [EN](../../guides/testing-guide.md) | **PT** | [ES](../../es/guides/testing-guide.md)

---

> Guia completo sobre a estratégia de testes, ferramentas e melhores práticas do Electron AAOS Electron AAOS.
...
O Electron AAOS segue uma estratégia abrangente de testes que garante qualidade de código em todas as camadas do framework. Nossa filosofia de testes é baseada em:
 ...
 *
 * Garante que agentes de versões anteriores do Electron AAOS continuem funcionando.
 */
...
O Electron AAOS suporta Windows, macOS e Linux. Testes cross-platform garantem comportamento consistente.
...
│   └── .electron-aaos-core/       # Cobertura por módulo
...
O Sistema de Quality Gate do Electron AAOS (veja [Guia de Quality Gates](./quality-gates.md)) integra testes em múltiplas camadas:
...
_Electron AAOS Electron AAOS v2.1 Guia de Testes_
