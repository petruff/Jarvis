...
```
.electron-aaos/data/quality-metrics.json
```
...
```bash
# Sincronizar de .electron-aaos/data para o dashboard
npm run sync-metrics
...
Isso copia `.electron-aaos/data/quality-metrics.json` para `tools/quality-dashboard/public/.electron-aaos/data/`.
...
ls -la .electron-aaos/data/quality-metrics.json

# Se estiver faltando, popule com dados de exemplo
npx electron-aaos metrics seed
```
...
_Electron AAOS Electron AAOS Quality Dashboard v1.0_
