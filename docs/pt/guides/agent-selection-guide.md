...
| **@electron-aaos-master** (Orion)     | 👑    | Desenvolvimento do framework, orquestração multi-agente                                                            | Tarefas rotineiras (use agentes especializados) |
...
| `*list-gotchas` | Listar gotchas conhecidos de .electron-aaos/gotchas.md |
