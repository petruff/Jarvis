...
> Motor de geração de documentos e substituição de variáveis para Electron AAOS Electron AAOS.
...
O Template Engine fornece uma forma consistente de gerar documentos (PRDs, ADRs, Stories, etc.) com substituição de variáveis, condicionais e loops. Ele alimenta todas as tarefas de geração de documentos no Electron AAOS.
...
_Electron AAOS Electron AAOS Template Engine v2.0_
