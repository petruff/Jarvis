...
# Guia de Service Discovery Electron AAOS

> 🌐 [EN](../../guides/service-discovery.md) | **PT** | [ES](../../es/guides/service-discovery.md)

---

> Como descobrir, consultar e usar workers no framework Electron AAOS.
...
O sistema de Service Discovery permite encontrar e usar workers (tasks, templates, scripts, workflows) em todo o framework Electron AAOS. O **Service Registry** é o catálogo central contendo metadados sobre todos os workers disponíveis.
...
Encontrados 5 workers correspondendo a "create story":
  ...
  [task] dev-create-brownfield-story
         Path: .electron-aaos-core/development/tasks/dev-create-brownfield-story.md
...
**Localização:** `.electron-aaos-core/development/tasks/`
...
**Localização:** `.electron-aaos-core/product/templates/`
...
**Localização:** `.electron-aaos-core/infrastructure/scripts/`
...
**Localização:** `.electron-aaos-core/development/workflows/`
...
**Localização:** `.electron-aaos-core/product/checklists/`
...
_Guia de Service Discovery Electron AAOS Electron AAOS v2.1_
