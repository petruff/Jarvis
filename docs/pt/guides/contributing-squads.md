...
Como contribuir squads para o ecossistema Electron AAOS.

## Visão Geral

Existem duas formas de compartilhar seu squad com a comunidade:

1. **Repositório electron-aaos-squads** - Squads gratuitos e open-source no GitHub
2. **Electron AAOS Marketplace** - Squads premium via API Electron AAOS
...
| **Compatibilidade Electron AAOS** | `electron-aaos.minVersion: "2.1.0"` ou superior |
...
## Publicando no electron-aaos-squads
...
Isso irá:
1. Fazer fork de `Electron AAOSAI/electron-aaos-squads` (se necessário)
...
## Publicando no Electron AAOS Marketplace

### Pré-requisitos

1. Conta Electron AAOS
...
- Siga convenções do Electron AAOS
...
- **Perguntas**: [GitHub Discussions](https://github.com/Electron AAOSAI/electron-aaos-core/discussions)
- **Issues**: [Issue Tracker](https://github.com/Electron AAOSAI/electron-aaos-core/issues)
