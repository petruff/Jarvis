...
# Guia de Workflow Git do Electron AAOS
...
O Electron AAOS Electron AAOS implementa uma estratégia de validação de **Defesa em Profundidade** com três camadas progressivas que detectam problemas antecipadamente e garantem a qualidade do código antes do merge.
...
**Localização:** `.electron-aaos-core/utils/electron-aaos-validator.js`
...
- [Abra uma Issue](https://github.com/Electron AAOSAI/electron-aaos-core/issues)
