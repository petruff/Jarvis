# Electron AAOS Agent Flows - Detailed Agent Documentation

> **EN** | [PT](../../electron-aaos-agent-flows/README.md) | [ES](../../es/electron-aaos-agent-flows/README.md)
...
This folder contains detailed documentation for all Electron AAOS agents, including:
...
| Electron AAOS Workflows | [docs/electron-aaos-workflows/](../../electron-aaos-workflows/) | Detailed workflows |
...
*Electron AAOS Agent Flows Documentation v1.0 - Detailed documentation of the agent system*
