...
> **EN** | [PT](../../electron-aaos-workflows/spec-pipeline-workflow.md) | [ES](../../es/electron-aaos-workflows/spec-pipeline-workflow.md)

---

**Full documentation available in:** [Portuguese Version](../../electron-aaos-workflows/spec-pipeline-workflow.md)
...
*For complete details, diagrams, and step-by-step instructions, see the [Portuguese documentation](../../electron-aaos-workflows/spec-pipeline-workflow.md).*
