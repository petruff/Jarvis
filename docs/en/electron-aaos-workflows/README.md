# Electron AAOS Workflows - Detailed Workflow Documentation

> **EN** | [PT](../../electron-aaos-workflows/README.md) | [ES](../../es/electron-aaos-workflows/README.md)
...
This folder contains detailed documentation of all Electron AAOS workflows, including:
...
| Agent Flows | [docs/electron-aaos-agent-flows/](../../electron-aaos-agent-flows/) | Agent details |
| Agent Reference | [docs/agent-reference-guide.md](../../agent-reference-guide.md) | Quick reference |
...
*Electron AAOS Workflows Documentation v1.0 - Detailed documentation of development workflows*
