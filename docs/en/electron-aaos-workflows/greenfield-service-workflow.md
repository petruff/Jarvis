...
> **EN** | [PT](../../electron-aaos-workflows/greenfield-service-workflow.md) | [ES](../../es/electron-aaos-workflows/greenfield-service-workflow.md)

---

**Full documentation available in:** [Portuguese Version](../../electron-aaos-workflows/greenfield-service-workflow.md)
...
*For complete details, diagrams, and step-by-step instructions, see the [Portuguese documentation](../../electron-aaos-workflows/greenfield-service-workflow.md).*
