...
**Arquivo Fonte:** `.electron-aaos-core/development/workflows/greenfield-fullstack.yaml`

---

## Visão Geral

O **Greenfield Full-Stack Workflow** e o fluxo de trabalho principal do Electron AAOS para construcao de aplicacoes full-stack desde o conceito ate o desenvolvimento. Este workflow suporta tanto planejamento abrangente para projetos complexos quanto prototipagem rapida para projetos simples.
...
flowchart TD
    subgraph FASE0["FASE 0: Environment Bootstrap"]
        ...
        CHECK -->|Verificar| ENV_REPORT[".electron-aaos/environment-report.json existe?"]
...
|------|--------|------|---------|-------|-------------|
| 1 | @devops (Gage) | `environment-bootstrap.md` | `project_name`, `project_path`, `github_org` | `.electron-aaos/config.yaml`, `.electron-aaos/environment-report.json`, `.gitignore`, `README.md`, `package.json` | Sim |

### Artefatos Criados

| Arquivo | Descricao |
|---------|-----------|
| `.electron-aaos/config.yaml` | Configuracao do projeto Electron AAOS |
| `.electron-aaos/environment-report.json` | Relatorio completo do ambiente |
...
- Pular apenas se o projeto ja tiver `.electron-aaos/environment-report.json`
...
| Fase | Entrada | Saida |
|------|---------|-------|
| 0 | Nome do projeto, organizacao GitHub | Config Electron AAOS, repo Git, estrutura de pastas |
...
|------|------------------|--------|----------|
| 0 | Ambiente pronto? | Pular / Executar bootstrap | Existencia de `.electron-aaos/environment-report.json` |
...
flowchart TD
    D1{Ambiente pronto?}
    D1 -->|Verificar .electron-aaos/environment-report.json| D1_CHECK
...
| Problema | Causa | Solucao |
|----------|-------|---------|
| Template nao encontrado | Caminho incorreto | Verificar `.electron-aaos-core/development/templates/` |
...
```bash
# Verificar ambiente
cat .electron-aaos/environment-report.json
...
|------|---------|-----------|
| Workflow | `.electron-aaos-core/development/workflows/greenfield-fullstack.yaml` | Definicao do workflow |
| Task | `.electron-aaos-core/development/tasks/environment-bootstrap.md` | Bootstrap do ambiente |
| Task | `.electron-aaos-core/development/tasks/shard-doc.md` | Fragmentacao de documentos |
| Task | `.electron-aaos-core/development/tasks/sm-create-next-story.md` | Criacao de stories |
| Agente | `.electron-aaos-core/development/agents/*.md` | Definicoes de agentes |
| Template | `.electron-aaos-core/development/templates/*.yaml` | Templates de documentos |
| Checklist | `.electron-aaos-core/development/checklists/*.md` | Checklists de validacao |
...
**Mantido por:** Electron AAOS Development Team
