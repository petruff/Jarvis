...
| Arquivo | Localizacao |
|---------|-------------|
| Definicao do Workflow | `.electron-aaos-core/development/workflows/brownfield-discovery.yaml` |
| Task: brownfield-create-epic | `.electron-aaos-core/development/tasks/brownfield-create-epic.md` |
| Task: brownfield-create-story | `.electron-aaos-core/development/tasks/brownfield-create-story.md` |
| Task: db-schema-audit | `.electron-aaos-core/development/tasks/db-schema-audit.md` |
| Task: security-audit | `.electron-aaos-core/development/tasks/security-audit.md` |
...
| @data-engineer | `.electron-aaos-core/development/agents/data-engineer.md` |
| @ux-design-expert | `.electron-aaos-core/development/agents/ux-design-expert.md` |
...
- [Guia de Workflows Electron AAOS](../Electron AAOS-WORKFLOWS-GUIDE.md)
