# Electron AAOS Workflows - Documentação Detalhada dos Workflows

> 🌐 **PT** | [EN](../en/electron-aaos-workflows/README.md) | [ES](../es/electron-aaos-workflows/README.md)
...
Esta pasta contém a documentação detalhada de todos os workflows do Electron AAOS, incluindo:
...
| Agent Flows | [docs/electron-aaos-agent-flows/](../electron-aaos-agent-flows/) | Detalhes de agentes |
| Agent Reference | [docs/agent-reference-guide.md](../agent-reference-guide.md) | Referência rápida |
...
*Electron AAOS Workflows Documentation v1.0 - Documentação detalhada dos workflows de desenvolvimento*
