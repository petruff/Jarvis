...
flowchart TB
    ...
    PF3 -->|Existe| PF4
    PF3 -->|Não existe| ERR3[Erro: Electron AAOS incompleto]
...
**Estrutura Criada:**
```
.electron-aaos/worktrees/{storyId}/     # Diretório de trabalho
...
| Propriedade | Valor |
|-------------|-------|
| **Localização** | `.electron-aaos-core/development/tasks/create-worktree.md` |
| **Agente** | @devops (Gage) |
| **Versão** | 1.0 |
| **Story** | 1.3 |
...
3. Aumentar limite (se necessário) em `.electron-aaos/config.yaml`
...
*Documentação gerada automaticamente pelo Electron AAOS-FULLSTACK*
