...
2. **Electron AAOS-Core Disponivel**
   - Templates em `.electron-aaos-core/development/templates/`
   - Tasks em `.electron-aaos-core/development/tasks/`
   - Checklists em `.electron-aaos-core/development/checklists/`
...
| Problema | Causa Provável | Solução |
|----------|----------------|---------|
| Templates nao encontrados | Path incorreto | Verificar `.electron-aaos-core/development/templates/` |
...
| Arquivo | Caminho |
|---------|---------|
| Definição do Workflow | `.electron-aaos-core/development/workflows/greenfield-ui.yaml` |
| Knowledge Base | `.electron-aaos-core/data/electron-aaos-kb.md` |

### Agentes

| Agente | Caminho |
|--------|---------|
| @analyst | `.electron-aaos-core/development/agents/analyst.md` |
| @pm | `.electron-aaos-core/development/agents/pm.md` |
| @ux-expert | `.electron-aaos-core/development/agents/ux-design-expert.md` |
| @architect | `.electron-aaos-core/development/agents/architect.md` |
| @po | `.electron-aaos-core/development/agents/po.md` |
| @sm | `.electron-aaos-core/development/agents/sm.md` |
| @dev | `.electron-aaos-core/development/agents/dev.md` |
| @qa | `.electron-aaos-core/development/agents/qa.md` |

### Templates Principais

| Template | Caminho |
|----------|---------|
| Project Brief | `.electron-aaos-core/development/templates/project-brief-tmpl.yaml` |
| PRD | `.electron-aaos-core/development/templates/prd-tmpl.yaml` |
| Frontend Spec | `.electron-aaos-core/development/templates/front-end-spec-tmpl.yaml` |
| Frontend Architecture | `.electron-aaos-core/development/templates/front-end-architecture-tmpl.yaml` |
| Story | `.electron-aaos-core/development/templates/story-tmpl.yaml` |

### Checklists

| Checklist | Caminho |
|-----------|---------|
| PO Master | `.electron-aaos-core/development/checklists/po-master-checklist.md` |
| Story Draft | `.electron-aaos-core/development/checklists/story-draft-checklist.md` |
| Story DoD | `.electron-aaos-core/development/checklists/story-dod-checklist.md` |

### Documentação Relacionada

- [Electron AAOS Knowledge Base](.electron-aaos-core/data/electron-aaos-kb.md) - Base de conhecimento central
...
*Documento gerado automaticamente a partir de `.electron-aaos-core/development/workflows/greenfield-ui.yaml`*
