...
2. **Ambiente Configurado**
   ...
   - Acesso aos templates Electron AAOS
...
4. **Templates Disponíveis**
   - `.electron-aaos-core/development/templates/brownfield-prd-tmpl.yaml`
   - `.electron-aaos-core/development/templates/brownfield-architecture-tmpl.yaml`
   - `.electron-aaos-core/development/templates/story-tmpl.yaml`

5. **Checklists Disponíveis**
   - `.electron-aaos-core/development/checklists/po-master-checklist.md`
   - `.electron-aaos-core/development/checklists/story-draft-checklist.md`
   - `.electron-aaos-core/development/checklists/story-dod-checklist.md`
...
|---------|-----------|---------|
| Workflow Definition | Definição YAML do workflow | `.electron-aaos-core/development/workflows/brownfield-service.yaml` |
| PRD Template | Template para brownfield PRD | `.electron-aaos-core/development/templates/brownfield-prd-tmpl.yaml` |
| Architecture Template | Template para arquitetura | `.electron-aaos-core/development/templates/brownfield-architecture-tmpl.yaml` |
| Story Template | Template para stories | `.electron-aaos-core/development/templates/story-tmpl.yaml` |
| PO Master Checklist | Checklist de validação | `.electron-aaos-core/development/checklists/po-master-checklist.md` |
| Story Draft Checklist | Checklist de story | `.electron-aaos-core/development/checklists/story-draft-checklist.md` |
| Story DoD Checklist | Definition of Done | `.electron-aaos-core/development/checklists/story-dod-checklist.md` |
...
| @analyst | Atlas | `.electron-aaos-core/development/agents/analyst.md` |
| @dev | Dex | `.electron-aaos-core/development/agents/dev.md` |
| @qa | Quinn | `.electron-aaos-core/development/agents/qa.md` |

### Documentação Relacionada

- [Electron AAOS Knowledge Base](../../../.electron-aaos-core/data/electron-aaos-kb.md) - Base de conhecimento do framework
- [Technical Preferences](../../../.electron-aaos-core/development/data/technical-preferences.md) - Preferências técnicas do projeto
- [IDE Development Workflow](../../../.electron-aaos-core/data/electron-aaos-kb.md#IDE-Development-Workflow) - Fluxo de desenvolvimento no IDE
...
*Documento gerado a partir do workflow `brownfield-service.yaml` - Electron AAOS Framework v2.2*
