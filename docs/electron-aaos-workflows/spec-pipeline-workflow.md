...
|------|------|--------|---------|
| Gather Requirements | 1 | @pm | `.electron-aaos-core/development/tasks/spec-gather-requirements.md` |
| Assess Complexity | 2 | @architect | `.electron-aaos-core/development/tasks/spec-assess-complexity.md` |
| Research Dependencies | 3 | @analyst | `.electron-aaos-core/development/tasks/spec-research-dependencies.md` |
| Write Specification | 4 | @pm | `.electron-aaos-core/development/tasks/spec-write-spec.md` |
| Critique Specification | 5, 5c | @qa | `.electron-aaos-core/development/tasks/spec-critique.md` |
| Create Implementation Plan | 6 | @architect | `.electron-aaos-core/development/tasks/plan-create-implementation.md` |
...
| Arquivo | Localização |
|---------|-------------|
| Definicao do Workflow | `.electron-aaos-core/development/workflows/spec-pipeline.yaml` |
| Task: Gather | `.electron-aaos-core/development/tasks/spec-gather-requirements.md` |
| Task: Assess | `.electron-aaos-core/development/tasks/spec-assess-complexity.md` |
| Task: Research | `.electron-aaos-core/development/tasks/spec-research-dependencies.md` |
| Task: Write Spec | `.electron-aaos-core/development/tasks/spec-write-spec.md` |
| Task: Critique | `.electron-aaos-core/development/tasks/spec-critique.md` |
| Task: Create Plan | `.electron-aaos-core/development/tasks/plan-create-implementation.md` |
...
- [Electron AAOS Documentation Index](../Electron AAOS-DOCUMENTATION-INDEX.md)
...
metadata:
  ...
  baseado_em:
    - .electron-aaos-core/development/workflows/spec-pipeline.yaml
    - .electron-aaos-core/development/tasks/spec-*.md
