...
| Arquivo | Propósito |
|---------|-----------|
| `.electron-aaos-core/development/workflows/brownfield-fullstack.yaml` | Definição do workflow |
...
| `.electron-aaos-core/product/checklists/po-master-checklist.md` | Checklist de validação PO |
