...
**Localização:** `.electron-aaos-core/development/tasks/qa-review-story.md`
...
**Localização:** `.electron-aaos-core/development/tasks/qa-create-fix-request.md`
...
**Localização:** `.electron-aaos-core/development/tasks/dev-apply-qa-fixes.md`
...
config:
  ...
  dashboardStatusPath: .electron-aaos/dashboard/status.json
  legacyStatusPath: .electron-aaos/status.json
...
No arquivo `.electron-aaos-core/core-config.yaml`:
...
| Arquivo | Localização |
|---------|-------------|
| Workflow Definition | `.electron-aaos-core/development/workflows/qa-loop.yaml` |
| QA Review Task | `.electron-aaos-core/development/tasks/qa-review-story.md` |
| Create Fix Request Task | `.electron-aaos-core/development/tasks/qa-create-fix-request.md` |
| Apply QA Fixes Task | `.electron-aaos-core/development/tasks/dev-apply-qa-fixes.md` |
...
|----------|-------------|-----|
| `qa-gate-tmpl.yaml` | `.electron-aaos-core/development/templates/` | Gate file structure |
| `story-tmpl.yaml` | `.electron-aaos-core/development/templates/` | Story file structure |
