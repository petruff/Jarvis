...
Electron AAOS (AI-Orchestrated System) is an open-source project maintained by Electron AAOSAI Inc. This privacy policy explains how we handle any data that may be collected when you use Electron AAOS Electron AAOS.

## Data Collection

### What We Don't Collect

Electron AAOS Electron AAOS does **NOT** collect:
...
Electron AAOS Electron AAOS uses a **consent-based telemetry system**. The system is designed as follows:
...
You can also revoke consent at any time through the consent management interface or by deleting the `.electron-aaos/telemetry/` directory.

## Local Data Storage

Electron AAOS Electron AAOS stores some data locally on your machine:

- Configuration files (`.electron-aaos/`, `.electron-aaos-core/`)
- Project status cache (`.electron-aaos/project-status.yaml`)
...
When using Electron AAOS Electron AAOS, you may interact with third-party services:
...
**Important:** Your interactions with these services are governed by their respective privacy policies. Electron AAOS Electron AAOS does not control or have access to data you share with these services.
...
- **Delete** all local data by removing the `.electron-aaos/` and `.ai/` directories
...
- Repository: [github.com/Electron AAOSAI/electron-aaos-core](https://github.com/Electron AAOSAI/electron-aaos-core)
- No hidden data collection mechanisms
- All configuration options are documented

## Children's Privacy

Electron AAOS Electron AAOS is a development tool intended for professional use. We do not knowingly collect any information from children under 13 years of age.
...
- API keys and credentials are never stored by Electron AAOS (users manage their own)
- Regular security audits of the codebase

For security vulnerabilities, please [open an issue](https://github.com/Electron AAOSAI/electron-aaos-core/issues) or email security@Electron AAOSAI.com.

## Contact

For privacy concerns or questions:

- **GitHub Issues:** [Open an issue](https://github.com/Electron AAOSAI/electron-aaos-core/issues)
- **Email:** privacy@Electron AAOSAI.com
...
**Copyright (c) 2025 Electron AAOSAI Inc.**
