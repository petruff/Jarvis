...
By using Electron AAOS Electron AAOS ("the Software"), you agree to be bound by these Terms of Use. If you do not agree to these terms, do not use the Software.

## License

Electron AAOS Electron AAOS is released under the **MIT License**. See the [LICENSE](LICENSE) file for the full license text.
...
- ❌ Use Electron AAOSAI Inc. trademarks without written permission
- ❌ Hold the authors or copyright holders liable for any damages
- ❌ Claim authorship or endorsement by Electron AAOSAI Inc.
...
By contributing to Electron AAOS Electron AAOS, you agree that:
...
The following are trademarks or registered trademarks of Electron AAOSAI Inc.:

- "Electron AAOS"
- "Electron AAOS Electron AAOS"
- "Electron AAOS"
...
For trademark licensing inquiries, contact: legal@Electron AAOSAI.com

## Third-Party Dependencies

Electron AAOS Electron AAOS includes third-party open-source components. Each component is subject to its own license terms:
...
When using AI providers (Claude, OpenAI, etc.) through Electron AAOS Electron AAOS:
...
These Terms of Use, together with the [LICENSE](LICENSE), [Privacy Policy](PRIVACY.md), and [Code of Conduct](CODE_OF_CONDUCT.md), constitute the entire agreement between you and Electron AAOSAI Inc. regarding use of Electron AAOS Electron AAOS.
...
- **Email:** legal@Electron AAOSAI.com
- **Discord:** [Community Server](https://discord.gg/gk8jAdXWmj)

---

**Copyright (c) 2025 Electron AAOSAI Inc. All rights reserved.**
