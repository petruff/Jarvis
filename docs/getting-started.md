# Getting Started with Electron AAOS Electron AAOS

> 🌐 **EN** | [PT](./pt/getting-started.md) | [ES](./es/getting-started.md)

---

Welcome to Electron AAOS Electron AAOS! This guide will walk you through your first steps with the AI-powered self-modifying development framework.
...
Before installing Electron AAOS Electron AAOS, ensure you have:
...
Electron AAOS Electron AAOS offers flexible installation options:
...
```
my-first-project/
├── .electron-aaos/                    # Framework configuration
...
The main configuration file (`.electron-aaos/config.json`) contains:
...
The meta-agent is the core of Electron AAOS Electron AAOS - an AI that understands and can modify its own codebase.
...
- **[Video Tutorials](https://@electron-aaos/electron-aaos-core.dev/tutorials)**: Visual learning
...
- **Twitter**: Follow [@electron-aaosfullstack](https://twitter.com/electron-aaosfullstack)
...
Remember: Electron AAOS Electron AAOS learns and improves with use. The more you interact with it, the better it understands your development style and needs.

Happy coding with Electron AAOS Electron AAOS! 🚀