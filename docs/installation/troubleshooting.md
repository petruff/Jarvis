...
### Issue 1: "npx @electron-aaos/electron-aaos-core is not recognized"
...
```bash
# Check Electron AAOS installation status
npx @electron-aaos/electron-aaos-core status
...
```bash
# Verify .electron-aaos-core structure
...
1. Run `npx @electron-aaos/electron-aaos-core status` and note the output
2. Check this troubleshooting guide
3. Search existing [GitHub Issues](https://github.com/Electron AAOSAI/electron-aaos-core/issues)
...
- **GitHub Issues**: [@electron-aaos/electron-aaos-core/issues](https://github.com/Electron AAOSAI/electron-aaos-core/issues)
