# Windows Installation Guide for Electron AAOS Electron AAOS
...
2. Electron AAOS can integrate via `.continue\` configuration
...
### Configure Electron AAOS with WSL
...
# - Back up customizations to .electron-aaos-backup\
...
```powershell
# Remove Electron AAOS from project
Remove-Item -Recurse -Force .electron-aaos-core
Remove-Item -Recurse -Force .claude\commands\Electron AAOS

# Remove global npm packages
npm uninstall -g @electron-aaos/electron-aaos
```
