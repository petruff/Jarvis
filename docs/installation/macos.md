# macOS Installation Guide for Electron AAOS Electron AAOS
...
1. Commands are installed to `.claude/commands/Electron AAOS/`
2. Use `/agent-name` to activate agents

### Windsurf

1. Rules are installed to `.windsurf/rules/`
2. Use `@agent-name` to activate agents
...
2. Electron AAOS Electron AAOS handles both case-sensitive and case-insensitive filesystems automatically
