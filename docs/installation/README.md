# Electron AAOS Electron AAOS Installation Documentation
...
This directory contains comprehensive installation and setup documentation for Electron AAOS Electron AAOS.
...
2. Search [FAQ](./faq.md)
3. Open a [GitHub Issue](https://github.com/Electron AAOSAI/electron-aaos-core/issues)
