...
- **🤖 Electron AAOS Autonomous Development Engine (ADE)**: Complete autonomous development system with 7 Epics:
...
- **Agent Sync**: All agents now synced between `.electron-aaos-core/development/agents/` and `.claude/commands/Electron AAOS/agents/`
...
- **Directory Structure**: Renamed `.bmad-core/` to `.electron-aaos-core/`
...
- **IDE Configuration**: Claude Code agents moved to `.claude/commands/Electron AAOS/agents/`
- **File Locations**:
...
- Manual installation process (use `npx @electron-aaos/electron-aaos-core install` instead)
...
- Initial public release of Electron AAOS Electron AAOS
...
1. Directory renamed: `.bmad-core/` → `.electron-aaos-core/`
...
- [GitHub Repository](https://github.com/Electron AAOSAI/electron-aaos-core)
