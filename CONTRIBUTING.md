# Contributing to Electron AAOS Electron AAOS

> **[Versao em Portugues](CONTRIBUTING-PT.md)**

Welcome to Electron AAOS! Thank you for your interest in contributing. This guide will help you understand our development workflow, contribution process, and how to submit your changes.
...
```
.electron-aaos-core/development/agents/your-agent.md
```
...
```
.electron-aaos-core/development/tasks/your-task.md
```
...
- [Squad Discussions](https://github.com/Electron AAOSAI/electron-aaos-core/discussions/categories/ideas) - Share ideas
...
- Security concerns
- Electron AAOS-specific patterns (agents, tasks, workflows)
- Performance issues
...
Electron AAOS implements a **Defense in Depth** strategy with 3 validation layers:
...
- **Discussions:** [Start a discussion](https://github.com/Electron AAOSAI/electron-aaos-core/discussions)
...
Electron AAOS uses an Open Core model with a private `pro/` git submodule (see [ADR-PRO-001](docs/architecture/adr/adr-pro-001-repository-strategy.md)).
...
**Push order:** Always push `pro/` changes first, then `electron-aaos-core`.
...
**Thank you for contributing to Electron AAOS Electron AAOS!**
