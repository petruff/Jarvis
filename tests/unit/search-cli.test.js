...
// Test modules
const { searchKeyword, fuzzyMatchScore, levenshteinDistance } = require('../../.electron-aaos-core/cli/commands/workers/search-keyword');
const { applyFilters, filterByCategory, filterByTags } = require('../../.electron-aaos-core/cli/commands/workers/search-filters');
const { formatOutput, formatTable, formatJSON, formatYAML } = require('../../.electron-aaos-core/cli/utils/output-formatter-cli');
const { calculateScores, sortByScore, calculateSearchAccuracy } = require('../../.electron-aaos-core/cli/utils/score-calculator');
const { isSemanticAvailable, cosineSimilarity, buildSearchText } = require('../../.electron-aaos-core/cli/commands/workers/search-semantic');
...
const mockWorkers = [
  {
    ...
    path: '.electron-aaos-core/development/tasks/data/json-csv-transformer.md',
  },
  {
    ...
    subcategory: 'transformation',
    tags: ['etl', 'data', 'json', 'csv'],
    path: '.electron-aaos-core/development/tasks/data/csv-json-transformer.md',
  },
  {
    id: 'json-validator',
    ...
    path: '.electron-aaos-core/development/tasks/validation/json-validator.md',
  },
  {
    id: 'api-generator',
    ...
    path: '.electron-aaos-core/development/tasks/code/api-generator.md',
  },
  {
    id: 'test-runner',
    name: 'Test Runner',
    ...
    path: '.electron-aaos-core/development/tasks/testing/test-runner.md',
  },
];
  ...
  const testResults = [
    {
      ...
      tags: ['etl', 'json', 'csv'],
      score: 95,
      path: '.electron-aaos-core/tasks/json-csv-transformer.md',
    },
  ];
