...
const { resolveConfig: mockResolveConfig } = require('../../.electron-aaos-core/core/config/config-resolver');
...
const { loadProjectStatus, formatStatusDisplay } = require('../../.electron-aaos-core/infrastructure/scripts/project-status-loader');
