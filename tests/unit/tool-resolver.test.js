...
`;
  ...
  describe('Cache Mechanism', () => {
    test('should cache tool after first resolution', async () => {
      // Mock file system
      glob.sync.mockReturnValue(['electron-aaos-core/tools/test-simple.yaml']);
  ...
  describe('Search Path Priority', () => {
    ...
    test('should fall back to core when expansion pack tool not found', async () => {
      ...
      glob.sync.mockImplementation((pattern) => {
        ...
        if (pattern.includes('electron-aaos-core/tools')) {
          return ['electron-aaos-core/tools/test-simple.yaml'];
        }
        return [];
      });
  ...
  describe('Schema Validation', () => {
    test('should validate required fields', async () => {
      glob.sync.mockReturnValue(['electron-aaos-core/tools/invalid.yaml']);
    ...
    test('should validate v1.0 tool schema', async () => {
      glob.sync.mockReturnValue(['electron-aaos-core/tools/simple.yaml']);
      fs.readFile.mockResolvedValue(simpleToolYaml);
    ...
    test('should validate v2.0 tool schema with executable knowledge', async () => {
      glob.sync.mockReturnValue(['electron-aaos-core/tools/complex.yaml']);
    ...
    test('should reject invalid YAML syntax', async () => {
      glob.sync.mockReturnValue(['electron-aaos-core/tools/broken.yaml']);
...
`;
      ...
      glob.sync.mockReturnValue(['electron-aaos-core/tools/auto.yaml']);
...
`;
      ...
      glob.sync.mockReturnValue(['electron-aaos-core/tools/api.yaml']);
...
`;
      ...
      glob.sync.mockReturnValue(['electron-aaos-core/tools/anti.yaml']);
...
`;
      ...
      glob.sync.mockReturnValue(['electron-aaos-core/tools/health.yaml']);
...
`;
      ...
      glob.sync.mockReturnValue(['electron-aaos-core/tools/http-health.yaml']);
...
`;
      ...
      glob.sync.mockReturnValue(['electron-aaos-core/tools/function-health.yaml']);
  ...
  describe('Additional Methods', () => {
    test('should list all available tools', async () => {
      glob.sync.mockReturnValue([
        'electron-aaos-core/tools/tool1.yaml',
        'electron-aaos-core/tools/tool2.yaml',
    ...
    test('should check if tool exists without loading', async () => {
      ...
      glob.sync.mockImplementation((pattern) => {
        if (pattern.includes('/exists.yaml')) {
          return ['electron-aaos-core/tools/exists.yaml'];
        }
        return [];
      });
