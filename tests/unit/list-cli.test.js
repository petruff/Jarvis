...
// Test modules
const { formatTree, formatTreeCollapsed, groupWorkers } = require('../../.electron-aaos-core/cli/commands/workers/formatters/list-tree');
const { formatTable, formatJSON, formatYAML, formatList, formatCount, truncate } = require('../../.electron-aaos-core/cli/commands/workers/formatters/list-table');
const { paginate, formatPaginationInfo, formatPaginationHint } = require('../../.electron-aaos-core/cli/commands/workers/utils/pagination');
...
const mockWorkers = [
  ...
  },
  {
    ...
    subcategory: 'transformation',
    tags: ['etl', 'json', 'csv'],
    path: '.electron-aaos-core/tasks/csv-json-transformer.md',
  },
  {
    id: 'json-validator',
    ...
    path: '.electron-aaos-core/tasks/json-validator.md',
  },
  {
    id: 'unit-test-runner',
    ...
    path: '.electron-aaos-core/tasks/unit-test-runner.md',
  },
  {
    id: 'api-generator',
    ...
    path: '.electron-aaos-core/tasks/api-generator.md',
  },
];
...
describe('Tree Formatter', () => {
  ...
  test('formatTree includes usage hints', () => {
    const output = formatTree(mockWorkers, {});
    expect(output).toContain('electron-aaos workers info <id>');
    expect(output).toContain('electron-aaos workers search <query>');
  });
...
describe('Performance Requirements', () => {
  ...
  const largeMockWorkers = Array.from({ length: 250 }, (_, i) => ({
    ...
    tags: ['tag1', 'tag2', 'tag3'],
    path: `.electron-aaos-core/tasks/worker-${i}.md`,
  }));
