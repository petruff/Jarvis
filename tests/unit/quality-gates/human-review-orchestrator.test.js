...
describe('HumanReviewOrchestrator', () => {
  ...
  beforeEach(() => {
    orchestrator = new HumanReviewOrchestrator({
      statusPath: '.electron-aaos/qa-status-test.json',
      reviewRequestsPath: '.electron-aaos/human-review-requests-test',
    });
  });
  ...
  describe('constructor', () => {
    ...
    it('should create orchestrator with custom config', () => {
      expect(orchestrator.statusPath).toBe('.electron-aaos/qa-status-test.json');
      expect(orchestrator.reviewRequestsPath).toBe('.electron-aaos/human-review-requests-test');
    });
  });
