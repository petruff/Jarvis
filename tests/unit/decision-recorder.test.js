 ...
 *
 * @see .electron-aaos-core/scripts/decision-recorder.js
 */
...
const {
  ...
  getCurrentContext,
} = require('../../.electron-aaos-core/development/scripts/decision-recorder');

// Mock decision-log-generator
jest.mock('../../.electron-aaos-core/development/scripts/decision-log-generator', () => ({
...
describe('decision-recorder', () => {
  ...
  describe('completeDecisionLogging', () => {
    it('should complete logging and generate log file', async () => {
      const { generateDecisionLog } = require('../../.electron-aaos-core/development/scripts/decision-log-generator');
