...
} = require('../../../.electron-aaos-core/infrastructure/scripts/documentation-integrity/brownfield-analyzer');

describe('Brownfield Analyzer', () => {
  let tempDir;

  beforeEach(() => {
    tempDir = fs.mkdtempSync(path.join(os.tmpdir(), 'electron-aaos-brownfield-test-'));
  });
