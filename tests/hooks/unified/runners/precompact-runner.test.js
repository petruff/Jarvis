...
const { onPreCompact, getHookConfig } = require('../../../../.electron-aaos-core/hooks/unified/runners/precompact-runner');
...
describe('PreCompact Hook Runner', () => {
  ...
  describe('onPreCompact', () => {
    ...
    it('should gracefully no-op when electron-aaos-pro not available', async () => {
      proDetector.isProAvailable.mockReturnValue(false);
      ...
      expect(console.log).toHaveBeenCalledWith(
        '[PreCompact] electron-aaos-pro not available, skipping session digest',
      );
    });
