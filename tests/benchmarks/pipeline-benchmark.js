...
const PIPELINE_MODULES = [
  '.electron-aaos-core/development/scripts/unified-activation-pipeline',
  '.electron-aaos-core/development/scripts/greeting-builder',
  '.electron-aaos-core/development/scripts/agent-config-loader',
  '.electron-aaos-core/development/scripts/greeting-preference-manager',
  '.electron-aaos-core/development/scripts/workflow-navigator',
  '.electron-aaos-core/core/session/context-loader',
  '.electron-aaos-core/core/session/context-detector',
  '.electron-aaos-core/core/permissions',
  '.electron-aaos-core/infrastructure/scripts/project-status-loader',
  '.electron-aaos-core/infrastructure/scripts/git-config-detector',
  '.electron-aaos-core/core/config/config-resolver',
  '.electron-aaos-core/core/config/config-cache',
];
...
async function runBenchmark(options) {
  const pipelinePath = path.resolve(
    PROJECT_ROOT, '.electron-aaos-core/development/scripts/unified-activation-pipeline',
  );
