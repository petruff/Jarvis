...
const ReporterManager = require('../../.electron-aaos-core/core/health-check/reporters');
const {
  MarkdownReporter,
  JSONReporter,
  ConsoleReporter,
} = require('../../.electron-aaos-core/core/health-check/reporters');
const { CheckStatus, CheckSeverity } = require('../../.electron-aaos-core/core/health-check/base-check');
