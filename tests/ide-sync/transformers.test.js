...
const claudeCode = require('../../.electron-aaos-core/infrastructure/scripts/ide-sync/transformers/claude-code');
const cursor = require('../../.electron-aaos-core/infrastructure/scripts/ide-sync/transformers/cursor');
const windsurf = require('../../.electron-aaos-core/infrastructure/scripts/ide-sync/transformers/windsurf');
const antigravity = require('../../.electron-aaos-core/infrastructure/scripts/ide-sync/transformers/antigravity');
...
describe('IDE Transformers', () => {
  ...
  describe('claude-code transformer', () => {
    ...
    it('should add sync footer if not present', () => {
      const result = claudeCode.transform(sampleAgent);
      expect(result).toContain('Synced from .electron-aaos-core/development/agents/dev.md');
    });
    ...
    it('should not duplicate sync footer', () => {
      const agentWithFooter = {
        ...
        raw:
          sampleAgent.raw +
          '\n---\n*Electron AAOS Agent - Synced from .electron-aaos-core/development/agents/dev.md*',
      };
