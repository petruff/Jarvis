...
const { SessionState } = require('../../.electron-aaos-core/core/orchestration/session-state');
const { SurfaceChecker } = require('../../.electron-aaos-core/core/orchestration/surface-checker');
...
describe('WorkflowNavigator Integration (Story ACT-5)', () => {
  ...
  describe('AC5: Bob orchestration patterns in workflow-patterns.yaml', () => {
    ...
    beforeAll(() => {
      const patternsPath = path.join(
        __dirname,
        '../../.electron-aaos-core/data/workflow-patterns.yaml',
      );
  ...
  describe('UnifiedActivationPipeline _detectWorkflowState relaxation', () => {
    ...
    beforeEach(() => {
      ...
      jest.mock('../../.electron-aaos-core/development/scripts/greeting-builder');
      ...
      const { UnifiedActivationPipeline } = require('../../.electron-aaos-core/development/scripts/unified-activation-pipeline');
      const MockWorkflowNavigator = require('../../.electron-aaos-core/development/scripts/workflow-navigator');
