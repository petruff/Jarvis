...
jest.mock('../../.electron-aaos-core/core/memory/gotchas-memory', () => { throw new Error('mocked'); });

const { SubagentDispatcher } = require('../../.electron-aaos-core/core/execution/subagent-dispatcher');
