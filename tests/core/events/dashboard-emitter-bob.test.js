...
const { DashboardEmitter, getDashboardEmitter } = require('../../../.electron-aaos-core/core/events/dashboard-emitter');
const { DashboardEventType } = require('../../../.electron-aaos-core/core/events/types');
...
describe('DashboardEmitter Bob-specific methods', () => {
  ...
  beforeEach(async () => {
    ...
    emitter.fallbackPath = path.join(tempDir, '.electron-aaos', 'dashboard', 'events.jsonl');
  });
