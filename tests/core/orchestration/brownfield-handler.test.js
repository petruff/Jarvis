...
const {
  ...
  PostDiscoveryChoice,
  PhaseFailureAction,
} = require('../../../.electron-aaos-core/core/orchestration/brownfield-handler');
  ...
  describe('constructor', () => {
    ...
    test('should set correct workflow path', () => {
      expect(handler.workflowPath).toBe(
        path.join(TEST_PROJECT_ROOT, '.electron-aaos-core/development/workflows/brownfield-discovery.yaml'),
      );
    });
  });
