...
const { WorkflowExecutor } = require('../../../.electron-aaos-core/core/orchestration/workflow-executor');
...
describe('WorkflowExecutor Callbacks (Story 12.6)', () => {
  ...
  beforeEach(async () => {
    ...
    await fs.ensureDir(path.join(tempDir, '.electron-aaos-core/development/workflows'));
...
`;
    await fs.writeFile(
      path.join(tempDir, '.electron-aaos-core/development/workflows/development-cycle.yaml'),
      workflowContent,
    );
