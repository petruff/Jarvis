...
} = require('../../../.electron-aaos-core/core/orchestration/bob-status-writer');
...
describe('BobStatusWriter', () => {
  ...
  describe('constructor', () => {
    ...
    it('should set correct paths', () => {
      ...
      expect(writer.dashboardDir).toBe(path.join(tempDir, '.electron-aaos', 'dashboard'));
      expect(writer.statusPath).toBe(path.join(tempDir, '.electron-aaos', 'dashboard', 'bob-status.json'));
    });
  });
