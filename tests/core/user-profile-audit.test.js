...
const { validateUserProfile } = require('../../.electron-aaos-core/infrastructure/scripts/validate-user-profile');

// Import modules under test after mocks
const GreetingPreferenceManager = require('../../.electron-aaos-core/development/scripts/greeting-preference-manager');
...
describe('validate-user-profile standalone', () => {
  ...
  const actualValidateUserProfile = jest.requireActual(
    '../../.electron-aaos-core/infrastructure/scripts/validate-user-profile',
  ).validateUserProfile;
