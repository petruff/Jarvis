...
const MasterOrchestrator = require('../../.electron-aaos-core/core/orchestration/master-orchestrator');
...
describe('MasterOrchestrator', () => {
  ...
  beforeEach(async () => {
    ...
    // Create .electron-aaos/dashboard directory for dashboard integration
    await fs.ensureDir(path.join(tempDir, '.electron-aaos', 'dashboard'));
  ...
  describe('State Persistence (Story 0.2)', () => {
    describe('saveState (AC1, AC3)', () => {
      it('should save state to correct path', async () => {
        ...
        expect(normalizedPath).toContain('.electron-aaos/master-orchestrator/TEST-001.json');
