...
const {
  ...
  NotificationType,
} = require('../../.electron-aaos-core/core/orchestration/dashboard-integration');

const { MasterOrchestrator, OrchestratorState } = require('../../.electron-aaos-core/core/orchestration');
...
describe('Dashboard Integration (Story 0.8)', () => {
  ...
  describe('Status File Update (AC1)', () => {
    ...
    it('should return status path', () => {
      ...
      expect(normalizedPath).toContain('.electron-aaos/dashboard/status.json');
    });
  });
