...
jest.mock('../../.electron-aaos-core/workflow-intelligence/engine/wave-analyzer', () => null);
jest.mock('../../.electron-aaos-core/infrastructure/scripts/worktree-manager', () => { throw new Error('not available'); });
jest.mock('../../.electron-aaos-core/core/memory/gotchas-memory', () => { throw new Error('not available'); });
...
const {
  ...
  Phase,
  DEFAULT_CONFIG,
} = require('../../.electron-aaos-core/core/execution/build-orchestrator');
