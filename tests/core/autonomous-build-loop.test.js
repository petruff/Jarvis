...
jest.mock('../../.electron-aaos-core/core/execution/build-state-manager', () => ({
  BuildStateManager: jest.fn().mockImplementation(() => ({ ...mockStateInstance })),
}));

// Mock optional dependencies to not load
jest.mock('../../.electron-aaos-core/infrastructure/scripts/recovery-tracker', () => {
  throw new Error('not available');
});
jest.mock('../../.electron-aaos-core/infrastructure/scripts/worktree-manager', () => {
  throw new Error('not available');
});
...
const {
  ...
  SubtaskResult,
  DEFAULT_CONFIG,
} = require('../../.electron-aaos-core/core/execution/autonomous-build-loop');

const { BuildStateManager } = require('../../.electron-aaos-core/core/execution/build-state-manager');
