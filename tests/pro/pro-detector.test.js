 ...
 *
 * @see Story PRO-5 - electron-aaos-pro Repository Bootstrap (Task 3.2)
  ...
  describe('getProVersion()', () => {
    ...
    it('should return version from pro/package.json', () => {
      ...
      fs.readFileSync.mockReturnValue(
        JSON.stringify({ name: '@electron-aaos-fullstack/pro', version: '0.1.0' }),
      );
    ...
    it('should return null when package.json has no version field', () => {
      fs.existsSync.mockReturnValue(true);
      fs.readFileSync.mockReturnValue(JSON.stringify({ name: '@electron-aaos-fullstack/pro' }));
