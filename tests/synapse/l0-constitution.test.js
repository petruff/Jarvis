...
const os = require('os');
const LayerProcessor = require('../../.electron-aaos-core/core/synapse/layers/layer-processor');
const L0ConstitutionProcessor = require('../../.electron-aaos-core/core/synapse/layers/l0-constitution');
