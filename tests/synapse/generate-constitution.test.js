...
const {
  ...
  main,
  ROMAN_TO_ARABIC,
} = require('../../.electron-aaos-core/core/synapse/scripts/generate-constitution');
const { parseManifest, loadDomainFile } = require('../../.electron-aaos-core/core/synapse/domain/domain-loader');
 ...
 */
const FULL_CONSTITUTION = `# Electron AAOS Electron AAOS Constitution
...
describe('generateConstitution', () => {
  ...
  test('should include header comments', () => {
    ...
    expect(output).toContain('# Auto-generated from .electron-aaos-core/constitution.md');
...
describe('integration: real constitution.md', () => {
  const realConstitutionPath = path.join(__dirname, '..', '..', '.electron-aaos-core', 'constitution.md');
