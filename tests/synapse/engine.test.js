...
jest.mock('../../.electron-aaos-core/core/synapse/context/context-tracker', () => ({
...
// Mock formatter
jest.mock('../../.electron-aaos-core/core/synapse/output/formatter', () => ({
...
jest.mock('../../.electron-aaos-core/core/synapse/layers/l0-constitution', () => {
...
jest.mock('../../.electron-aaos-core/core/synapse/layers/l1-global', () => {
...
jest.mock('../../.electron-aaos-core/core/synapse/layers/l2-agent', () => {
...
jest.mock('../../.electron-aaos-core/core/synapse/layers/l3-workflow', () => {
...
jest.mock('../../.electron-aaos-core/core/synapse/layers/l4-task', () => {
  const err = new Error("Cannot find module './layers/l4-task'");
  err.code = 'MODULE_NOT_FOUND';
  throw err;
}, { virtual: true });

jest.mock('../../.electron-aaos-core/core/synapse/layers/l5-squad', () => {
  const err = new Error("Cannot find module './layers/l5-squad'");
  err.code = 'MODULE_NOT_FOUND';
  throw err;
}, { virtual: true });

jest.mock('../../.electron-aaos-core/core/synapse/layers/l6-keyword', () => {
  const err = new Error("Cannot find module './layers/l6-keyword'");
  err.code = 'MODULE_NOT_FOUND';
  throw err;
}, { virtual: true });

jest.mock('../../.electron-aaos-core/core/synapse/layers/l7-star-command', () => {
...
jest.mock('../../.electron-aaos-core/core/synapse/memory/memory-bridge', () => ({
...
const { SynapseEngine, PipelineMetrics, PIPELINE_TIMEOUT_MS } = require('../../.electron-aaos-core/core/synapse/engine');
const contextTracker = require('../../.electron-aaos-core/core/synapse/context/context-tracker');
const formatter = require('../../.electron-aaos-core/core/synapse/output/formatter');
