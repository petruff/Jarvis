...
describeIntegration('Google Workspace Tool Validators', () => {
  ...
  beforeAll(async () => {
    // Set search path to electron-aaos-core/tools
    const toolsPath = path.join(__dirname, '../../electron-aaos-core/tools');
  ...
  describeIntegration('Tool Resolution', () => {
    test('should resolve google-workspace tool from electron-aaos-core/tools/mcp', async () => {
