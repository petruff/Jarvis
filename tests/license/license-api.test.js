...
describe('license-api', () => {
  ...
  beforeEach(() => {
    ...
    testDir = fs.mkdtempSync(path.join(os.tmpdir(), 'electron-aaos-api-test-'));
  ...
  describe('LicenseApiClient constructor', () => {
    it('should use default config', () => {
      ...
      expect(client.baseUrl).toBe(process.env.Electron AAOS_LICENSE_API_URL || 'https://api.electron-aaos.ai');
    ...
    it('should successfully activate license (AC-1)', async () => {
      ...
      await createMockServer((req, res) => {
        ...
        req.on('end', () => {
          ...
          expect(data.electron-aaosCoreVersion).toBe('3.0.0');
