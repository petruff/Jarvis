...
describe('errors', () => {
  describe('ProFeatureError', () => {
    ...
    it('should include activation instructions in message', () => {
      ...
      expect(error.message).toContain('Premium Squads requires an active Electron AAOS Pro license');
      expect(error.message).toContain('electron-aaos pro activate --key <KEY>');
      expect(error.message).toContain('https://electron-aaos.ai/pro');
    });
    ...
    describe('toCliMessage', () => {
      it('should return formatted CLI message', () => {
        ...
        expect(cliMsg).toContain('Premium Squads requires an active Electron AAOS Pro license');
    ...
    describe('toJSON', () => {
      it('should return JSON-serializable object', () => {
        ...
        expect(json.message).toContain('requires an active Electron AAOS Pro license');
