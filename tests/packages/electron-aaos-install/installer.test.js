...
describe('installer', () => {
  ...
  describe('detectBrownfield', () => {
    it('should detect greenfield (no existing Electron AAOS)', () => {
      // Given
      fs.existsSync.mockReturnValue(false);
    ...
    it('should detect brownfield with legacy config', () => {
      ...
      fs.existsSync.mockImplementation((p) => {
        ...
        if (p.includes('.electron-aaos-core') && !p.includes('.yaml')) return true;
        return false;
      });
    ...
    it('should detect brownfield with layered config', () => {
      ...
      fs.existsSync.mockImplementation((p) => {
        ...
        if (p.includes('.electron-aaos-core')) return true;
        return false;
      });
