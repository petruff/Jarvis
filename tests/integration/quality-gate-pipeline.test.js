...
const { Layer1PreCommit } = require('../../.electron-aaos-core/core/quality-gates/layer1-precommit');
const { Layer2PRAutomation } = require('../../.electron-aaos-core/core/quality-gates/layer2-pr-automation');
const { Layer3HumanReview } = require('../../.electron-aaos-core/core/quality-gates/layer3-human-review');
const { ChecklistGenerator } = require('../../.electron-aaos-core/core/quality-gates/checklist-generator');
    ...
    it('should generate checklist with context', async () => {
      const checklist = await generator.generate({
        ...
        changedFiles: [
          ...
          '.electron-aaos-core/core/quality-gates/manager.js',
