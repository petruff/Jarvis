...
const { searchKeyword } = require('../../.electron-aaos-core/cli/commands/workers/search-keyword');
const { applyFilters } = require('../../.electron-aaos-core/cli/commands/workers/search-filters');
const { formatOutput, formatJSON } = require('../../.electron-aaos-core/cli/utils/output-formatter-cli');
...
describe('Smoke Tests - Search CLI', () => {
   ...
   * `electron-aaos workers search "validator"` returns results
