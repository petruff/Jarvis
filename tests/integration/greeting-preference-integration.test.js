...
const CONFIG_PATH = path.join(process.cwd(), '.electron-aaos-core', 'core-config.yaml');
const BACKUP_PATH = path.join(process.cwd(), '.electron-aaos-core', 'core-config.yaml.backup');
