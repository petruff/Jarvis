...
const { HumanReviewOrchestrator } = require('../../.electron-aaos-core/core/quality-gates/human-review-orchestrator');
const { FocusAreaRecommender } = require('../../.electron-aaos-core/core/quality-gates/focus-area-recommender');
const { NotificationManager } = require('../../.electron-aaos-core/core/quality-gates/notification-manager');
  ...
  describe('HUMAN-01: Orchestration Flow', () => {
    ...
    beforeEach(() => {
      orchestrator = new HumanReviewOrchestrator({
        statusPath: '.electron-aaos/qa-status-integration-test.json',
        reviewRequestsPath: '.electron-aaos/human-review-requests-integration-test',
      });
