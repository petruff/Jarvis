...
utilities.forEach(util => {
  try {
    const utilPath = path.join(__dirname, '../../electron-aaos-core/utils', `${util}.js`);
    require(utilPath);
...
const agents = [
  { name: 'qa', path: '.electron-aaos-core/development/agents/qa.md' },
  { name: 'po', path: '.electron-aaos-core/development/agents/po.md' },
  { name: 'devops', path: '.electron-aaos-core/development/agents/devops.md' },
  { name: 'dev', path: '.electron-aaos-core/development/agents/dev.md' },
];
