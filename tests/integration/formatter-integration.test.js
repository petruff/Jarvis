...
const PersonalizedOutputFormatter = require('../../.electron-aaos-core/infrastructure/scripts/output-formatter');
const OutputPatternValidator = require('../../.electron-aaos-core/infrastructure/scripts/validate-output-pattern');
const fs = require('fs');
...
- .electron-aaos-core/scripts/output-formatter.js
- .electron-aaos-core/scripts/validate-output-pattern.js
